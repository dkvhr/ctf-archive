...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m6692trySendImplMj0NB7M = conflatedBufferedChannel.m6692trySendImplMj0NB7M(e, true);
        if (m6692trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m6678exceptionOrNullimpl(m6692trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m6692trySendImplMj0NB7M = conflatedBufferedChannel.m6692trySendImplMj0NB7M(e, true);
        if (!(m6692trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo6664trySendJP2dKIU(E element) {
        return m6692trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m6692trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m6690trySendDropLatestMj0NB7M(element, isSendOp) : m6691trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m6690trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo6664trySendJP2dKIU = super.mo6664trySendJP2dKIU(element);
        if (ChannelResult.m6684isSuccessimpl(mo6664trySendJP2dKIU) || ChannelResult.m6682isClosedimpl(mo6664trySendJP2dKIU)) {
            return mo6664trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m6689successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m6691trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m6687closedJP2dKIU(getSendException());
                }
            } else {
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo6664trySendJP2dKIU = mo6664trySendJP2dKIU(element);
        if (!(mo6664trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo6664trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m6678exceptionOrNullimpl(mo6664trySendJP2dKIU);
