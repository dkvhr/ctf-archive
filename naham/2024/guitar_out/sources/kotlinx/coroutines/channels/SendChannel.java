...
public interface SendChannel<E> {
    ...
    Object mo6664trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo6664trySendJP2dKIU = sendChannel.mo6664trySendJP2dKIU(e);
            if (ChannelResult.m6684isSuccessimpl(mo6664trySendJP2dKIU)) {
                return true;
            }
            Throwable m6678exceptionOrNullimpl = ChannelResult.m6678exceptionOrNullimpl(mo6664trySendJP2dKIU);
