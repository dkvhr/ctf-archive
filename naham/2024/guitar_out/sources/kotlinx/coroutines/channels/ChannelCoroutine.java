...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo6668receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo6668receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo6669tryReceivePtdJZtk() {
        return this._channel.mo6669tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo6664trySendJP2dKIU(E element) {
        return this._channel.mo6664trySendJP2dKIU(element);
    }
