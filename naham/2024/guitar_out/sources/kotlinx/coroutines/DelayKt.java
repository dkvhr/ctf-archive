...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo6720scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m6650delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6651toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6651toDelayMillisLRDsOJo(long j) {
        if (Duration.m6485compareToLRDsOJo(j, Duration.INSTANCE.m6589getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6504getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
