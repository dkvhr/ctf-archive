...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m5160constructorimpl = Result.m5160constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5166isFailureimpl(m5160constructorimpl) ? null : m5160constructorimpl);
        if (bool != null) {
