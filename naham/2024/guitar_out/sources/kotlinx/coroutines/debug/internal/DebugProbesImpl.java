...
public final class DebugProbesImpl {
    ...
    public final boolean isInstalled$kotlinx_coroutines_core() {
        return DebugProbesImpl$Installations$kotlinx$VolatileWrapper.access$getInstallations$FU$p().get(installations$kotlinx$VolatileWrapper) > 0;
    }
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            m5160constructorimpl = Result.m5160constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
        } catch (Throwable th) {
        ...
        return (Function1) m5160constructorimpl;
    }
    ...
    private final String toStringRepr(Object obj) {
        return DebugProbesImplKt.access$repr(obj.toString());
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            m5160constructorimpl = Result.m5160constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m5160constructorimpl;
    ...
    private final <T> Continuation<T> createOwner(Continuation<? super T> completion, StackTraceFrame frame) {
        ...
        CoroutineOwner<?> coroutineOwner = new CoroutineOwner<>(completion, new DebugCoroutineInfoImpl(completion.getContext(), frame, DebugProbesImpl$SequenceNumber$kotlinx$VolatileWrapper.access$getSequenceNumber$FU$p().incrementAndGet(sequenceNumber$kotlinx$VolatileWrapper)));
