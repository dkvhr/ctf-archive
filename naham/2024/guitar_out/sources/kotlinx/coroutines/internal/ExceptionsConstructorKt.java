...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5160constructorimpl = Result.m5160constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m5160constructorimpl = Result.m5160constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m5166isFailureimpl(m5160constructorimpl) ? null : m5160constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m5160constructorimpl = Result.m5160constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5166isFailureimpl(m5160constructorimpl)) {
            m5160constructorimpl = valueOf;
        }
        return ((Number) m5160constructorimpl).intValue();
    }
