    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        ...
                        continuation.resumeWith(Result.m5160constructorimpl(ResultKt.createFailure(cancellationException)));
                    }
                    cancellationException = cancellationException2;
                    continuation.resumeWith(Result.m5160constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m5160constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m5160constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    m5160constructorimpl2 = Result.m5160constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m5160constructorimpl2 = Result.m5160constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m5163exceptionOrNullimpl(m5160constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                m5160constructorimpl = Result.m5160constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.INSTANCE;
                m5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m5163exceptionOrNullimpl(m5160constructorimpl));
        }
    }
