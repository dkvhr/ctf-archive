...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m5159boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m5160constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5161equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5162equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m5165hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m5167isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m5166isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m5164getOrNullimpl(Object obj) {
        if (m5166isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m5163exceptionOrNullimpl(Object obj) {
    ...
    public static String m5168toStringimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m5160constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m5160constructorimpl(ResultKt.createFailure(exception));
        }
    }
