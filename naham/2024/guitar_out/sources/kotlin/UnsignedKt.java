...
public final class UnsignedKt {
    ...
    public static final int m5512uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m5256constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }
    ...
    public static final long m5514ulongDivideeb3DHEI(long j, long j2) {
        ...
        if (j2 < 0) {
            ...
            return compare2 < 0 ? ULong.m5335constructorimpl(0L) : ULong.m5335constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m5335constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        compare = Long.compare(ULong.m5335constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m5335constructorimpl(j2) ^ Long.MIN_VALUE);
        return ULong.m5335constructorimpl(j3 + (compare < 0 ? 0 : 1));
    }
    ...
    public static final long m5515ulongRemaindereb3DHEI(long j, long j2) {
        ...
        if (j2 < 0) {
            compare2 = Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE);
            return compare2 < 0 ? j : ULong.m5335constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m5335constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        compare = Long.compare(ULong.m5335constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m5335constructorimpl(j2) ^ Long.MIN_VALUE);
        if (compare < 0) {
            j2 = 0;
        }
    ...
    public static final int doubleToUInt(double d) {
        ...
        return UInt.m5256constructorimpl(UInt.m5256constructorimpl((int) (d - Integer.MAX_VALUE)) + UInt.m5256constructorimpl(Integer.MAX_VALUE));
    }
