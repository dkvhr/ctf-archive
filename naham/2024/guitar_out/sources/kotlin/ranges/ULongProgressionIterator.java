...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    */
    private ULongProgressionIterator(long r4, long r6, long r8) {
        ...
        L1c:
            r3.hasNext = r1
            long r8 = kotlin.ULong.m5335constructorimpl(r8)
            r3.step = r8
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m5329boximpl(m6396nextsVKNKU());
    }

    /* renamed from: next-s-VKNKU, reason: not valid java name */
    public long m6396nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m5335constructorimpl(this.step + j);
        } else {
            if (!this.hasNext) {
