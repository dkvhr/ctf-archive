...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m6626boximpl(m6620markNowz9LOYto());
    }
    ...
    public long m6620markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m6629constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m6619elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m6618differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m6617adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m6629constructorimpl(LongSaturatedMathKt.m6615saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
