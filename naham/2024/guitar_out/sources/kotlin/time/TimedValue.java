...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m6644copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m6646copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m6646copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m6491equalsimpl0(this.duration, timedValue.duration);
    }

    /* renamed from: getDuration-UwyO8pc, reason: not valid java name */
    public final long m6647getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m6514hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m6535toStringimpl(this.duration)) + ')';
    }
