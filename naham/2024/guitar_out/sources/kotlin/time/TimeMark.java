...
public interface TimeMark {
    ...
    TimeMark mo6477minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6479plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m6624plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m6623minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo6479plusLRDsOJo(Duration.m6539unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m6519isNegativeimpl(timeMark.mo6476elapsedNowUwyO8pc());
        }
