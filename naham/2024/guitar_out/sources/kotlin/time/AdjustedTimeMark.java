...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo6477minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6623minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6476elapsedNowUwyO8pc() {
        return Duration.m6521minusLRDsOJo(this.mark.mo6476elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6479plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m6522plusLRDsOJo(this.adjustment, duration), null);
    }
}
