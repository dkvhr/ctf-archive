...
public final class UMathKt {
    ...
    private static final int m6373minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6355minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m6374mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6363minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m6371maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6343maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m6372maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6351maxOfeb3DHEI(j, j2);
    }
}
