...
public final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float getTop() {
        return Dp.m4873constructorimpl(this.topPadding.getValue().m4887unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float getBottom() {
        return Dp.m4873constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
