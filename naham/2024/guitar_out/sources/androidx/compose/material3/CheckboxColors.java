...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState state, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(state == ToggleableState.Off ? this.uncheckedCheckmarkColor : this.checkedCheckmarkColor, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean z, ToggleableState state, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.checkedCheckmarkColor, checkboxColors.checkedCheckmarkColor) && Color.m2630equalsimpl0(this.uncheckedCheckmarkColor, checkboxColors.uncheckedCheckmarkColor) && Color.m2630equalsimpl0(this.checkedBoxColor, checkboxColors.checkedBoxColor) && Color.m2630equalsimpl0(this.uncheckedBoxColor, checkboxColors.uncheckedBoxColor) && Color.m2630equalsimpl0(this.disabledCheckedBoxColor, checkboxColors.disabledCheckedBoxColor) && Color.m2630equalsimpl0(this.disabledUncheckedBoxColor, checkboxColors.disabledUncheckedBoxColor) && Color.m2630equalsimpl0(this.disabledIndeterminateBoxColor, checkboxColors.disabledIndeterminateBoxColor) && Color.m2630equalsimpl0(this.checkedBorderColor, checkboxColors.checkedBorderColor) && Color.m2630equalsimpl0(this.uncheckedBorderColor, checkboxColors.uncheckedBorderColor) && Color.m2630equalsimpl0(this.disabledBorderColor, checkboxColors.disabledBorderColor) && Color.m2630equalsimpl0(this.disabledIndeterminateBorderColor, checkboxColors.disabledIndeterminateBorderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((Color.m2636hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m2636hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m2636hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m2636hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m2636hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m2636hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m2636hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m2636hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2636hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
