...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors m1230iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        ...
        if ((i2 & 2) != 0) {
            ...
            j5 = ((Color) consume).m2639unboximpl();
        } else {
            j5 = j2;
        }
        long m2664getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j3;
        long m2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(j5, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(m2664getTransparent0d7_KjU, j5, m2664getTransparent0d7_KjU2, m2628copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1231iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            j7 = ((Color) consume).m2639unboximpl();
        } else {
            j7 = j2;
        }
        long m2664getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j3;
        long m2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(j7, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2664getTransparent0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j5;
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(m2664getTransparent0d7_KjU, j7, m2664getTransparent0d7_KjU2, m2628copywmQWz5c$default, m2664getTransparent0d7_KjU3, color, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1226filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(color, m1094contentColorForek8zF_U, m2628copywmQWz5c$default, m2628copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1227filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m1094contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, color2, m2628copywmQWz5c$default, m2628copywmQWz5c$default2, color3, m1094contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1228filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1094contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1229filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, m1094contentColorForek8zF_U, m2628copywmQWz5c$default, m2628copywmQWz5c$default2, color2, color3, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1232outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
    ...
    public final IconToggleButtonColors m1233outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m1094contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(m2664getTransparent0d7_KjU, j7, m2664getTransparent0d7_KjU2, m2628copywmQWz5c$default, color, m1094contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            m2628copywmQWz5c$default = ((Color) consume).m2639unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            m2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(((Color) consume2).m2639unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceableGroup();
        }
        Color m2619boximpl = Color.m2619boximpl(m2628copywmQWz5c$default);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2619boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = BorderStrokeKt.m186BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m2004getUnselectedOutlineWidthD9Ej5fM(), m2628copywmQWz5c$default);
