    ...
    */
    ...
    public static final void m1256LeadingContent3IgeMak(final RowScope rowScope, final long j, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(j))}, ComposableLambdaKt.composableLambda(startRestartGroup, 315166618, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier then = PaddingKt.m484paddingqDBjuR0$default(companion, 0.0f, 0.0f, f, 0.0f, 11, null).then(!z ? rowScope.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterVertically()) : Modifier.INSTANCE);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$LeadingContent$2
            ...
            public final void invoke(Composer composer2, int i3) {
                ListItemKt.m1256LeadingContent3IgeMak(RowScope.this, j, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m1260TrailingContent3IgeMak(final RowScope rowScope, final long j, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m482paddingVpY3zN4$default = PaddingKt.m482paddingVpY3zN4$default(Modifier.INSTANCE, TrailingHorizontalPadding, 0.0f, 2, null);
            Modifier.Companion companion = Modifier.INSTANCE;
            if (!z) {
                companion = rowScope.align(companion, Alignment.INSTANCE.getCenterVertically());
            }
            Modifier then = m482paddingVpY3zN4$default.then(companion);
            ...
            int i3 = i2 >> 3;
            m1259ProvideTextStyleFromToken3JVO9M(j, ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), function2, startRestartGroup, (i3 & 14) | 48 | (i3 & 896));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$TrailingContent$2
            ...
            public final void invoke(Composer composer2, int i4) {
                ListItemKt.m1260TrailingContent3IgeMak(RowScope.this, j, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void m1259ProvideTextStyleFromToken3JVO9M(final long j, final TypographyKeyTokens typographyKeyTokens, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(j))}, ComposableLambdaKt.composableLambda(startRestartGroup, -514310925, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ProvideTextStyleFromToken$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
