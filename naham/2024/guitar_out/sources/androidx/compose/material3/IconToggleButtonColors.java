...
public final class IconToggleButtonColors {
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(!z ? this.disabledContainerColor : !z2 ? this.containerColor : this.checkedContainerColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> contentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(!z ? this.disabledContentColor : !z2 ? this.contentColor : this.checkedContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m2630equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m2630equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m2630equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m2630equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m2630equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m2636hashCodeimpl(this.containerColor) * 31) + Color.m2636hashCodeimpl(this.contentColor)) * 31) + Color.m2636hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2636hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2636hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.checkedContentColor);
    }
}
