    ...
    */
    ...
    public static final void m1234Iconww6aTOc(final ImageBitmap bitmap, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        ...
        if ((i2 & 8) != 0) {
            ...
            j2 = ((Color) consume).m2639unboximpl();
            i3 = i & (-7169);
        } else {
            j2 = j;
            i3 = i;
        ...
        m1235Iconww6aTOc((BitmapPainter) rememberedValue, str, modifier2, j2, startRestartGroup, (i3 & 112) | 8 | (i3 & 896) | (i3 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$2
            ...
            public final void invoke(Composer composer2, int i4) {
                IconKt.m1234Iconww6aTOc(ImageBitmap.this, str, modifier3, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void m1235Iconww6aTOc(final Painter painter, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        ...
        ColorFilter m2670tintxETnrds$default = Color.m2630equalsimpl0(j2, Color.INSTANCE.m2665getUnspecified0d7_KjU()) ? null : ColorFilter.Companion.m2670tintxETnrds$default(ColorFilter.INSTANCE, j2, 0, 2, null);
        ...
        startRestartGroup.endReplaceableGroup();
        final long j3 = j2;
        BoxKt.Box(PainterModifierKt.paint$default(defaultSizeFor(GraphicsLayerModifierKt.toolingGraphicsLayer(modifier2), painter), painter, false, null, ContentScale.INSTANCE.getFit(), 0.0f, m2670tintxETnrds$default, 22, null).then(companion), startRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$3
            ...
            public final void invoke(Composer composer2, int i4) {
                IconKt.m1235Iconww6aTOc(Painter.this, str, modifier3, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
