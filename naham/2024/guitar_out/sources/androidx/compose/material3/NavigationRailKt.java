...
public final class NavigationRailKt {
    ...
    */
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItemBaselineLayout$2
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    Object obj;
                    Placeable placeable;
                    MeasureResult m1314placeLabelAndIconzUg2_y0;
                    MeasureResult m1313placeIconX9ElhV4;
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                            ...
                            int height = mo3866measureBRTryo0.getHeight() + Layout.mo319roundToPx0680j_4(Dp.m4873constructorimpl(f3 * f4));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                                    Placeable mo3866measureBRTryo02 = measurable2.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(i3, height));
                                    ...
                                    Placeable mo3866measureBRTryo03 = measurable3 != null ? measurable3.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(roundToInt, height)) : null;
                                    if (function24 != null) {
                                    ...
                                    placeable = null;
                                    if (function24 == null) {
                                        m1313placeIconX9ElhV4 = NavigationRailKt.m1313placeIconX9ElhV4(Layout, mo3866measureBRTryo0, mo3866measureBRTryo02, mo3866measureBRTryo03, j);
                                        return m1313placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(placeable);
                                    m1314placeLabelAndIconzUg2_y0 = NavigationRailKt.m1314placeLabelAndIconzUg2_y0(Layout, placeable, mo3866measureBRTryo0, mo3866measureBRTryo02, mo3866measureBRTryo03, j, z, f);
                                    return m1314placeLabelAndIconzUg2_y0;
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
    ...
    public static final MeasureResult m1313placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m4843constrainWidthK40F9xA = ConstraintsKt.m4843constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), Math.max(placeable2.getWidth(), placeable3 != null ? placeable3.getWidth() : 0)));
        final int m4828getMaxHeightimpl = Constraints.m4828getMaxHeightimpl(j);
        final int width = (m4843constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = (m4828getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (m4843constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height2 = (m4828getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m4843constrainWidthK40F9xA, m4828getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (m4843constrainWidthK40F9xA - placeable4.getWidth()) / 2, (m4828getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1314placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        ...
        final int m4843constrainWidthK40F9xA = ConstraintsKt.m4843constrainWidthK40F9xA(j, Math.max(placeable2.getWidth(), Math.max(placeable.getWidth(), placeable4 != null ? placeable4.getWidth() : 0)));
        final int width = (m4843constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int width2 = (m4843constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width3 = (m4843constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo319roundToPx0680j_4(IndicatorVerticalPaddingWithLabel);
        return MeasureScope.layout$default(measureScope, m4843constrainWidthK40F9xA, m4828getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeLabelAndIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable5 != null) {
                    int i4 = m4843constrainWidthK40F9xA;
                    int i5 = i2;
