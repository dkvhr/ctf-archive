...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m2630equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m2636hashCodeimpl(this.containerColor) * 31) + Color.m2636hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
