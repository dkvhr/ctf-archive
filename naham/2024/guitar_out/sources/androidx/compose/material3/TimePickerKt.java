...
public final class TimePickerKt {
    ...
    */
    ...
    public static final TimePickerState rememberTimePickerState(final int i, final int i2, final boolean z, Composer composer, int i3, int i4) {
        ...
        TimePickerState timePickerState = (TimePickerState) RememberSaveableKt.m2276rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    */
    ...
    public static final void TimeInputImpl(final Modifier modifier, final TimePickerColors timePickerColors, final TimePickerState timePickerState, Composer composer, final int i) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, TimeInputBottomPadding, 7, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m484paddingqDBjuR0$default);
            ...
            Composer m2263constructorimpl = Updater.m2263constructorimpl(composer2);
            Updater.m2270setimpl(m2263constructorimpl, rowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2270setimpl(m2263constructorimpl, density, ComposeUiNode.INSTANCE.getSetDensity());
            Updater.m2270setimpl(m2263constructorimpl, layoutDirection, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            composer2.enableReusing();
            materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer2)), composer2, 0);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{TextKt.getLocalTextStyle().provides(m4418copyCXVQc50)}, ComposableLambdaKt.composableLambda(composer2, 1306700887, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        if (changed3 || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue3 = (Function1) new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$1$1
                                ...
                                public final Boolean m1576invokeZmokQxo(android.view.KeyEvent event) {
                                    ...
                                    int m3617getUtf16CodePointZmokQxo = KeyEvent_androidKt.m3617getUtf16CodePointZmokQxo(event);
                                    if (48 <= m3617getUtf16CodePointZmokQxo && m3617getUtf16CodePointZmokQxo < 58) {
                                        TimeInputImpl$lambda$52 = TimePickerKt.TimeInputImpl$lambda$5(mutableState);
                                        if (TextRange.m4404getStartimpl(TimeInputImpl$lambda$52.getSelection()) == 2) {
                                            TimeInputImpl$lambda$53 = TimePickerKt.TimeInputImpl$lambda$5(mutableState);
                                            if (TimeInputImpl$lambda$53.getText().length() == 2) {
                                                TimePickerState.this.m1595setSelectioniHAOin8$material3_release(Selection.INSTANCE.m1380getMinuteJiIwxys());
                                            }
                                        }
                                    }
                                    return false;
                        ...
                        if (changed4 || rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue4 = (Function1) new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$2$1
                                ...
                                public final void invoke2(TextFieldValue newValue) {
                                    ...
                                    int m1379getHourJiIwxys = Selection.INSTANCE.m1379getHourJiIwxys();
                                    ...
                                    TimePickerKt.m1575timeInputOnChangegIWD5Rc(m1379getHourJiIwxys, timePickerState4, newValue, TimeInputImpl$lambda$52, i5, new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$2$1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                        ...
                        int i5 = i3;
                        TimePickerKt.m1568TimePickerTextFieldlxUZ_iY(onKeyEvent, TimeInputImpl$lambda$5, function1, timePickerState4, m1379getHourJiIwxys, keyboardOptions, keyboardActions, timePickerColors2, composer3, ((i5 << 3) & 7168) | 24576 | ((i5 << 18) & 29360128), 0);
                        Modifier.Companion companion2 = Modifier.INSTANCE;
                        f = TimePickerKt.DisplaySeparatorWidth;
                        TimePickerKt.DisplaySeparator(SizeKt.m529sizeVpY3zN4(companion2, f, TimeInputTokens.INSTANCE.m2154getPeriodSelectorContainerHeightD9Ej5fM()), composer3, 6);
                        ...
                        if (changed6 || rememberedValue6 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue6 = (Function1) new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$4$1
                                ...
                                /*
                                    ...
                                    To view partially-correct code enable 'Show inconsistent code' option in preferences
                                */
                                public final java.lang.Boolean m1577invokeZmokQxo(android.view.KeyEvent r3) {
                                    /*
                                        r2 = this;
                                        java.lang.String r0 = "event"
                                        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, r0)
                                        int r3 = androidx.compose.ui.input.key.KeyEvent_androidKt.m3617getUtf16CodePointZmokQxo(r3)
                                        if (r3 != 0) goto L1d
                                        ...
                                        int r3 = androidx.compose.ui.text.TextRange.m4404getStartimpl(r0)
                                        if (r3 != 0) goto L1d
                                        r3 = 1
                                        goto L1e
                                    L1d:
                                    ...
                                    L1e:
                                        ...
                                        int r1 = r1.m1379getHourJiIwxys()
                                        r0.m1595setSelectioniHAOin8$material3_release(r1)
                                    L2b:
                                        java.lang.Boolean r3 = java.lang.Boolean.valueOf(r3)
                                        return r3
                                    */
                                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$4$1.m1577invokeZmokQxo(android.view.KeyEvent):java.lang.Boolean");
                                }
                            };
                        ...
                        if (changed7 || rememberedValue7 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue7 = (Function1) new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$5$1
                                ...
                                public final void invoke2(TextFieldValue newValue) {
                                    ...
                                    Intrinsics.checkNotNullParameter(newValue, "newValue");
                                    int m1380getMinuteJiIwxys = Selection.INSTANCE.m1380getMinuteJiIwxys();
                                    ...
                                    TimePickerKt.m1575timeInputOnChangegIWD5Rc(m1380getMinuteJiIwxys, timePickerState8, newValue, TimeInputImpl$lambda$82, 59, new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeInputImpl$1$1$5$1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(1);
                                        }
                        ...
                        int i6 = i3;
                        TimePickerKt.m1568TimePickerTextFieldlxUZ_iY(onPreviewKeyEvent, TimeInputImpl$lambda$8, function12, timePickerState8, m1380getMinuteJiIwxys, keyboardOptions2, keyboardActions2, timePickerColors3, composer3, ((i6 << 3) & 7168) | 24576 | ((i6 << 18) & 29360128), 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            if (!timePickerState.getIs24hour()) {
                Modifier m484paddingqDBjuR0$default2 = PaddingKt.m484paddingqDBjuR0$default(modifier, PeriodToggleMargin, 0.0f, 0.0f, 0.0f, 14, null);
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m484paddingqDBjuR0$default2);
                if (!(composer2.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                composer2.startReusableNode();
                ...
                composer2.disableReusing();
                Composer m2263constructorimpl2 = Updater.m2263constructorimpl(composer2);
                Updater.m2270setimpl(m2263constructorimpl2, rememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                Updater.m2270setimpl(m2263constructorimpl2, density2, ComposeUiNode.INSTANCE.getSetDensity());
                Updater.m2270setimpl(m2263constructorimpl2, layoutDirection2, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                Updater.m2270setimpl(m2263constructorimpl2, viewConfiguration2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                composer2.enableReusing();
                materializerOf2.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer2)), composer2, 0);
                composer2.startReplaceableGroup(2058660585);
    ...
    public static final void HorizontalClockDisplay(final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, 0);
            ...
            if (!timePickerState.getIs24hour()) {
                Modifier m484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, PeriodToggleMargin, 0.0f, 0.0f, 13, null);
                ...
                ViewConfiguration viewConfiguration2 = (ViewConfiguration) consume6;
                Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m484paddingqDBjuR0$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                Updater.m2270setimpl(m2263constructorimpl2, viewConfiguration2, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                startRestartGroup.enableReusing();
                materializerOf2.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, 0);
                startRestartGroup.startReplaceableGroup(2058660585);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1253629305, "C72@3384L9:Box.kt#2w3rfo");
                BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 34966463, "C806@34136L310:TimePicker.kt#uh7d8r");
                int i3 = i2 << 3;
                HorizontalPeriodToggle(SizeKt.m529sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m2166getPeriodSelectorHorizontalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m2165getPeriodSelectorHorizontalContainerHeightD9Ej5fM()), timePickerState, timePickerColors, startRestartGroup, (i3 & 896) | (i3 & 112) | 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endReplaceableGroup();
    ...
    public static final void VerticalClockDisplay(final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            if (!timePickerState.getIs24hour()) {
                Modifier m484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(Modifier.INSTANCE, PeriodToggleMargin, 0.0f, 0.0f, 0.0f, 14, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                MeasurePolicy rememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false, startRestartGroup, 0);
                startRestartGroup.startReplaceableGroup(-1323940314);
                ...
                int i3 = i2 << 3;
                VerticalPeriodToggle(SizeKt.m529sizeVpY3zN4(Modifier.INSTANCE, TimePickerTokens.INSTANCE.m2169getPeriodSelectorVerticalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m2168getPeriodSelectorVerticalContainerHeightD9Ej5fM()), timePickerState, timePickerColors, startRestartGroup, (i3 & 896) | (i3 & 112) | 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{TextKt.getLocalTextStyle().provides(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), TimePickerTokens.INSTANCE.getTimeSelectorLabelTextFont()))}, ComposableLambdaKt.composableLambda(startRestartGroup, -477913269, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockDisplayNumbers$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier.Companion companion2 = Modifier.INSTANCE;
                        f = TimePickerKt.DisplaySeparatorWidth;
                        TimePickerKt.DisplaySeparator(SizeKt.m529sizeVpY3zN4(companion2, f, TimePickerTokens.INSTANCE.m2168getPeriodSelectorVerticalContainerHeightD9Ej5fM()), composer2, 6);
                    ...
                    public final MeasureResult mo11measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long j) {
                        ...
                        for (Measurable measurable : list) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                                final Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j, 0, MathKt.roundToInt(MeasurePolicy.mo325toPx0680j_4(TimePickerTokens.INSTANCE.m2167getPeriodSelectorOutlineWidthD9Ej5fM())), 0, 0, 12, null));
                                ...
                                return MeasureScope.layout$default(MeasurePolicy, Constraints.m4829getMaxWidthimpl(j), Constraints.m4828getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1$measure$1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        Placeable.PlacementScope.place$default(layout, mo3866measureBRTryo0, arrayList4.get(0).getWidth() - (mo3866measureBRTryo0.getWidth() / 2), 0, 0.0f, 4, null);
                                    }
                                }, 4, null);
                            }
                        }
            ...
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1
                    ...
                    public final MeasureResult mo11measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long j) {
                        ...
                        for (Measurable measurable : list) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                                final Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j, 0, 0, 0, MathKt.roundToInt(MeasurePolicy.mo325toPx0680j_4(TimePickerTokens.INSTANCE.m2167getPeriodSelectorOutlineWidthD9Ej5fM())), 3, null));
                                ArrayList arrayList = new ArrayList();
                                for (Object obj : list) {
                                    if (!Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable) obj), "Spacer")) {
                                        arrayList.add(obj);
                                ...
                                return MeasureScope.layout$default(MeasurePolicy, Constraints.m4829getMaxWidthimpl(j), Constraints.m4828getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1$measure$1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        Placeable.PlacementScope.place$default(layout, mo3866measureBRTryo0, 0, arrayList4.get(0).getHeight() - (mo3866measureBRTryo0.getHeight() / 2), 0.0f, 4, null);
                                    }
                                }, 4, null);
                            }
                        }
    ...
    public static final void PeriodToggleImpl(final Modifier modifier, final TimePickerState timePickerState, final TimePickerColors timePickerColors, final MeasurePolicy measurePolicy, final Shape shape, final Shape shape2, Composer composer, final int i) {
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            BorderStroke m186BorderStrokecXLIe8U = BorderStrokeKt.m186BorderStrokecXLIe8U(TimePickerTokens.INSTANCE.m2167getPeriodSelectorOutlineWidthD9Ej5fM(), timePickerColors.getPeriodSelectorBorderColor());
            ...
            final String m1465getStringNWtq28 = Strings_androidKt.m1465getStringNWtq28(Strings.INSTANCE.m1462getTimePickerPeriodToggleadMyvUU(), startRestartGroup, 6);
            startRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            boolean changed = startRestartGroup.changed(m1465getStringNWtq28);
            Object rememberedValue = startRestartGroup.rememberedValue();
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$PeriodToggleImpl$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        SemanticsPropertiesKt.setContentDescription(semantics, m1465getStringNWtq28);
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            startRestartGroup.endReplaceableGroup();
            Modifier border = BorderKt.border(SelectableGroupKt.selectableGroup(SemanticsModifierKt.semantics$default(modifier, false, (Function1) rememberedValue, 1, null)).then(modifier), m186BorderStrokecXLIe8U, cornerBasedShape);
            startRestartGroup.startReplaceableGroup(-1323940314);
            ...
            Composer m2263constructorimpl = Updater.m2263constructorimpl(startRestartGroup);
            Updater.m2270setimpl(m2263constructorimpl, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2270setimpl(m2263constructorimpl, density, ComposeUiNode.INSTANCE.getSetDensity());
            Updater.m2270setimpl(m2263constructorimpl, layoutDirection, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i3 >> 3) & 112));
            startRestartGroup.startReplaceableGroup(2058660585);
            ...
            startRestartGroup.endReplaceableGroup();
            int i4 = (i2 << 3) & 7168;
            ToggleItem(z, shape, (Function0) rememberedValue2, timePickerColors, ComposableSingletons$TimePickerKt.INSTANCE.m1129getLambda1$material3_release(), startRestartGroup, ((i2 >> 9) & 112) | 24576 | i4);
            SpacerKt.Spacer(BackgroundKt.m159backgroundbw27NRU$default(SizeKt.fillMaxSize$default(ZIndexModifierKt.zIndex(LayoutIdKt.layoutId(Modifier.INSTANCE, "Spacer"), SeparatorZIndex), 0.0f, 1, null), ColorSchemeKt.toColor(TimePickerTokens.INSTANCE.getPeriodSelectorOutlineColor(), startRestartGroup, 6), null, 2, null), startRestartGroup, 0);
            ...
            startRestartGroup.endReplaceableGroup();
            ToggleItem(isAfternoonToggle$material3_release, shape2, (Function0) rememberedValue3, timePickerColors, ComposableSingletons$TimePickerKt.INSTANCE.m1130getLambda2$material3_release(), startRestartGroup, ((i2 >> 12) & 112) | 24576 | i4);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
            startRestartGroup.endReplaceableGroup();
    ...
    public static final void ToggleItem(final boolean z, final Shape shape, final Function0<Unit> function0, final TimePickerColors timePickerColors, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((46811 & i2) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            long m1561periodSelectorContentColorvNxB06k$material3_release = timePickerColors.m1561periodSelectorContentColorvNxB06k$material3_release(z);
            long m1560periodSelectorContainerColorvNxB06k$material3_release = timePickerColors.m1560periodSelectorContainerColorvNxB06k$material3_release(z);
            ...
            startRestartGroup.endReplaceableGroup();
            ButtonKt.TextButton(function0, SemanticsModifierKt.semantics$default(fillMaxSize$default, false, (Function1) rememberedValue, 1, null), false, shape, ButtonDefaults.INSTANCE.m1013textButtonColorsro_MJ88(m1560periodSelectorContainerColorvNxB06k$material3_release, m1561periodSelectorContentColorvNxB06k$material3_release, 0L, 0L, startRestartGroup, 24576, 12), null, null, PaddingKt.m473PaddingValues0680j_4(Dp.m4873constructorimpl(0)), null, function3, startRestartGroup, ((i2 >> 6) & 14) | 12582912 | ((i2 << 6) & 7168) | ((i2 << 15) & 1879048192), 356);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void DisplaySeparator(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.disableReusing();
            Composer m2263constructorimpl = Updater.m2263constructorimpl(startRestartGroup);
            Updater.m2270setimpl(m2263constructorimpl, rememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2270setimpl(m2263constructorimpl, density, ComposeUiNode.INSTANCE.getSetDensity());
            Updater.m2270setimpl(m2263constructorimpl, layoutDirection, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            startRestartGroup.enableReusing();
    ...
    public static final void m1569TimeSelectoruXwN82Y(final Modifier modifier, final int i, final TimePickerState timePickerState, final int i2, final TimePickerColors timePickerColors, Composer composer, final int i3) {
        int i4;
        int m1458getTimePickerMinuteSelectionadMyvUU;
        Composer composer2;
        ...
        if ((46811 & i5) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            boolean m1375equalsimpl0 = Selection.m1375equalsimpl0(timePickerState.m1592getSelectionJiIwxys$material3_release(), i2);
            if (Selection.m1375equalsimpl0(i2, Selection.INSTANCE.m1379getHourJiIwxys())) {
                m1458getTimePickerMinuteSelectionadMyvUU = Strings.INSTANCE.m1454getTimePickerHourSelectionadMyvUU();
            } else {
                m1458getTimePickerMinuteSelectionadMyvUU = Strings.INSTANCE.m1458getTimePickerMinuteSelectionadMyvUU();
            }
            final String m1465getStringNWtq28 = Strings_androidKt.m1465getStringNWtq28(m1458getTimePickerMinuteSelectionadMyvUU, startRestartGroup, 0);
            long m1562timeSelectorContainerColorvNxB06k$material3_release = timePickerColors.m1562timeSelectorContainerColorvNxB06k$material3_release(m1375equalsimpl0);
            final long m1563timeSelectorContentColorvNxB06k$material3_release = timePickerColors.m1563timeSelectorContentColorvNxB06k$material3_release(m1375equalsimpl0);
            ...
            startRestartGroup.endReplaceableGroup();
            composer2 = startRestartGroup;
            SurfaceKt.m1475Surfaced85dljk(m1375equalsimpl0, new Function0<Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                ...
                public final void invoke(Composer composer3, int i6) {
                    ...
                    if ((i6 & 11) != 2 || !composer3.getSkipping()) {
                        ...
                        int i8 = i;
                        int i9 = i5;
                        final String m1574numberContentDescriptionYKJpE6Y = TimePickerKt.m1574numberContentDescriptionYKJpE6Y(i7, is24hour, i8, composer3, ((i9 << 3) & 896) | ((i9 >> 9) & 14));
                        Alignment center = Alignment.INSTANCE.getCenter();
                        int i10 = i;
                        long j = m1563timeSelectorContentColorvNxB06k$material3_release;
                        ...
                        Composer m2263constructorimpl = Updater.m2263constructorimpl(composer3);
                        Updater.m2270setimpl(m2263constructorimpl, rememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        Updater.m2270setimpl(m2263constructorimpl, density, ComposeUiNode.INSTANCE.getSetDensity());
                        Updater.m2270setimpl(m2263constructorimpl, layoutDirection, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                        Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                        composer3.enableReusing();
                        materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer3)), composer3, 0);
                        ...
                        composer3.startReplaceableGroup(1157296644);
                        ComposerKt.sourceInformation(composer3, "CC(remember)P(1):Composables.kt#9igjgp");
                        boolean changed2 = composer3.changed(m1574numberContentDescriptionYKJpE6Y);
                        Object rememberedValue3 = composer3.rememberedValue();
                        if (changed2 || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue3 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$3$1$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semantics) {
                                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                    SemanticsPropertiesKt.setContentDescription(semantics, m1574numberContentDescriptionYKJpE6Y);
                                }
                            };
                            composer3.updateRememberedValue(rememberedValue3);
                        }
                        ...
                        TextKt.m1552Text4IGK_g(localString, semantics$default, j, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131064);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        composer3.endReplaceableGroup();
                        composer3.endNode();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$4
            ...
            public final void invoke(Composer composer3, int i6) {
                TimePickerKt.m1569TimeSelectoruXwN82Y(Modifier.this, i, timePickerState, i2, timePickerColors, composer3, RecomposeScopeImplKt.updateChangedFlags(i3 | 1));
            }
        });
    }
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(state.getValues$material3_release(), SemanticsModifierKt.semantics$default(SizeKt.m527size3ABfNKs(BackgroundKt.m158backgroundbw27NRU(Modifier.INSTANCE, colors.getClockDialColor(), RoundedCornerShapeKt.getCircleShape()), TimePickerTokens.INSTANCE.m2160getClockDialContainerSizeD9Ej5fM()), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$1
                ...
                public final void invoke(final List<Integer> screen, Composer composer2, int i3) {
                    ...
                    drawSelector = TimePickerKt.drawSelector(SizeKt.m527size3ABfNKs(clockDial, TimePickerTokens.INSTANCE.m2160getClockDialContainerSizeD9Ej5fM()), TimePickerState.this, colors);
                    ...
                    final boolean z2 = z;
                    final int i4 = i2;
                    TimePickerKt.m1566CircularLayoutuFdPcIQ(drawSelector, f, ComposableLambdaKt.composableLambda(composer2, -1385633737, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockFace$2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer composer3, int i5) {
                            ...
                            if ((i5 & 11) != 2 || !composer3.getSkipping()) {
                                ...
                                ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(TimePickerColors.this.m1555clockDialContentColorvNxB06k$material3_release(false)))};
                                    ...
                                    public final void invoke(Composer composer4, int i7) {
                                        ...
                                        if ((i7 & 11) != 2 || !composer4.getSkipping()) {
                                            ...
                                            if (Selection.m1375equalsimpl0(timePickerState2.m1592getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1379getHourJiIwxys()) && timePickerState2.getIs24hour()) {
                                                Modifier m158backgroundbw27NRU = BackgroundKt.m158backgroundbw27NRU(SizeKt.m527size3ABfNKs(LayoutIdKt.layoutId(Modifier.INSTANCE, LayoutId.InnerCircle), TimePickerTokens.INSTANCE.m2160getClockDialContainerSizeD9Ej5fM()), Color.INSTANCE.m2664getTransparent0d7_KjU(), RoundedCornerShapeKt.getCircleShape());
                                                f2 = TimePickerKt.InnerCircleRadius;
                                                final TimePickerState timePickerState4 = timePickerState2;
                                                final boolean z5 = z3;
                                                final int i10 = i6;
                                                TimePickerKt.m1566CircularLayoutuFdPcIQ(m158backgroundbw27NRU, f2, ComposableLambdaKt.composableLambda(composer4, -448649404, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt.ClockFace.2.1.1.2
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    {
                                                        super(2);
                                                    }
    ...
    public static final Modifier drawSelector(Modifier modifier, final TimePickerState timePickerState, final TimePickerColors timePickerColors) {
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$drawSelector$1
            ...
            public final void invoke2(ContentDrawScope drawWithContent) {
                ...
                long Offset = OffsetKt.Offset(drawWithContent.mo325toPx0680j_4(DpOffset.m4934getXD9Ej5fM(TimePickerState.this.m1593getSelectorPosRKDOV3M$material3_release())), drawWithContent.mo325toPx0680j_4(DpOffset.m4936getYD9Ej5fM(TimePickerState.this.m1593getSelectorPosRKDOV3M$material3_release())));
                float f = 2;
                ...
                DrawScope.m3154drawCircleVaOC9Bg$default(contentDrawScope, Color.INSTANCE.m2655getBlack0d7_KjU(), f2, Offset, 0.0f, null, null, BlendMode.INSTANCE.m2546getClear0nO6VwU(), 56, null);
                drawWithContent.drawContent();
                DrawScope.m3154drawCircleVaOC9Bg$default(contentDrawScope, selectorColor, f2, Offset, 0.0f, null, null, BlendMode.INSTANCE.m2574getXor0nO6VwU(), 56, null);
                DrawScope.m3159drawLineNGM6Ib0$default(contentDrawScope, selectorColor, androidx.compose.ui.geometry.SizeKt.m2469getCenteruvyYCjk(drawWithContent.mo3172getSizeNHjbRc()), Offset.m2394minusMKHz9U(Offset, OffsetKt.Offset(((float) Math.cos(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue())) * f2, ((float) Math.sin(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue())) * f2)), drawWithContent.mo325toPx0680j_4(TimePickerTokens.INSTANCE.m2163getClockDialSelectorTrackContainerWidthD9Ej5fM()), 0, null, 0.0f, null, BlendMode.INSTANCE.m2573getSrcOver0nO6VwU(), 240, null);
                ...
                DrawScope.m3154drawCircleVaOC9Bg$default(contentDrawScope, timePickerColors.m1555clockDialContentColorvNxB06k$material3_release(true), f2, Offset, 0.0f, null, null, BlendMode.INSTANCE.m2556getDstOver0nO6VwU(), 56, null);
            }
        });
    }
    ...
    public static final void ClockText(final TimePickerState timePickerState, final int i, final boolean z, Composer composer, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Object consume = startRestartGroup.consume(localDensity);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final float mo325toPx0680j_4 = ((Density) consume).mo325toPx0680j_4(MaxDistance);
            startRestartGroup.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):Composables.kt#9igjgp");
            Object rememberedValue = startRestartGroup.rememberedValue();
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2379boximpl(Offset.INSTANCE.m2406getZeroF1C5BW0()), null, 2, null);
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            startRestartGroup.endReplaceableGroup();
            ...
            startRestartGroup.endReplaceableGroup();
            final String m1574numberContentDescriptionYKJpE6Y = m1574numberContentDescriptionYKJpE6Y(timePickerState.m1592getSelectionJiIwxys$material3_release(), timePickerState.getIs24hour(), i, startRestartGroup, (i3 << 3) & 896);
            ...
            Alignment center = Alignment.INSTANCE.getCenter();
            Modifier m527size3ABfNKs = SizeKt.m527size3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE), MinimumInteractiveSize);
            startRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier focusable$default = FocusableKt.focusable$default(OnGloballyPositionedModifierKt.onGloballyPositioned(m527size3ABfNKs, (Function1) rememberedValue3), false, null, 3, null);
            ...
            Modifier semantics = SemanticsModifierKt.semantics(focusable$default, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockText$2
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics2) {
                    ...
                    final TimePickerState timePickerState2 = timePickerState;
                    final float f = mo325toPx0680j_4;
                    final boolean z3 = z;
                        ...
                        public static final class C00401 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            public final Object invokeSuspend(Object obj) {
                                ...
                                if (i == 0) {
                                    ...
                                    float m2390getXimpl = Offset.m2390getXimpl(ClockText$lambda$29);
                                    ClockText$lambda$292 = TimePickerKt.ClockText$lambda$29(this.$center$delegate);
                                    this.label = 1;
                                    if (timePickerState.onTap$material3_release(m2390getXimpl, Offset.m2391getYimpl(ClockText$lambda$292), this.$maxDist, this.$autoSwitchToMinute, this) == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                } else {
                                    if (i != 1) {
            ...
            startRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            boolean changed2 = startRestartGroup.changed(m1574numberContentDescriptionYKJpE6Y);
            ...
            if (changed2 || rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                rememberedValue4 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockText$3$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver clearAndSetSemantics) {
                        ...
                        SemanticsPropertiesKt.setContentDescription(clearAndSetSemantics, m1574numberContentDescriptionYKJpE6Y);
                    }
                };
            ...
            composer2 = startRestartGroup;
            TextKt.m1552Text4IGK_g(localString, clearAndSetSemantics, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, copyAndSetFontPadding, composer2, 0, 0, 65532);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            composer2.endReplaceableGroup();
            composer2.endNode();
    ...
    */
    ...
    public static final void m1566CircularLayoutuFdPcIQ(Modifier modifier, final float f, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$1
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, final long j) {
                    ...
                    long m4820copyZbe2FdA$default = Constraints.m4820copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                    List<? extends Measurable> list = measurables;
                    ArrayList arrayList = new ArrayList();
                    ...
                    Iterator it = arrayList2.iterator();
                    while (it.hasNext()) {
                        arrayList3.add(((Measurable) it.next()).mo3866measureBRTryo0(m4820copyZbe2FdA$default));
                    }
                    final ArrayList arrayList4 = arrayList3;
                    ...
                    final Placeable mo3866measureBRTryo0 = measurable2 != null ? measurable2.mo3866measureBRTryo0(m4820copyZbe2FdA$default) : null;
                    final Placeable mo3866measureBRTryo02 = measurable3 != null ? measurable3.mo3866measureBRTryo0(m4820copyZbe2FdA$default) : null;
                    return MeasureScope.layout$default(Layout, Constraints.m4831getMinWidthimpl(j), Constraints.m4830getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$1$measure$1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            while (it4.hasNext()) {
                                ...
                                Placeable.PlacementScope.place$default(layout, placeable2, MathKt.roundToInt((Math.cos(d2) * d) + ((Constraints.m4829getMaxWidthimpl(j2) / 2) - (placeable2.getWidth() / 2))), MathKt.roundToInt((d * Math.sin(d2)) + ((Constraints.m4828getMaxHeightimpl(j2) / 2) - (placeable2.getHeight() / 2))), 0.0f, 4, null);
                                i5 = i6;
                                it4 = it5;
                            }
                            Placeable placeable3 = mo3866measureBRTryo02;
                            if (placeable3 != null) {
                                Placeable.PlacementScope.place$default(layout, placeable3, (Constraints.m4831getMinWidthimpl(j) - mo3866measureBRTryo02.getWidth()) / 2, (Constraints.m4830getMinHeightimpl(j) - mo3866measureBRTryo02.getHeight()) / 2, 0.0f, 4, null);
                            }
                        }
                    }, 4, null);
                }
            ...
            Updater.m2270setimpl(m2263constructorimpl, layoutDirection, ComposeUiNode.INSTANCE.getSetLayoutDirection());
            Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
            materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i6 >> 3) & 112));
            startRestartGroup.startReplaceableGroup(2058660585);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$CircularLayout$2
            ...
            public final void invoke(Composer composer2, int i7) {
                TimePickerKt.m1566CircularLayoutuFdPcIQ(Modifier.this, f, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final String m1574numberContentDescriptionYKJpE6Y(int i, boolean z, int i2, Composer composer, int i3) {
        int m1455getTimePickerHourSuffixadMyvUU;
        ...
        if (Selection.m1375equalsimpl0(i, Selection.INSTANCE.m1380getMinuteJiIwxys())) {
            m1455getTimePickerHourSuffixadMyvUU = Strings.INSTANCE.m1459getTimePickerMinuteSuffixadMyvUU();
        } else if (z) {
            m1455getTimePickerHourSuffixadMyvUU = Strings.INSTANCE.m1451getTimePicker24HourSuffixadMyvUU();
        } else {
            m1455getTimePickerHourSuffixadMyvUU = Strings.INSTANCE.m1455getTimePickerHourSuffixadMyvUU();
        }
        String m1466getStringiSCLEhQ = Strings_androidKt.m1466getStringiSCLEhQ(m1455getTimePickerHourSuffixadMyvUU, new Object[]{Integer.valueOf(i2)}, composer, 64);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1466getStringiSCLEhQ;
    }
