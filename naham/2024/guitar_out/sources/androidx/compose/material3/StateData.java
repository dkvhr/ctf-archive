...
public final class StateData {
    ...
    private StateData(Long l, Long l2, Long l3, IntRange yearRange, int i) {
        ...
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1166boximpl(i), null, 2, null);
    ...
    public final void m1393switchDisplayModevCnGnXg(int displayMode) {
        ...
        this.displayMode.setValue(DisplayMode.m1166boximpl(displayMode));
    }
        ...
        public final Saver<StateData, Object> Saver() {
            return ListSaverKt.listSaver(new Function2<SaverScope, StateData, List<? extends Object>>() { // from class: androidx.compose.material3.StateData$Companion$Saver$1
                ...
                public final StateData invoke2(List<? extends Object> value) {
                    ...
                    return new StateData(l, l2, l3, intRange, DisplayMode.m1167constructorimpl(((Integer) obj3).intValue()), null);
                }
            });
        }
    }
