...
public final class ExposedDropdownMenuPopupKt {
        ...
        if ((i6 & 731) != 146 || !startRestartGroup.getSkipping()) {
                        ...
                        if ((i7 & 11) != 2 || !composer5.getSkipping()) {
                            ...
                            Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public final void m1678invokeozmzZPI(long j) {
                                    PopupLayout.this.m1680setPopupContentSizefhxjrPA(IntSize.m5025boximpl(j));
                            ...
                            Composer m2263constructorimpl = Updater.m2263constructorimpl(composer5);
                            Updater.m2270setimpl(m2263constructorimpl, exposedDropdownMenuPopupKt$SimpleStack$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            Updater.m2270setimpl(m2263constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
                            Updater.m2270setimpl(m2263constructorimpl, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                            Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                            materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer5)), composer5, 0);
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    long mo3873getSizeYbymL2g = parentLayoutCoordinates.mo3873getSizeYbymL2g();
                    long positionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    PopupLayout.this.setParentBounds(IntRectKt.m5023IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2390getXimpl(positionInWindow)), MathKt.roundToInt(Offset.m2391getYimpl(positionInWindow))), mo3873getSizeYbymL2g));
                    PopupLayout.this.updatePosition();
                }
            });
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m2270setimpl(m2263constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
        materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer)), composer, Integer.valueOf((i3 >> 3) & 112));
