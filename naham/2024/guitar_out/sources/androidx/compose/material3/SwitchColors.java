...
public final class SwitchColors {
    ...
    public final State<Color> thumbColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? z2 ? this.checkedThumbColor : this.uncheckedThumbColor : z2 ? this.disabledCheckedThumbColor : this.disabledUncheckedThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> trackColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? z2 ? this.checkedTrackColor : this.uncheckedTrackColor : z2 ? this.disabledCheckedTrackColor : this.disabledUncheckedTrackColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> borderColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? z2 ? this.checkedBorderColor : this.uncheckedBorderColor : z2 ? this.disabledCheckedBorderColor : this.disabledUncheckedBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? z2 ? this.checkedIconColor : this.uncheckedIconColor : z2 ? this.disabledCheckedIconColor : this.disabledUncheckedIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.checkedThumbColor, switchColors.checkedThumbColor) && Color.m2630equalsimpl0(this.checkedTrackColor, switchColors.checkedTrackColor) && Color.m2630equalsimpl0(this.checkedBorderColor, switchColors.checkedBorderColor) && Color.m2630equalsimpl0(this.checkedIconColor, switchColors.checkedIconColor) && Color.m2630equalsimpl0(this.uncheckedThumbColor, switchColors.uncheckedThumbColor) && Color.m2630equalsimpl0(this.uncheckedTrackColor, switchColors.uncheckedTrackColor) && Color.m2630equalsimpl0(this.uncheckedBorderColor, switchColors.uncheckedBorderColor) && Color.m2630equalsimpl0(this.uncheckedIconColor, switchColors.uncheckedIconColor) && Color.m2630equalsimpl0(this.disabledCheckedThumbColor, switchColors.disabledCheckedThumbColor) && Color.m2630equalsimpl0(this.disabledCheckedTrackColor, switchColors.disabledCheckedTrackColor) && Color.m2630equalsimpl0(this.disabledCheckedBorderColor, switchColors.disabledCheckedBorderColor) && Color.m2630equalsimpl0(this.disabledCheckedIconColor, switchColors.disabledCheckedIconColor) && Color.m2630equalsimpl0(this.disabledUncheckedThumbColor, switchColors.disabledUncheckedThumbColor) && Color.m2630equalsimpl0(this.disabledUncheckedTrackColor, switchColors.disabledUncheckedTrackColor) && Color.m2630equalsimpl0(this.disabledUncheckedBorderColor, switchColors.disabledUncheckedBorderColor) && Color.m2630equalsimpl0(this.disabledUncheckedIconColor, switchColors.disabledUncheckedIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((Color.m2636hashCodeimpl(this.checkedThumbColor) * 31) + Color.m2636hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m2636hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.checkedIconColor)) * 31) + Color.m2636hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m2636hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m2636hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.uncheckedIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m2636hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m2636hashCodeimpl(this.disabledCheckedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.disabledCheckedIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m2636hashCodeimpl(this.disabledUncheckedTrackColor)) * 31) + Color.m2636hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.disabledUncheckedIconColor);
    }
}
