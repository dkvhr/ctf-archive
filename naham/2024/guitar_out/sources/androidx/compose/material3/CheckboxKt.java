...
public final class CheckboxKt {
    ...
    private static final float CheckboxSize = Dp.m4873constructorimpl(20);
    ...
    */
    ...
    public static final void m1023drawBox1wkBAMs(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
        ...
        if (Color.m2630equalsimpl0(j, j2)) {
            DrawScope.m3169drawRoundRectuAw5IA$default(drawScope, j, 0L, SizeKt.Size(m2459getWidthimpl, m2459getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f4 = m2459getWidthimpl - (2 * f2);
        DrawScope.m3169drawRoundRectuAw5IA$default(drawScope, j, OffsetKt.Offset(f2, f2), SizeKt.Size(f4, f4), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, f - f2), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
        float f5 = m2459getWidthimpl - f2;
        DrawScope.m3169drawRoundRectuAw5IA$default(drawScope, j2, OffsetKt.Offset(f3, f3), SizeKt.Size(f5, f5), CornerRadiusKt.CornerRadius$default(f - f3, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawCheck-3IgeMak, reason: not valid java name */
    public static final void m1024drawCheck3IgeMak(DrawScope drawScope, long j, float f, float f2, float f3, CheckDrawingCache checkDrawingCache) {
        Stroke stroke = new Stroke(f3, 0.0f, StrokeCap.INSTANCE.m2977getSquareKaPHkGw(), 0, null, 26, null);
        float m2459getWidthimpl = Size.m2459getWidthimpl(drawScope.mo3172getSizeNHjbRc());
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * m2459getWidthimpl, lerp3 * m2459getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(lerp * m2459getWidthimpl, lerp2 * m2459getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * m2459getWidthimpl, m2459getWidthimpl * lerp4);
        ...
        DrawScope.m3163drawPathLG529CI$default(drawScope, checkDrawingCache.getPathToDraw(), j, 0.0f, stroke, null, 0, 52, null);
    }

    static {
        float f = 2;
        CheckboxDefaultPadding = Dp.m4873constructorimpl(f);
        StrokeWidth = Dp.m4873constructorimpl(f);
        RadiusSize = Dp.m4873constructorimpl(f);
    }
}
