...
public final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        Object obj6;
        Object obj7;
        final int m1326calculateWidthDHJA7U0;
        final int m1325calculateHeightDHJA7U0;
        ...
        Placeable mo3866measureBRTryo0 = measurable != null ? measurable.mo3866measureBRTryo0(m4820copyZbe2FdA$default) : null;
        int widthOrZero = TextFieldImplKt.widthOrZero(mo3866measureBRTryo0);
        int max = Math.max(0, TextFieldImplKt.heightOrZero(mo3866measureBRTryo0));
        ...
        Placeable mo3866measureBRTryo02 = measurable2 != null ? measurable2.mo3866measureBRTryo0(ConstraintsKt.m4846offsetNN6EwU$default(m4820copyZbe2FdA$default, -widthOrZero, 0, 2, null)) : null;
        int widthOrZero2 = widthOrZero + TextFieldImplKt.widthOrZero(mo3866measureBRTryo02);
        int max2 = Math.max(max, TextFieldImplKt.heightOrZero(mo3866measureBRTryo02));
        ...
        Placeable mo3866measureBRTryo03 = measurable3 != null ? measurable3.mo3866measureBRTryo0(ConstraintsKt.m4846offsetNN6EwU$default(m4820copyZbe2FdA$default, -widthOrZero2, 0, 2, null)) : null;
        int widthOrZero3 = widthOrZero2 + TextFieldImplKt.widthOrZero(mo3866measureBRTryo03);
        int max3 = Math.max(max2, TextFieldImplKt.heightOrZero(mo3866measureBRTryo03));
        ...
        if (measurable4 != null) {
            placeable = mo3866measureBRTryo02;
            placeable2 = measurable4.mo3866measureBRTryo0(ConstraintsKt.m4846offsetNN6EwU$default(m4820copyZbe2FdA$default, -widthOrZero3, 0, 2, null));
        } else {
            placeable = mo3866measureBRTryo02;
            placeable2 = null;
        }
        ...
        int i4 = -i;
        long m4845offsetNN6EwU = ConstraintsKt.m4845offsetNN6EwU(m4820copyZbe2FdA$default, i3, i4);
        ...
        final Placeable mo3866measureBRTryo04 = measurable5 != null ? measurable5.mo3866measureBRTryo0(m4845offsetNN6EwU) : null;
        if (mo3866measureBRTryo04 != null) {
            this.onLabelMeasured.invoke(Size.m2447boximpl(SizeKt.Size(mo3866measureBRTryo04.getWidth(), mo3866measureBRTryo04.getHeight())));
        }
        int max5 = Math.max(TextFieldImplKt.heightOrZero(mo3866measureBRTryo04) / 2, measure.mo319roundToPx0680j_4(this.paddingValues.getTop()));
        long m4820copyZbe2FdA$default2 = Constraints.m4820copyZbe2FdA$default(ConstraintsKt.m4845offsetNN6EwU(j, -widthOrZero4, i4 - max5), 0, 0, 0, 0, 11, null);
        ...
        while (it6.hasNext()) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable6), TextFieldImplKt.TextFieldId)) {
                final Placeable mo3866measureBRTryo05 = measurable6.mo3866measureBRTryo0(m4820copyZbe2FdA$default2);
                long m4820copyZbe2FdA$default3 = Constraints.m4820copyZbe2FdA$default(m4820copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                ...
                Placeable mo3866measureBRTryo06 = measurable7 != null ? measurable7.mo3866measureBRTryo0(m4820copyZbe2FdA$default3) : null;
                long m4820copyZbe2FdA$default4 = Constraints.m4820copyZbe2FdA$default(ConstraintsKt.m4846offsetNN6EwU$default(m4820copyZbe2FdA$default, 0, -Math.max(max4, Math.max(TextFieldImplKt.heightOrZero(mo3866measureBRTryo05), TextFieldImplKt.heightOrZero(mo3866measureBRTryo06)) + max5 + i), 1, null), 0, 0, 0, 0, 11, null);
                ...
                Placeable mo3866measureBRTryo07 = measurable8 != null ? measurable8.mo3866measureBRTryo0(m4820copyZbe2FdA$default4) : null;
                int heightOrZero = TextFieldImplKt.heightOrZero(mo3866measureBRTryo07);
                m1326calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1326calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(mo3866measureBRTryo0), TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(mo3866measureBRTryo03), TextFieldImplKt.widthOrZero(placeable3), mo3866measureBRTryo05.getWidth(), TextFieldImplKt.widthOrZero(mo3866measureBRTryo04), TextFieldImplKt.widthOrZero(mo3866measureBRTryo06), z, j, measure.getDensity(), this.paddingValues);
                m1325calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1325calculateHeightDHJA7U0(TextFieldImplKt.heightOrZero(mo3866measureBRTryo0), TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(mo3866measureBRTryo03), TextFieldImplKt.heightOrZero(placeable3), mo3866measureBRTryo05.getHeight(), TextFieldImplKt.heightOrZero(mo3866measureBRTryo04), TextFieldImplKt.heightOrZero(mo3866measureBRTryo06), TextFieldImplKt.heightOrZero(mo3866measureBRTryo07), j, measure.getDensity(), this.paddingValues);
                int i5 = m1325calculateHeightDHJA7U0 - heightOrZero;
                for (Measurable measurable9 : list) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable9), TextFieldImplKt.ContainerId)) {
                        final Placeable mo3866measureBRTryo08 = measurable9.mo3866measureBRTryo0(ConstraintsKt.Constraints(m1326calculateWidthDHJA7U0 != Integer.MAX_VALUE ? m1326calculateWidthDHJA7U0 : 0, m1326calculateWidthDHJA7U0, i5 != Integer.MAX_VALUE ? i5 : 0, i5));
                        final Placeable placeable4 = mo3866measureBRTryo0;
                        final Placeable placeable5 = placeable;
                        final Placeable placeable6 = mo3866measureBRTryo03;
                        final Placeable placeable7 = placeable3;
                        final Placeable placeable8 = mo3866measureBRTryo06;
                        final Placeable placeable9 = mo3866measureBRTryo07;
                        return MeasureScope.layout$default(measure, m1326calculateWidthDHJA7U0, m1325calculateHeightDHJA7U0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$2
                            /* JADX INFO: Access modifiers changed from: package-private */
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                int i6 = m1325calculateHeightDHJA7U0;
                                int i7 = m1326calculateWidthDHJA7U0;
                                ...
                                Placeable placeable14 = mo3866measureBRTryo05;
                                Placeable placeable15 = mo3866measureBRTryo04;
                                Placeable placeable16 = placeable8;
                                Placeable placeable17 = mo3866measureBRTryo08;
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj5;
        Object obj6;
        int m1326calculateWidthDHJA7U0;
        ...
        for (Object obj7 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj7), TextFieldImplKt.TextFieldId)) {
                ...
                m1326calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1326calculateWidthDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intrinsicMeasurable6 != null ? function2.invoke(intrinsicMeasurable6, Integer.valueOf(i)).intValue() : 0, this.animationProgress < 1.0f, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1326calculateWidthDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj6;
        Object obj7;
        int m1325calculateHeightDHJA7U0;
        List<? extends IntrinsicMeasurable> list2 = list;
        for (Object obj8 : list2) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj8), TextFieldImplKt.TextFieldId)) {
                ...
                m1325calculateHeightDHJA7U0 = OutlinedTextFieldKt.m1325calculateHeightDHJA7U0(intValue4, intValue3, intValue5, intValue6, intValue, intValue2, intValue7, intrinsicMeasurable7 != null ? function2.invoke(intrinsicMeasurable7, Integer.valueOf(i)).intValue() : 0, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1325calculateHeightDHJA7U0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
