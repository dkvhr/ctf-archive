...
public final class SliderColors {
    ...
    public final State<Color> thumbColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> trackColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? z2 ? this.activeTrackColor : this.inactiveTrackColor : z2 ? this.disabledActiveTrackColor : this.disabledInactiveTrackColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> tickColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? z2 ? this.activeTickColor : this.inactiveTickColor : z2 ? this.disabledActiveTickColor : this.disabledInactiveTickColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m2630equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m2630equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m2630equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m2630equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m2630equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m2630equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m2630equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m2630equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m2630equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m2636hashCodeimpl(this.thumbColor) * 31) + Color.m2636hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2636hashCodeimpl(this.activeTickColor)) * 31) + Color.m2636hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2636hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2636hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2636hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2636hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2636hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2636hashCodeimpl(this.disabledInactiveTickColor);
    }
}
