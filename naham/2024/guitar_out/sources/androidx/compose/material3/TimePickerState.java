...
public final class TimePickerState {
    ...
    public TimePickerState(int i, int i2, final boolean z) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m4928boximpl(m1596invokeRKDOV3M());
            }

            /* renamed from: invoke-RKDOV3M, reason: not valid java name */
            public final long m1596invokeRKDOV3M() {
                float f;
                boolean isInnerCircle$material3_release = TimePickerState.this.isInnerCircle$material3_release();
                float f2 = 2;
                float m4873constructorimpl = Dp.m4873constructorimpl(TimePickerTokens.INSTANCE.m2162getClockDialSelectorHandleContainerSizeD9Ej5fM() / f2);
                if (z && isInnerCircle$material3_release && Selection.m1375equalsimpl0(TimePickerState.this.m1592getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1379getHourJiIwxys())) {
                    f = TimePickerKt.InnerCircleRadius;
                } else {
                    f = TimePickerKt.OuterCircleSizeRadius;
                }
                float m4873constructorimpl2 = Dp.m4873constructorimpl(Dp.m4873constructorimpl(f - m4873constructorimpl) + m4873constructorimpl);
                return DpKt.m4894DpOffsetYgX7TsA(Dp.m4873constructorimpl(Dp.m4873constructorimpl(((float) Math.cos(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue())) * m4873constructorimpl2) + Dp.m4873constructorimpl(TimePickerTokens.INSTANCE.m2160getClockDialContainerSizeD9Ej5fM() / f2)), Dp.m4873constructorimpl(Dp.m4873constructorimpl(m4873constructorimpl2 * ((float) Math.sin(TimePickerState.this.getCurrentAngle$material3_release().getValue().floatValue()))) + Dp.m4873constructorimpl(TimePickerTokens.INSTANCE.m2160getClockDialContainerSizeD9Ej5fM() / f2)));
            }
        });
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m4982boximpl(IntOffset.INSTANCE.m5001getZeronOccac()), null, 2, null);
        this.center = mutableStateOf$default;
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m1372boximpl(Selection.INSTANCE.m1379getHourJiIwxys()), null, 2, null);
    ...
    public final long m1591getCenternOccac$material3_release() {
    ...
    public final void m1594setCentergyyYBs$material3_release(long j) {
        this.center.setValue(IntOffset.m4982boximpl(j));
    }

    public final List<Integer> getValues$material3_release() {
        List<Integer> list;
        List<Integer> list2;
        if (Selection.m1375equalsimpl0(m1592getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1380getMinuteJiIwxys())) {
    ...
    public final int m1592getSelectionJiIwxys$material3_release() {
        return ((Selection) this.selection.getValue()).m1378unboximpl();
    }

    /* renamed from: setSelection-iHAOin8$material3_release, reason: not valid java name */
    public final void m1595setSelectioniHAOin8$material3_release(int i) {
        this.selection.setValue(Selection.m1372boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        float dist;
        if (Selection.m1375equalsimpl0(m1592getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1379getHourJiIwxys()) && this.is24hour) {
            dist = TimePickerKt.dist(x, y, IntOffset.m4991getXimpl(m1591getCenternOccac$material3_release()), IntOffset.m4992getYimpl(m1591getCenternOccac$material3_release()));
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L41:
            kotlin.ResultKt.throwOnFailure(r12)
            int r12 = r11.m1592getSelectionJiIwxys$material3_release()
            ...
            boolean r12 = androidx.compose.material3.Selection.m1375equalsimpl0(r12, r1)
            if (r12 == 0) goto L61
    ...
    */
    ...
    public final long m1593getSelectorPosRKDOV3M$material3_release() {
