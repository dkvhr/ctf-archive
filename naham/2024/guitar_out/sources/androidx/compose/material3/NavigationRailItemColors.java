...
public final class NavigationRailItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(!z2 ? this.disabledIconColor : z ? this.selectedIconColor : this.unselectedIconColor, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(!z2 ? this.disabledTextColor : z ? this.selectedTextColor : this.unselectedTextColor, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m2630equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m2630equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m2630equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m2630equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m2630equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m2630equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m2636hashCodeimpl(this.selectedIconColor) * 31) + Color.m2636hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2636hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2636hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2636hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m2636hashCodeimpl(this.disabledIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledTextColor);
    }
}
