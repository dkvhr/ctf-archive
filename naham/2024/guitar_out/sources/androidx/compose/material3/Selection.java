...
public final class Selection {
    ...
    private static final int Hour = m1373constructorimpl(0);
    private static final int Minute = m1373constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Selection m1372boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1373constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1374equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1378unboximpl();
    }
