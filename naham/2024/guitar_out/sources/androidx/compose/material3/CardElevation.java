...
public final class CardElevation {
    ...
    public final State<Dp> tonalElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m4871boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(Dp.m4871boximpl(f2), new CardElevation$animateElevation$2(z, animatable, this, f2, interaction, null), composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m4878equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m4878equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m4878equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m4878equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m4879hashCodeimpl(this.defaultElevation) * 31) + Dp.m4879hashCodeimpl(this.pressedElevation)) * 31) + Dp.m4879hashCodeimpl(this.focusedElevation)) * 31) + Dp.m4879hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m4879hashCodeimpl(this.disabledElevation);
    }
}
