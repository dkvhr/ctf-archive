...
public final class DisplayMode {
    ...
    private static final int Picker = m1167constructorimpl(0);
    private static final int Input = m1167constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1166boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1167constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1168equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1169equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1170hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m1170hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1174getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* renamed from: getInput-jFl-4v0, reason: not valid java name */
        public final int m1173getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    public String toString() {
        return m1171toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1171toStringimpl(int i) {
        return m1169equalsimpl0(i, Picker) ? "Picker" : m1169equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
