...
public final class SelectableChipColors {
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(!z ? z2 ? this.disabledSelectedContainerColor : this.disabledContainerColor : !z2 ? this.containerColor : this.selectedContainerColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> labelColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(!z ? this.disabledLabelColor : !z2 ? this.labelColor : this.selectedLabelColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> leadingIconContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(!z ? this.disabledLeadingIconColor : !z2 ? this.leadingIconColor : this.selectedLeadingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(!z ? this.disabledTrailingIconColor : !z2 ? this.trailingIconColor : this.selectedTrailingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m2630equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m2630equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m2630equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m2630equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m2630equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m2630equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m2630equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m2630equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m2630equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m2630equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m2630equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m2630equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m2636hashCodeimpl(this.containerColor) * 31) + Color.m2636hashCodeimpl(this.labelColor)) * 31) + Color.m2636hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2636hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2636hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2636hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2636hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m2636hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m2636hashCodeimpl(this.selectedTrailingIconColor);
    }
}
