...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m1214copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1215copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m1215copy0680j_4(float offset) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof FixedThreshold) && Dp.m4878equalsimpl0(this.offset, ((FixedThreshold) other).offset);
    }

    public int hashCode() {
        return Dp.m4879hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m4884toStringimpl(this.offset)) + ')';
    }
    ...
    public float computeThreshold(Density density, float f, float f2) {
        ...
        return f + (density.mo325toPx0680j_4(this.offset) * Math.signum(f2 - f));
    }
}
