...
public final class TimePickerColors {
    ...
    public final long m1555clockDialContentColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1560periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1561periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1562timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1563timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m2630equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m2630equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m2630equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m2630equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m2630equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m2630equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m2630equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m2630equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m2630equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m2630equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m2630equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m2636hashCodeimpl(this.clockDialColor) * 31) + Color.m2636hashCodeimpl(this.selectorColor)) * 31) + Color.m2636hashCodeimpl(this.containerColor)) * 31) + Color.m2636hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2636hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2636hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2636hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2636hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2636hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
