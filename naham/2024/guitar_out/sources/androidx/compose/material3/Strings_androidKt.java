...
public final class Strings_androidKt {
    ...
    public static final String m1466getStringiSCLEhQ(int i, Object[] formatArgs, Composer composer, int i2) {
        ...
        String m1465getStringNWtq28 = m1465getStringNWtq28(i, composer, i2 & 14);
        ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ...
        String format = String.format(locale, m1465getStringNWtq28, Arrays.copyOf(copyOf, copyOf.length));
