...
public final class NavigationDrawerKt {
    ...
    public static final DrawerState rememberDrawerState(final DrawerValue initialValue, final Function1<? super DrawerValue, Boolean> function1, Composer composer, int i, int i2) {
        ...
        DrawerState drawerState = (DrawerState) RememberSaveableKt.m2276rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    */
    ...
    public static final void m1303ScrimBx497Mc(final boolean z, final Function0<Unit> function0, final Function0<Float> function02, final long j, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            final String m1465getStringNWtq28 = Strings_androidKt.m1465getStringNWtq28(Strings.INSTANCE.m1407getCloseDraweradMyvUU(), startRestartGroup, 6);
            ...
            if (z) {
                ...
                boolean changed2 = startRestartGroup.changed(m1465getStringNWtq28) | startRestartGroup.changed(function0);
            ...
            startRestartGroup.startReplaceableGroup(511388516);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1,2):Composables.kt#9igjgp");
            boolean changed3 = startRestartGroup.changed(m2619boximpl) | startRestartGroup.changed(function02);
