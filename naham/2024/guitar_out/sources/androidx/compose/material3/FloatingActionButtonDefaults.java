...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m1836getIconSizeD9Ej5fM();

    /* renamed from: getLargeIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1219getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m1218elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m1853getContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m1863getPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m1856getFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m1857getHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1220loweredElevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m1859getLoweredContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m1862getLoweredPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m1860getLoweredFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m1861getLoweredHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m1217bottomAppBarFabElevationa9UjIt4(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m1216bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m1217bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }
}
