...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m186BorderStrokecXLIe8U(this.borderWidth, z ? this.borderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.borderColor, chipBorder.borderColor) && Color.m2630equalsimpl0(this.disabledBorderColor, chipBorder.disabledBorderColor) && Dp.m4878equalsimpl0(this.borderWidth, chipBorder.borderWidth);
    }

    public int hashCode() {
        return (((Color.m2636hashCodeimpl(this.borderColor) * 31) + Color.m2636hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m4879hashCodeimpl(this.borderWidth);
    }
}
