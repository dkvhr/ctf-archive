    ...
    public static final void m1176Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (Dp.m4878equalsimpl0(f, Dp.INSTANCE.m4891getHairlineD9Ej5fM())) {
                ...
                f2 = Dp.m4873constructorimpl(1.0f / ((Density) consume).getDensity());
            } else {
                f2 = f;
            }
            startRestartGroup.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m159backgroundbw27NRU$default(SizeKt.m513height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), f2), j, null, 2, null), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer2, int i6) {
                DividerKt.m1176Divider9IZ8Weo(Modifier.this, f3, j2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
