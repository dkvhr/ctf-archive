    ...
    public static final void m1282Scrim3JVO9M(final long j, final Function0<Unit> function0, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (j != Color.INSTANCE.m2665getUnspecified0d7_KjU()) {
                ...
                boolean changed2 = startRestartGroup.changed(m2619boximpl) | startRestartGroup.changed(animateFloatAsState);
                ...
                if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    rememberedValue2 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$Scrim$1$1
                        ...
                        public final void invoke2(DrawScope Canvas) {
                            ...
                            DrawScope.m3167drawRectnJ9OG0$default(Canvas, j2, 0L, 0L, Scrim_3J_VO9M$lambda$2, null, null, 0, 118, null);
                        }
                    };
