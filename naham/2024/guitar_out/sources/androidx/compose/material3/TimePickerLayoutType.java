...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m1583constructorimpl(0);
    private static final int Vertical = m1583constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1582boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1583constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1584equalsimpl(this.value, obj);
    }
    ...
    public static String m1587toStringimpl(int i) {
        return m1585equalsimpl0(i, Horizontal) ? "Horizontal" : m1585equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}
