    ...
    */
    ...
    public static final void OutlinedTextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> textField, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final boolean z, final float f, final Function1<? super Size, Unit> onLabelMeasured, final Function2<? super Composer, ? super Integer, Unit> container, final Function2<? super Composer, ? super Integer, Unit> function26, final PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i5 & 1533916891) != 306783378 || (i6 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m2270setimpl(m2263constructorimpl, outlinedTextFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            materializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i9 >> 3) & 112));
            ...
            if (function23 != null) {
                calculateEndPadding = Dp.m4873constructorimpl(RangesKt.coerceAtLeast(Dp.m4873constructorimpl(calculateEndPadding - TextFieldImplKt.getHorizontalIconPadding()), Dp.m4873constructorimpl(i4)));
            }
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier m484paddingqDBjuR0$default3 = PaddingKt.m484paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m515heightInVpY3zN4$default(Modifier.INSTANCE, TextFieldImplKt.getMinTextLineHeight(), 0.0f, 2, null), null, false, 3, null), function24 == null ? f2 : Dp.m4873constructorimpl(0), 0.0f, function25 == null ? f3 : Dp.m4873constructorimpl(0), 0.0f, 10, null);
            startRestartGroup.startReplaceableGroup(1116457331);
            ComposerKt.sourceInformation(startRestartGroup, "595@28047L105");
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.PlaceholderId).then(m484paddingqDBjuR0$default3), startRestartGroup, Integer.valueOf((i5 >> 3) & 112));
            }
            startRestartGroup.endReplaceableGroup();
            Modifier then3 = LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.TextFieldId).then(m484paddingqDBjuR0$default3);
            startRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
            ...
            if (function2 != null) {
                Modifier layoutId = LayoutIdKt.layoutId(SizeKt.wrapContentHeight$default(SizeKt.m515heightInVpY3zN4$default(Modifier.INSTANCE, DpKt.m4916lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f), 0.0f, 2, null), null, false, 3, null), TextFieldImplKt.LabelId);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final Modifier m1327outlineCutout12SF9DM(Modifier outlineCutout, final long j, final PaddingValues paddingValues) {
        ...
        return DrawModifierKt.drawWithContent(outlineCutout, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt$outlineCutout$1
            ...
            public final void invoke2(ContentDrawScope drawWithContent) {
                ...
                if (m2459getWidthimpl > 0.0f) {
                    f = OutlinedTextFieldKt.OutlinedTextFieldInnerPadding;
                    float f2 = drawWithContent.mo325toPx0680j_4(f);
                    float f3 = drawWithContent.mo325toPx0680j_4(paddingValues.mo431calculateLeftPaddingu2uoSUM(drawWithContent.getLayoutDirection())) - f2;
                    float f4 = 2;
                    float f5 = m2459getWidthimpl + f3 + (f2 * f4);
                    if (WhenMappings.$EnumSwitchMapping$0[drawWithContent.getLayoutDirection().ordinal()] == 1) {
                        coerceAtLeast = Size.m2459getWidthimpl(drawWithContent.mo3172getSizeNHjbRc()) - f5;
                    } else {
                        coerceAtLeast = RangesKt.coerceAtLeast(f3, 0.0f);
                    }
                    float f6 = coerceAtLeast;
                    if (WhenMappings.$EnumSwitchMapping$0[drawWithContent.getLayoutDirection().ordinal()] == 1) {
                        f5 = Size.m2459getWidthimpl(drawWithContent.mo3172getSizeNHjbRc()) - RangesKt.coerceAtLeast(f3, 0.0f);
                    }
                    float f7 = f5;
                    float m2456getHeightimpl = Size.m2456getHeightimpl(j);
                    float f8 = (-m2456getHeightimpl) / f4;
                    float f9 = m2456getHeightimpl / f4;
                    ...
                    drawContext.getTransform().mo3100clipRectN_I0leg(f6, f8, f7, f9, m2617getDifferencertfAjoo);
