...
public final class TopAppBarColors {
    ...
    public final long m1668containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long m2680lerpjxsXWHM = ColorKt.m2680lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2680lerpjxsXWHM;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m2630equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m2630equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m2630equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m2630equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m2636hashCodeimpl(this.containerColor) * 31) + Color.m2636hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2636hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2636hashCodeimpl(this.titleContentColor)) * 31) + Color.m2636hashCodeimpl(this.actionIconContentColor);
    }
}
