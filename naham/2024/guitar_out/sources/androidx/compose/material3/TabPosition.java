...
public final class TabPosition {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.left, tabPosition.left) && Dp.m4878equalsimpl0(this.width, tabPosition.width);
    }

    public int hashCode() {
        return (Dp.m4879hashCodeimpl(this.left) * 31) + Dp.m4879hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m4884toStringimpl(this.left)) + ", right=" + ((Object) Dp.m4884toStringimpl(m1505getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m4884toStringimpl(this.width)) + ')';
    }

    /* renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m1505getRightD9Ej5fM() {
        return Dp.m4873constructorimpl(this.left + this.width);
    }
}
