    ...
    */
    ...
    public static final void m1387NewLineButtonSnackbarkKq0p4A(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final TextStyle textStyle, final long j, final long j2, Composer composer, final int i) {
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(SizeKt.m534widthInVpY3zN4$default(Modifier.INSTANCE, 0.0f, ContainerMaxWidth, 1, null), 0.0f, 1, null), HorizontalSpacing, 0.0f, 0.0f, SeparateButtonExtraY, 6, null);
            ...
            Modifier m365paddingFromBaselineVpY3zN4 = AlignmentLineKt.m365paddingFromBaselineVpY3zN4(Modifier.INSTANCE, HeightToFirstLine, LongButtonVerticalOffset);
            float f = HorizontalSpacingButtonSide;
            Modifier m484paddingqDBjuR0$default2 = PaddingKt.m484paddingqDBjuR0$default(m365paddingFromBaselineVpY3zN4, 0.0f, 0.0f, f, 0.0f, 11, null);
            ...
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            Modifier m484paddingqDBjuR0$default3 = PaddingKt.m484paddingqDBjuR0$default(columnScopeInstance.align(Modifier.INSTANCE, Alignment.INSTANCE.getEnd()), 0.0f, 0.0f, function23 == null ? f : Dp.m4873constructorimpl(0), 0.0f, 11, null);
            startRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m484paddingqDBjuR0$default3);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            Updater.m2270setimpl(m2263constructorimpl4, rowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(j)), TextKt.getLocalTextStyle().provides(textStyle)}, function22, startRestartGroup, (i2 & 112) | 8);
            startRestartGroup.startReplaceableGroup(302366994);
            ComposerKt.sourceInformation(startRestartGroup, "285@12457L173");
            if (function23 != null) {
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(j2))}, function23, startRestartGroup, ((i2 >> 3) & 112) | 8);
            }
            startRestartGroup.endReplaceableGroup();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    public static final void m1388OneRowSnackbarkKq0p4A(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final TextStyle textStyle, final long j, final long j2, Composer composer, final int i) {
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(Modifier.INSTANCE, HorizontalSpacing, 0.0f, function23 == null ? HorizontalSpacingButtonSide : Dp.m4873constructorimpl(0), 0.0f, 10, null);
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j3) {
                    ...
                    int m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(j3);
                    f = SnackbarKt.ContainerMaxWidth;
                    int min = Math.min(m4829getMaxWidthimpl, Layout.mo319roundToPx0680j_4(f));
                    ...
                    Placeable mo3866measureBRTryo0 = measurable != null ? measurable.mo3866measureBRTryo0(j3) : null;
                    String str5 = str2;
                    ...
                    final Placeable mo3866measureBRTryo02 = measurable2 != null ? measurable2.mo3866measureBRTryo0(j3) : null;
                    int width = mo3866measureBRTryo0 != null ? mo3866measureBRTryo0.getWidth() : 0;
                    int height2 = mo3866measureBRTryo0 != null ? mo3866measureBRTryo0.getHeight() : 0;
                    int width2 = mo3866measureBRTryo02 != null ? mo3866measureBRTryo02.getWidth() : 0;
                    int height3 = mo3866measureBRTryo02 != null ? mo3866measureBRTryo02.getHeight() : 0;
                    if (width2 == 0) {
                        f3 = SnackbarKt.TextEndExtraSpacing;
                        i3 = Layout.mo319roundToPx0680j_4(f3);
                    } else {
                        i3 = 0;
                    }
                    int coerceAtLeast = RangesKt.coerceAtLeast(((min - width) - width2) - i3, Constraints.m4831getMinWidthimpl(j3));
                    String str6 = str3;
                    for (Measurable measurable3 : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), str6)) {
                            int i6 = height3;
                            final Placeable mo3866measureBRTryo03 = measurable3.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j3, 0, coerceAtLeast, 0, 0, 9, null));
                            int i7 = mo3866measureBRTryo03.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                            if (i7 == Integer.MIN_VALUE) {
                                throw new IllegalArgumentException("No baselines for text".toString());
                            }
                            int i8 = mo3866measureBRTryo03.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                            ...
                            if (z) {
                                int max2 = Math.max(Layout.mo319roundToPx0680j_4(SnackbarTokens.INSTANCE.m2125getSingleLineContainerHeightD9Ej5fM()), Math.max(height2, i6));
                                int height4 = (max2 - mo3866measureBRTryo03.getHeight()) / 2;
                                height = (mo3866measureBRTryo0 == null || (i5 = mo3866measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline())) == Integer.MIN_VALUE) ? 0 : (i7 + height4) - i5;
                                i4 = height4;
                                max = max2;
                            } else {
                                f2 = SnackbarKt.HeightToFirstLine;
                                int i11 = Layout.mo319roundToPx0680j_4(f2) - i7;
                                max = Math.max(Layout.mo319roundToPx0680j_4(SnackbarTokens.INSTANCE.m2126getTwoLinesContainerHeightD9Ej5fM()), mo3866measureBRTryo03.getHeight() + i11);
                                i4 = i11;
                                height = mo3866measureBRTryo0 != null ? (max - mo3866measureBRTryo0.getHeight()) / 2 : 0;
                            }
                            final int height5 = mo3866measureBRTryo02 != null ? (max - mo3866measureBRTryo02.getHeight()) / 2 : 0;
                            final Placeable placeable = mo3866measureBRTryo0;
                            return MeasureScope.layout$default(Layout, min, max, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2$measure$4
                                ...
                                public final void invoke2(Placeable.PlacementScope layout) {
                                    ...
                                    Placeable placeable2 = mo3866measureBRTryo02;
                                    if (placeable2 != null) {
            ...
            Modifier m482paddingVpY3zN4$default = PaddingKt.m482paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, "text"), 0.0f, SnackbarVerticalPadding, 1, null);
            startRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
            MeasurePolicy rememberBoxMeasurePolicy = BoxKt.rememberBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false, startRestartGroup, 0);
            startRestartGroup.startReplaceableGroup(-1323940314);
            ...
            ViewConfiguration viewConfiguration2 = (ViewConfiguration) consume6;
            Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m482paddingVpY3zN4$default);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
