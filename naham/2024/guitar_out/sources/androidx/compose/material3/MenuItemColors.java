...
public final class MenuItemColors {
    ...
    public final State<Color> textColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? this.textColor : this.disabledTextColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? this.leadingIconColor : this.disabledLeadingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(z ? this.trailingIconColor : this.disabledTrailingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.textColor, menuItemColors.textColor) && Color.m2630equalsimpl0(this.leadingIconColor, menuItemColors.leadingIconColor) && Color.m2630equalsimpl0(this.trailingIconColor, menuItemColors.trailingIconColor) && Color.m2630equalsimpl0(this.disabledTextColor, menuItemColors.disabledTextColor) && Color.m2630equalsimpl0(this.disabledLeadingIconColor, menuItemColors.disabledLeadingIconColor) && Color.m2630equalsimpl0(this.disabledTrailingIconColor, menuItemColors.disabledTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((Color.m2636hashCodeimpl(this.textColor) * 31) + Color.m2636hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2636hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2636hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2636hashCodeimpl(this.disabledTrailingIconColor);
    }
}
