...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m1694getContainerElevationD9Ej5fM();

    /* renamed from: getContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m991getContainerElevationD9Ej5fM() {
    ...
    static {
        ...
        ContentPadding = PaddingKt.m477PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m553onlybOOhFvg = WindowInsetsKt.m553onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 8), WindowInsetsSides.m564plusgK_yJZ4(WindowInsetsSides.INSTANCE.m574getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m572getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
