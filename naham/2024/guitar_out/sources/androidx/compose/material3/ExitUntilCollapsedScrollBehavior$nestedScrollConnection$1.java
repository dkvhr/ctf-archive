...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m2391getYimpl(available) > 0.0f) {
    ...
    public long mo333onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (Offset.m2391getYimpl(available) < 0.0f || Offset.m2391getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
        ...
        if (Offset.m2391getYimpl(consumed) == 0.0f && Offset.m2391getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m2391getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo332onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L81:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo332onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
