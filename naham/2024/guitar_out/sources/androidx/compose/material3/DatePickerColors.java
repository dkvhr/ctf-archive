...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        ...
        if (z3) {
            ...
            m68animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(379006329);
            ComposerKt.sourceInformation(composer, "596@26492L134");
            m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        long m2664getTransparent0d7_KjU;
        ...
        if (z) {
            m2664getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m2664getTransparent0d7_KjU = Color.INSTANCE.m2664getTransparent0d7_KjU();
        }
        long j = m2664getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceableGroup(1577406023);
            ComposerKt.sourceInformation(composer, "622@27316L134");
            rememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1577406187);
            ComposerKt.sourceInformation(composer, "627@27480L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(z2 ? this.selectedYearContentColor : z ? this.currentYearContentColor : this.yearContentColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(z ? this.selectedYearContainerColor : Color.INSTANCE.m2664getTransparent0d7_KjU(), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m2630equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m2630equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m2630equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m2630equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m2630equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m2630equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m2630equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m2630equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m2630equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m2630equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m2630equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m2630equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m2630equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m2630equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m2630equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m2630equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m2630equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m2630equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Color.m2636hashCodeimpl(this.containerColor) * 31) + Color.m2636hashCodeimpl(this.titleContentColor)) * 31) + Color.m2636hashCodeimpl(this.headlineContentColor)) * 31) + Color.m2636hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m2636hashCodeimpl(this.subheadContentColor)) * 31) + Color.m2636hashCodeimpl(this.yearContentColor)) * 31) + Color.m2636hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m2636hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m2636hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m2636hashCodeimpl(this.dayContentColor)) * 31) + Color.m2636hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m2636hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m2636hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m2636hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m2636hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m2636hashCodeimpl(this.todayContentColor)) * 31) + Color.m2636hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m2636hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m2636hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
