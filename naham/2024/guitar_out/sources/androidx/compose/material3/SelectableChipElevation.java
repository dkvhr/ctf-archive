...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            rememberedValue3 = new Animatable(Dp.m4871boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m4871boximpl(f2), new SelectableChipElevation$animateElevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481799);
            ComposerKt.sourceInformation(composer, "1712@81209L570");
            EffectsKt.LaunchedEffect(Dp.m4871boximpl(f2), new SelectableChipElevation$animateElevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m4878equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m4878equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m4878equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m4878equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m4879hashCodeimpl(this.elevation) * 31) + Dp.m4879hashCodeimpl(this.pressedElevation)) * 31) + Dp.m4879hashCodeimpl(this.focusedElevation)) * 31) + Dp.m4879hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m4879hashCodeimpl(this.disabledElevation);
    }
}
