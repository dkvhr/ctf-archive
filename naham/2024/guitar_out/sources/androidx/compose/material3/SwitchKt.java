...
public final class SwitchKt {
    ...
    */
    ...
    public static final void m1496SwitchImpl0DmnUew(final BoxScope boxScope, final boolean z, final boolean z2, final SwitchColors switchColors, final State<Float> state, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape shape, final float f, final float f2, final float f3, Composer composer, final int i, final int i2) {
        ...
        float m2146getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            float mo321toDpu2uoSUM = ((Density) consume).mo321toDpu2uoSUM(state.getValue().floatValue());
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                m4873constructorimpl = SwitchTokens.INSTANCE.m2140getPressedHandleWidthD9Ej5fM();
            } else {
                m4873constructorimpl = Dp.m4873constructorimpl(Dp.m4873constructorimpl(Dp.m4873constructorimpl(ThumbDiameter - f) * (Dp.m4873constructorimpl(mo321toDpu2uoSUM - f2) / Dp.m4873constructorimpl(f3 - f2))) + f);
            }
            ...
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                ...
                if (!z) {
                    m2146getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m2146getTrackOutlineWidthD9Ej5fM();
                } else {
                    m2146getTrackOutlineWidthD9Ej5fM = Dp.m4873constructorimpl(ThumbPathLength - SwitchTokens.INSTANCE.m2146getTrackOutlineWidthD9Ej5fM());
                }
                floatValue = density.mo325toPx0680j_4(m2146getTrackOutlineWidthD9Ej5fM);
            } else {
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m158backgroundbw27NRU);
            ...
            Updater.m2270setimpl(m2263constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m158backgroundbw27NRU2);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            Updater.m2270setimpl(m2263constructorimpl2, rememberBoxMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2270setimpl(m2263constructorimpl2, density3, ComposeUiNode.INSTANCE.getSetDensity());
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$2
            ...
            public final void invoke(Composer composer2, int i7) {
                SwitchKt.m1496SwitchImpl0DmnUew(BoxScope.this, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }

    static {
        float m2142getSelectedHandleWidthD9Ej5fM = SwitchTokens.INSTANCE.m2142getSelectedHandleWidthD9Ej5fM();
        ThumbDiameter = m2142getSelectedHandleWidthD9Ej5fM;
        UncheckedThumbDiameter = SwitchTokens.INSTANCE.m2149getUnselectedHandleWidthD9Ej5fM();
        float m2147getTrackWidthD9Ej5fM = SwitchTokens.INSTANCE.m2147getTrackWidthD9Ej5fM();
        SwitchWidth = m2147getTrackWidthD9Ej5fM;
        float m2145getTrackHeightD9Ej5fM = SwitchTokens.INSTANCE.m2145getTrackHeightD9Ej5fM();
        SwitchHeight = m2145getTrackHeightD9Ej5fM;
        float m4873constructorimpl = Dp.m4873constructorimpl(Dp.m4873constructorimpl(m2145getTrackHeightD9Ej5fM - m2142getSelectedHandleWidthD9Ej5fM) / 2);
        ThumbPadding = m4873constructorimpl;
        ThumbPathLength = Dp.m4873constructorimpl(Dp.m4873constructorimpl(m2147getTrackWidthD9Ej5fM - m2142getSelectedHandleWidthD9Ej5fM) - m4873constructorimpl);
