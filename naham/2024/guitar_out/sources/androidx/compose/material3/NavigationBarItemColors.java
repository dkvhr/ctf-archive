...
public final class NavigationBarItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(!z2 ? this.disabledIconColor : z ? this.selectedIconColor : this.unselectedIconColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(!z2 ? this.disabledTextColor : z ? this.selectedTextColor : this.unselectedTextColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m2630equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m2630equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m2630equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m2630equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m2630equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m2630equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
