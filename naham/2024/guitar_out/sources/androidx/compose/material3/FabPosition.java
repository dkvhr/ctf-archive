...
public final class FabPosition {
    ...
    private static final int Center = m1198constructorimpl(0);
    private static final int End = m1198constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1197boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1204getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-ERTFSPs, reason: not valid java name */
        public final int m1205getEndERTFSPs() {
    ...
    public static String m1202toStringimpl(int i) {
        return m1200equalsimpl0(i, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}
