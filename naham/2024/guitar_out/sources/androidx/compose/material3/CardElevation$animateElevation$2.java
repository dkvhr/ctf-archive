...
public final class CardElevation$animateElevation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (this.$enabled) {
                float m4887unboximpl = this.$animatable.getTargetValue().m4887unboximpl();
                f = this.this$0.pressedElevation;
                DragInteraction.Start start = null;
                byte b = 0;
                if (Dp.m4878equalsimpl0(m4887unboximpl, f)) {
                    start = new PressInteraction.Press(Offset.INSTANCE.m2406getZeroF1C5BW0(), b == true ? 1 : 0);
                } else {
                    f2 = this.this$0.hoveredElevation;
                    if (Dp.m4878equalsimpl0(m4887unboximpl, f2)) {
                        start = new HoverInteraction.Enter();
                    } else {
                        f3 = this.this$0.focusedElevation;
                        if (Dp.m4878equalsimpl0(m4887unboximpl, f3)) {
                            start = new FocusInteraction.Focus();
                        } else {
                            f4 = this.this$0.draggedElevation;
                            if (Dp.m4878equalsimpl0(m4887unboximpl, f4)) {
                ...
                this.label = 1;
                if (ElevationKt.m1189animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                this.label = 2;
                if (this.$animatable.snapTo(Dp.m4871boximpl(this.$target), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
