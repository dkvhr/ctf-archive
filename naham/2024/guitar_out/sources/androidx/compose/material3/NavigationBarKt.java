...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m1966getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = Dp.m4873constructorimpl(8);
    private static final float NavigationBarItemVerticalPadding = Dp.m4873constructorimpl(16);
    private static final float IndicatorVerticalOffset = Dp.m4873constructorimpl(12);
    ...
    */
    public static final void m1291NavigationBarHsRjFd4(androidx.compose.ui.Modifier r25, long r26, long r28, float r30, androidx.compose.foundation.layout.WindowInsets r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationBarKt.m1291NavigationBarHsRjFd4(androidx.compose.ui.Modifier, long, long, float, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItemBaselineLayout$2
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    Object obj;
                    Placeable placeable;
                    MeasureResult m1295placeLabelAndIconzUg2_y0;
                    MeasureResult m1294placeIconX9ElhV4;
                    Intrinsics.checkNotNullParameter(Layout, "$this$Layout");
                    Intrinsics.checkNotNullParameter(measurables, "measurables");
                    List<? extends Measurable> list = measurables;
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                            Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(j);
                            int width = mo3866measureBRTryo0.getWidth();
                            f2 = NavigationBarKt.IndicatorHorizontalPadding;
                            float f4 = 2;
                            int i3 = width + Layout.mo319roundToPx0680j_4(Dp.m4873constructorimpl(f2 * f4));
                            int roundToInt = MathKt.roundToInt(i3 * f);
                            int height = mo3866measureBRTryo0.getHeight();
                            f3 = NavigationBarKt.IndicatorVerticalPadding;
                            int i4 = height + Layout.mo319roundToPx0680j_4(Dp.m4873constructorimpl(f3 * f4));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                                    Placeable mo3866measureBRTryo02 = measurable2.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(i3, i4));
                                    ...
                                    Placeable mo3866measureBRTryo03 = measurable3 != null ? measurable3.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(roundToInt, i4)) : null;
                                    if (function24 != null) {
                                        for (Measurable measurable4 : list) {
                                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "label")) {
                                                placeable = measurable4.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                            }
                                        }
                                    ...
                                    placeable = null;
                                    if (function24 == null) {
                                        m1294placeIconX9ElhV4 = NavigationBarKt.m1294placeIconX9ElhV4(Layout, mo3866measureBRTryo0, mo3866measureBRTryo02, mo3866measureBRTryo03, j);
                                        return m1294placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(placeable);
                                    m1295placeLabelAndIconzUg2_y0 = NavigationBarKt.m1295placeLabelAndIconzUg2_y0(Layout, placeable, mo3866measureBRTryo0, mo3866measureBRTryo02, mo3866measureBRTryo03, j, z, f);
                                    return m1295placeLabelAndIconzUg2_y0;
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
            ...
            if (function24 != null) {
                Modifier m482paddingVpY3zN4$default = PaddingKt.m482paddingVpY3zN4$default(AlphaKt.alpha(LayoutIdKt.layoutId(Modifier.INSTANCE, LabelLayoutIdTag), z ? 1.0f : f), Dp.m4873constructorimpl(NavigationBarItemHorizontalPadding / 2), 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m482paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
    ...
    public static final MeasureResult m1294placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(j);
        final int m4828getMaxHeightimpl = Constraints.m4828getMaxHeightimpl(j);
        final int width = (m4829getMaxWidthimpl - placeable.getWidth()) / 2;
        final int height = (m4828getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (m4829getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int height2 = (m4828getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m4829getMaxWidthimpl, m4828getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (m4829getMaxWidthimpl - placeable4.getWidth()) / 2, (m4828getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1295placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        int m4828getMaxHeightimpl = Constraints.m4828getMaxHeightimpl(j);
        int height = m4828getMaxHeightimpl - placeable.getHeight();
        ...
        final int roundToInt = MathKt.roundToInt(((z ? i2 : (m4828getMaxHeightimpl - placeable2.getHeight()) / 2) - i2) * (1 - f));
        final int m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(j);
        final int width = (m4829getMaxWidthimpl - placeable.getWidth()) / 2;
        final int width2 = (m4829getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int width3 = (m4829getMaxWidthimpl - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo319roundToPx0680j_4(IndicatorVerticalPadding);
        return MeasureScope.layout$default(measureScope, m4829getMaxWidthimpl, m4828getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable5 != null) {
                    int i4 = m4829getMaxWidthimpl;
                    int i5 = i2;
                    MeasureScope measureScope2 = measureScope;
                    int i6 = roundToInt;
                    int width4 = (i4 - placeable5.getWidth()) / 2;
                    f3 = NavigationBarKt.IndicatorVerticalPadding;
                    Placeable.PlacementScope.placeRelative$default(layout, placeable5, width4, i6 + (i5 - measureScope2.mo319roundToPx0680j_4(f3)), 0.0f, 4, null);
                }
                if (z || f != 0.0f) {
    ...
    static {
        float f = 2;
        IndicatorHorizontalPadding = Dp.m4873constructorimpl(Dp.m4873constructorimpl(NavigationBarTokens.INSTANCE.m1964getActiveIndicatorWidthD9Ej5fM() - NavigationBarTokens.INSTANCE.m1967getIconSizeD9Ej5fM()) / f);
        IndicatorVerticalPadding = Dp.m4873constructorimpl(Dp.m4873constructorimpl(NavigationBarTokens.INSTANCE.m1963getActiveIndicatorHeightD9Ej5fM() - NavigationBarTokens.INSTANCE.m1967getIconSizeD9Ej5fM()) / f);
    }
