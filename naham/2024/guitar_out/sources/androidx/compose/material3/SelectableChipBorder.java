...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m186BorderStrokecXLIe8U(z2 ? this.selectedBorderWidth : this.borderWidth, z ? z2 ? this.selectedBorderColor : this.borderColor : z2 ? this.disabledSelectedBorderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.borderColor, selectableChipBorder.borderColor) && Color.m2630equalsimpl0(this.selectedBorderColor, selectableChipBorder.selectedBorderColor) && Color.m2630equalsimpl0(this.disabledBorderColor, selectableChipBorder.disabledBorderColor) && Color.m2630equalsimpl0(this.disabledSelectedBorderColor, selectableChipBorder.disabledSelectedBorderColor) && Dp.m4878equalsimpl0(this.borderWidth, selectableChipBorder.borderWidth) && Dp.m4878equalsimpl0(this.selectedBorderWidth, selectableChipBorder.selectedBorderWidth);
    }

    public int hashCode() {
        return (((((((((Color.m2636hashCodeimpl(this.borderColor) * 31) + Color.m2636hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m2636hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2636hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m4879hashCodeimpl(this.borderWidth)) * 31) + Dp.m4879hashCodeimpl(this.selectedBorderWidth);
    }
}
