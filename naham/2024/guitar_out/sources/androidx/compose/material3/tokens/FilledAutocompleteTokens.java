...
public final class FilledAutocompleteTokens {
    ...
    private static final float MenuContainerElevation = ElevationTokens.INSTANCE.m1817getLevel2D9Ej5fM();
    ...
    private static final float MenuListItemContainerHeight = Dp.m4873constructorimpl((float) 48.0d);
    ...
    private static final float TextFieldContainerHeight = Dp.m4873constructorimpl((float) 56.0d);
    ...
    private static final float TextFieldFocusActiveIndicatorHeight = Dp.m4873constructorimpl((float) 2.0d);
    ...
    private static final float TextFieldLeadingIconSize = Dp.m4873constructorimpl((float) 20.0d);
    ...
    private static final float TextFieldTrailingIconSize = Dp.m4873constructorimpl((float) 24.0d);
    ...
    public final float m1875getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m1876getMenuDividerHeightD9Ej5fM() {
        return MenuDividerHeight;
    }

    /* renamed from: getMenuListItemContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m1877getMenuListItemContainerHeightD9Ej5fM() {
    ...
    public final float m1878getTextFieldActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1879getTextFieldContainerHeightD9Ej5fM() {
    ...
    public final float m1880getTextFieldDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1881getTextFieldFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1882getTextFieldHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1883getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m1884getTextFieldTrailingIconSizeD9Ej5fM() {
    ...
    static {
        float f = (float) 1.0d;
        MenuDividerHeight = Dp.m4873constructorimpl(f);
        TextFieldActiveIndicatorHeight = Dp.m4873constructorimpl(f);
        TextFieldDisabledActiveIndicatorHeight = Dp.m4873constructorimpl(f);
        TextFieldHoverActiveIndicatorHeight = Dp.m4873constructorimpl(f);
    }
}
