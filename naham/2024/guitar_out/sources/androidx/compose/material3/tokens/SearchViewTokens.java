...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m4873constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m4873constructorimpl((float) 72.0d);
    ...
    public final float m2104getContainerElevationD9Ej5fM() {
    ...
    public final float m2105getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m2106getFullScreenHeaderContainerHeightD9Ej5fM() {
