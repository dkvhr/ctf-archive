...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m4873constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m4873constructorimpl((float) 48.0d);
    ...
    public final float m1716getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1717getSizeD9Ej5fM() {
        return Size;
    }
