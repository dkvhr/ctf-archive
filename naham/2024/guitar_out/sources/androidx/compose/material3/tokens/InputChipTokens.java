...
public final class InputChipTokens {
    ...
    private static final float SelectedOutlineWidth = Dp.m4873constructorimpl((float) 0.0d);
    ...
    private static final float UnselectedOutlineWidth = Dp.m4873constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m4873constructorimpl((float) 24.0d);
    ...
    public final float m1936getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }

    /* renamed from: getContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m1937getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m1938getContainerHeightD9Ej5fM() {
    ...
    public final float m1939getDraggedContainerElevationD9Ej5fM() {
    ...
    public final float m1940getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m1941getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m1942getTrailingIconSizeD9Ej5fM() {
    ...
    public final float m1943getUnselectedOutlineWidthD9Ej5fM() {
    ...
    static {
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m4873constructorimpl(f);
        TrailingIconSize = Dp.m4873constructorimpl(f);
    }
}
