...
public final class OutlinedTextFieldTokens {
    ...
    private static final float FocusOutlineWidth = Dp.m4873constructorimpl((float) 2.0d);
    ...
    public final float m2005getContainerHeightD9Ej5fM() {
    ...
    public final float m2006getDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m2007getFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m2008getHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m2009getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2010getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
    ...
    public final float m2011getTrailingIconSizeD9Ej5fM() {
    ...
    static {
        float f = (float) 1.0d;
        DisabledOutlineWidth = Dp.m4873constructorimpl(f);
        HoverOutlineWidth = Dp.m4873constructorimpl(f);
        float f2 = (float) 24.0d;
        LeadingIconSize = Dp.m4873constructorimpl(f2);
        OutlineWidth = Dp.m4873constructorimpl(f);
        TrailingIconSize = Dp.m4873constructorimpl(f2);
    }
}
