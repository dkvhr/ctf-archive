...
public final class TimeInputTokens {
    ...
    private static final float PeriodSelectorContainerWidth = Dp.m4873constructorimpl((float) 52.0d);
    ...
    private static final float TimeFieldContainerWidth = Dp.m4873constructorimpl((float) 96.0d);
    ...
    private static final float TimeFieldFocusOutlineWidth = Dp.m4873constructorimpl((float) 2.0d);
    ...
    public final float m2154getPeriodSelectorContainerHeightD9Ej5fM() {
    ...
    public final float m2155getPeriodSelectorContainerWidthD9Ej5fM() {
    ...
    public final float m2156getPeriodSelectorOutlineWidthD9Ej5fM() {
    ...
    public final float m2157getTimeFieldContainerHeightD9Ej5fM() {
    ...
    public final float m2158getTimeFieldContainerWidthD9Ej5fM() {
    ...
    public final float m2159getTimeFieldFocusOutlineWidthD9Ej5fM() {
    ...
    static {
        float f = (float) 72.0d;
        PeriodSelectorContainerHeight = Dp.m4873constructorimpl(f);
        TimeFieldContainerHeight = Dp.m4873constructorimpl(f);
    }
}
