...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m1815getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m1816getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m1815getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m4873constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m1815getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m4873constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m4873constructorimpl((float) 2.0d);
    ...
    public final float m2111getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2112getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2113getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2114getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2115getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2116getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2117getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2118getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2119getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2120getStateLayerSizeD9Ej5fM() {
    ...
    public final float m2121getTickMarksContainerSizeD9Ej5fM() {
    ...
    public final float m2122getTrackElevationD9Ej5fM() {
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m4873constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m4873constructorimpl(f2);
        HandleWidth = Dp.m4873constructorimpl(f2);
        InactiveTrackHeight = Dp.m4873constructorimpl(f);
    }
}
