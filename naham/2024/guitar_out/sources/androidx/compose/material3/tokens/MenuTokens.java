...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m4873constructorimpl((float) 48.0d);
    ...
    public final float m1959getContainerElevationD9Ej5fM() {
    ...
    public final float m1960getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m1961getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m1962getListItemTrailingIconSizeD9Ej5fM() {
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m4873constructorimpl(f);
        ListItemTrailingIconSize = Dp.m4873constructorimpl(f);
    }
}
