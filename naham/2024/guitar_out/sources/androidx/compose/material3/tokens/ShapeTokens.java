...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m733RoundedCornerShape0680j_4(Dp.m4873constructorimpl((float) 12.0d));
    private static final Shape CornerNone = RectangleShapeKt.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m733RoundedCornerShape0680j_4(Dp.m4873constructorimpl((float) 8.0d));
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m733RoundedCornerShape0680j_4(Dp.m4873constructorimpl(f));
        float f2 = (float) 0.0d;
        CornerExtraLargeTop = RoundedCornerShapeKt.m734RoundedCornerShapea9UjIt4(Dp.m4873constructorimpl(f), Dp.m4873constructorimpl(f), Dp.m4873constructorimpl(f2), Dp.m4873constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m733RoundedCornerShape0680j_4(Dp.m4873constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m734RoundedCornerShapea9UjIt4(Dp.m4873constructorimpl(f3), Dp.m4873constructorimpl(f3), Dp.m4873constructorimpl(f2), Dp.m4873constructorimpl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m733RoundedCornerShape0680j_4(Dp.m4873constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m734RoundedCornerShapea9UjIt4(Dp.m4873constructorimpl(f2), Dp.m4873constructorimpl(f4), Dp.m4873constructorimpl(f4), Dp.m4873constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m734RoundedCornerShapea9UjIt4(Dp.m4873constructorimpl(f4), Dp.m4873constructorimpl(f4), Dp.m4873constructorimpl(f2), Dp.m4873constructorimpl(f2));
    }
}
