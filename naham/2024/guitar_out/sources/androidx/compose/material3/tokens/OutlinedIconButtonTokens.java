...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m4873constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m4873constructorimpl((float) 24.0d);
    ...
    public final float m2002getContainerSizeD9Ej5fM() {
    ...
    public final float m2003getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2004getUnselectedOutlineWidthD9Ej5fM() {
