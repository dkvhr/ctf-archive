...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m4873constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m4873constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m4873constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m1816getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m1815getLevel0D9Ej5fM();
    ...
    public final float m1968getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1969getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1970getContainerWidthD9Ej5fM() {
    ...
    public final float m1971getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m1972getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m1973getStandardContainerElevationD9Ej5fM() {
