...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m4873constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m4873constructorimpl((float) 6.0d);
    ...
    public final float m1692getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m1693getSizeD9Ej5fM() {
        return Size;
    }
