...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m4873constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m1817getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m4873constructorimpl((float) 80.0d);
    ...
    public final float m1963getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1964getActiveIndicatorWidthD9Ej5fM() {
