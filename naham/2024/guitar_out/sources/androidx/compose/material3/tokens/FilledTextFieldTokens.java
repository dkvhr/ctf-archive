...
public final class FilledTextFieldTokens {
    ...
    private static final float FocusActiveIndicatorHeight = Dp.m4873constructorimpl((float) 2.0d);
    ...
    private static final float LeadingIconSize = Dp.m4873constructorimpl((float) 20.0d);
    ...
    private static final float TrailingIconSize = Dp.m4873constructorimpl((float) 24.0d);
    ...
    public final float m1901getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1902getContainerHeightD9Ej5fM() {
    ...
    public final float m1903getDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1904getFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1905getHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1906getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m1907getTrailingIconSizeD9Ej5fM() {
    ...
    static {
        float f = (float) 1.0d;
        ActiveIndicatorHeight = Dp.m4873constructorimpl(f);
        DisabledActiveIndicatorHeight = Dp.m4873constructorimpl(f);
        HoverActiveIndicatorHeight = Dp.m4873constructorimpl(f);
    }
}
