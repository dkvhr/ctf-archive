...
public final class SliderKt {
                        ...
                        if (LayoutIdKt.getLayoutId(measurable) == SliderComponents.THUMB) {
                            ...
                            for (Measurable measurable2 : list) {
                                if (LayoutIdKt.getLayoutId(measurable2) == SliderComponents.TRACK) {
                                    final Placeable mo3866measureBRTryo02 = measurable2.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(ConstraintsKt.m4846offsetNN6EwU$default(j, -mo3866measureBRTryo0.getWidth(), 0, 2, null), 0, 0, 0, 0, 11, null));
                                    int width = mo3866measureBRTryo02.getWidth() + mo3866measureBRTryo0.getWidth();
                                    int max = Math.max(mo3866measureBRTryo02.getHeight(), mo3866measureBRTryo0.getHeight());
                                    mutableState6.setValue(Float.valueOf(mo3866measureBRTryo0.getWidth()));
                                    mutableState3.setValue(Integer.valueOf(width));
                                    final int width2 = mo3866measureBRTryo0.getWidth() / 2;
                                    final int roundToInt = MathKt.roundToInt(mo3866measureBRTryo02.getWidth() * f4);
                                    final int height = (max - mo3866measureBRTryo02.getHeight()) / 2;
                                    final int height2 = (max - mo3866measureBRTryo0.getHeight()) / 2;
                                    return MeasureScope.layout$default(Layout, width, max, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SliderKt$SliderImpl$2$measure$1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, mo3866measureBRTryo0, roundToInt, height2, 0.0f, 4, null);
                                        }
                                    }, 4, null);
                                }
                            }
    ...
    */
    ...
    static {
        float m2115getHandleWidthD9Ej5fM = SliderTokens.INSTANCE.m2115getHandleWidthD9Ej5fM();
        ThumbWidth = m2115getHandleWidthD9Ej5fM;
        float m2114getHandleHeightD9Ej5fM = SliderTokens.INSTANCE.m2114getHandleHeightD9Ej5fM();
        ThumbHeight = m2114getHandleHeightD9Ej5fM;
        ThumbSize = DpKt.m4895DpSizeYgX7TsA(m2115getHandleWidthD9Ej5fM, m2114getHandleHeightD9Ej5fM);
        ...
        float m4873constructorimpl = Dp.m4873constructorimpl(48);
        SliderHeight = m4873constructorimpl;
        float m4873constructorimpl2 = Dp.m4873constructorimpl(144);
        SliderMinWidth = m4873constructorimpl2;
        DefaultSliderConstraints = SizeKt.m515heightInVpY3zN4$default(SizeKt.m534widthInVpY3zN4$default(Modifier.INSTANCE, m4873constructorimpl2, 0.0f, 2, null), 0.0f, m4873constructorimpl, 1, null);
