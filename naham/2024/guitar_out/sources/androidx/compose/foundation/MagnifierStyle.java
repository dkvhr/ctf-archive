...
public final class MagnifierStyle {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.INSTANCE.m4980getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m4968equalsimpl0(this.size, magnifierStyle.size) && Dp.m4878equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m4878equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
    }

    public int hashCode() {
        return (((((((((Boolean.hashCode(this.useTextDefault) * 31) + DpSize.m4973hashCodeimpl(this.size)) * 31) + Dp.m4879hashCodeimpl(this.cornerRadius)) * 31) + Dp.m4879hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }

    public String toString() {
        return this.useTextDefault ? "MagnifierStyle.TextDefault" : "MagnifierStyle(size=" + ((Object) DpSize.m4978toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m4884toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m4884toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
