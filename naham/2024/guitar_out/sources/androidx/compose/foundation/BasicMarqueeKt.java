...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m4873constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m165basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = DefaultMarqueeIterations;
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m230getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m224equalsimpl0(i6, MarqueeAnimationMode.INSTANCE.m230getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
        ...
        return m164basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m164basicMarquee1Mj1MLw(Modifier basicMarquee, int i, int i2, int i3, int i4, MarqueeSpacing spacing, float f) {
    ...
    public static final AnimationSpec<Float> m166createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo325toPx0680j_4(f2)), f, i3);
        long m111constructorimpl$default = StartOffset.m111constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m111constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m93repeatable91I0pcU$default(i, velocityBasedTween, null, m111constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m162MarqueeSpacing0680j_4(final float f) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$MarqueeSpacing$1
            ...
            public final int calculateSpacing(Density MarqueeSpacing, int i, int i2) {
                ...
                return MarqueeSpacing.mo319roundToPx0680j_4(f);
            }
        };
    }
}
