...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public final void m204updateUMe6uN4(boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m4260setRolekuIjeqM(semanticsPropertyReceiver, role.getValue());
        }
