...
public final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m5055hashCodeimpl(this.before)) * 31) + TextUnit.m5055hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m5051equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m5051equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m380setBeforeR2X_6o(this.before);
        node.m379setAfterR2X_6o(this.after);
    }
}
