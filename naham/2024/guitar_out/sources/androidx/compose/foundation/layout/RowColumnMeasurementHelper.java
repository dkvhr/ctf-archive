...
public final class RowColumnMeasurementHelper {
    ...
    public final RowColumnMeasureHelperResult m507measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long constraints, int startIndex, int endIndex) {
        ...
        long m449constructorimpl = OrientationIndependentConstraints.m449constructorimpl(constraints, this.orientation);
        int i11 = measureScope.mo319roundToPx0680j_4(this.arrangementSpacing);
        ...
        while (true) {
            ...
            if (weight > f) {
                ...
                int m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(m449constructorimpl);
                ...
                if (placeable == null) {
                    ...
                    i9 = i14;
                    i10 = i13;
                    placeable = measurable.mo3866measureBRTryo0(OrientationIndependentConstraints.m462toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m451copyyUG9Ft0$default(m449constructorimpl, 0, m4829getMaxWidthimpl == Integer.MAX_VALUE ? Integer.MAX_VALUE : m4829getMaxWidthimpl - i18, 0, 0, 8, null), this.orientation));
                } else {
                    i7 = m4829getMaxWidthimpl;
                    i8 = i16;
                    i9 = i14;
        ...
        if (i17 == 0) {
            ...
            if (f2 > 0.0f && Constraints.m4829getMaxWidthimpl(m449constructorimpl) != Integer.MAX_VALUE) {
                m4831getMinWidthimpl = Constraints.m4829getMaxWidthimpl(m449constructorimpl);
            } else {
                m4831getMinWidthimpl = Constraints.m4831getMinWidthimpl(m449constructorimpl);
            }
            int i23 = i11 * (i17 - 1);
            int i24 = (m4831getMinWidthimpl - i18) - i23;
            ...
            while (i27 < endIndex) {
                if (this.placeables[i27] == null) {
                    ...
                    Placeable mo3866measureBRTryo0 = measurable2.mo3866measureBRTryo0(OrientationIndependentConstraints.m462toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m447constructorimpl(i3, max3, i21, Constraints.m4828getMaxHeightimpl(m449constructorimpl)), this.orientation));
                    i28 += mainAxisSize(mo3866measureBRTryo0);
                    i2 = Math.max(i2, crossAxisSize(mo3866measureBRTryo0));
                    int i30 = (i19 != 0 || RowColumnImplKt.isRelative(rowColumnParentData2)) ? 1 : i21;
                    this.placeables[i27] = mo3866measureBRTryo0;
                    i26 = i4;
                    i19 = i30;
                }
                i27++;
            ...
            coerceAtMost = RangesKt.coerceAtMost(i28 + i23, Constraints.m4829getMaxWidthimpl(m449constructorimpl) - i18);
        }
        if (i19 != 0) {
            int i31 = i21;
            int i32 = i31;
            for (int i33 = startIndex; i33 < endIndex; i33++) {
                ...
                if (calculateAlignmentLinePosition$foundation_layout_release != null) {
                    ...
                    i32 = Math.max(i32, crossAxisSize - intValue2);
                }
            }
            int i34 = i32;
            i6 = i31;
        ...
        int max4 = Math.max(i18 + coerceAtMost, Constraints.m4831getMinWidthimpl(m449constructorimpl));
        if (Constraints.m4828getMaxHeightimpl(m449constructorimpl) == Integer.MAX_VALUE || this.crossAxisSize != SizeMode.Expand) {
            max = Math.max(i2, Math.max(Constraints.m4830getMinHeightimpl(m449constructorimpl), i5 + i6));
        } else {
            max = Constraints.m4828getMaxHeightimpl(m449constructorimpl);
        }
        ...
        for (int i36 = i21; i36 < i12; i36++) {
            Placeable placeable3 = this.placeables[i36 + startIndex];
