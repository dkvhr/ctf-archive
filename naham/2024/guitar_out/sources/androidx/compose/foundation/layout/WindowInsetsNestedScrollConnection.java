...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        return m556scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m2390getXimpl(available), Offset.m2391getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo333onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m556scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m2390getXimpl(available), Offset.m2391getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m556scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    return this.sideCalculator.mo508consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo557onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m555flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m5098getXimpl(j), Velocity.m5099getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo332onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m555flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m5098getXimpl(j2), Velocity.m5099getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m555flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instructions count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m555flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
