...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo434calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long mo434calculateContentConstraintsl58MMJ0 = mo434calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            mo434calculateContentConstraintsl58MMJ0 = ConstraintsKt.m4841constrainN9IONVI(j, mo434calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(mo434calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3924placeRelative70tqf50$default(layout, Placeable.this, IntOffset.INSTANCE.m5001getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
