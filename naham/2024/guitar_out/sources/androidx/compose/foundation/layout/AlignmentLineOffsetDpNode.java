...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m373setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public final void m374setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        m360alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m360alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, j);
