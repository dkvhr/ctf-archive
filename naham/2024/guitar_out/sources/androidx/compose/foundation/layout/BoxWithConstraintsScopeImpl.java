...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m423copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m425copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m425copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m4822equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getConstraints-msEJaDk */
    public long mo418getConstraintsmsEJaDk() {
        return this.constraints;
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m4832hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m4834toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo422getMinWidthD9Ej5fM() {
        return this.density.mo322toDpu2uoSUM(Constraints.m4831getMinWidthimpl(mo418getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo420getMaxWidthD9Ej5fM() {
        return Constraints.m4825getHasBoundedWidthimpl(mo418getConstraintsmsEJaDk()) ? this.density.mo322toDpu2uoSUM(Constraints.m4829getMaxWidthimpl(mo418getConstraintsmsEJaDk())) : Dp.INSTANCE.m4892getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo421getMinHeightD9Ej5fM() {
        return this.density.mo322toDpu2uoSUM(Constraints.m4830getMinHeightimpl(mo418getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo419getMaxHeightD9Ej5fM() {
        return Constraints.m4824getHasBoundedHeightimpl(mo418getConstraintsmsEJaDk()) ? this.density.mo322toDpu2uoSUM(Constraints.m4828getMaxHeightimpl(mo418getConstraintsmsEJaDk())) : Dp.INSTANCE.m4892getInfinityD9Ej5fM();
    }
}
