...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo431calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo322toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float getTop() {
        Density density = this.density;
        return density.mo322toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo432calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo322toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float getBottom() {
        Density density = this.density;
        return density.mo322toDpu2uoSUM(this.insets.getBottom(density));
    }
