...
public final class SizeKt {
    ...
    public static final Modifier m532width3ABfNKs(Modifier width, final float f) {
        ...
        return width.then(new SizeElement(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Dp.m4871boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs */
    public static final Modifier m513height3ABfNKs(Modifier height, final float f) {
    ...
    public static final Modifier m528size6HolHcs(Modifier size, long j) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return m529sizeVpY3zN4(size, DpSize.m4971getWidthD9Ej5fM(j), DpSize.m4969getHeightD9Ej5fM(j));
    }

    /* renamed from: widthIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m534widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m533widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4 */
    public static final Modifier m533widthInVpY3zN4(Modifier widthIn, final float f, final float f2) {
        ...
        return widthIn.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m4871boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m4871boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m515heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m514heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4 */
    public static final Modifier m514heightInVpY3zN4(Modifier heightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m531sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        return m530sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0 */
    public static final Modifier m530sizeInqDBjuR0(Modifier sizeIn, final float f, final float f2, final float f3, final float f4) {
        ...
        return sizeIn.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m4871boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m4871boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m4871boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m4871boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs */
    public static final Modifier m524requiredWidth3ABfNKs(Modifier requiredWidth, final float f) {
    ...
    public static final Modifier m516requiredHeight3ABfNKs(Modifier requiredHeight, final float f) {
    ...
    public static final Modifier m520requiredSize6HolHcs(Modifier requiredSize, long j) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
        return m521requiredSizeVpY3zN4(requiredSize, DpSize.m4971getWidthD9Ej5fM(j), DpSize.m4969getHeightD9Ej5fM(j));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default */
    public static /* synthetic */ Modifier m526requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m525requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4 */
    public static final Modifier m525requiredWidthInVpY3zN4(Modifier requiredWidthIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m518requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m517requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4 */
    public static final Modifier m517requiredHeightInVpY3zN4(Modifier requiredHeightIn, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m523requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m522requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0 */
    public static final Modifier m522requiredSizeInqDBjuR0(Modifier requiredSizeIn, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m512defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m511defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4 */
    public static final Modifier m511defaultMinSizeVpY3zN4(Modifier defaultMinSize, float f, float f2) {
        Intrinsics.checkNotNullParameter(defaultMinSize, "$this$defaultMinSize");
        return defaultMinSize.then(new UnspecifiedConstraintsElement(f, f2, null));
    }

    /* renamed from: size-3ABfNKs */
    public static final Modifier m527size3ABfNKs(Modifier size, final float f) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
    ...
    public static final Modifier m529sizeVpY3zN4(Modifier size, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(size, "$this$size");
        return size.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                Intrinsics.checkNotNullParameter(inspectorInfo, "$this$null");
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set("width", Dp.m4871boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m4871boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs */
    public static final Modifier m519requiredSize3ABfNKs(Modifier requiredSize, final float f) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
    ...
    public static final Modifier m521requiredSizeVpY3zN4(Modifier requiredSize, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(requiredSize, "$this$requiredSize");
