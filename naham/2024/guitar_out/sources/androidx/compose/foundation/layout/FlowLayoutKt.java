...
public final class FlowLayoutKt {
    ...
    public static final void FlowRow(Modifier modifier, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, int i, Function3<? super FlowRowScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Composer m2263constructorimpl = Updater.m2263constructorimpl(composer);
        Updater.m2270setimpl(m2263constructorimpl, rowMeasurementHelper, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        ...
        modifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer)), composer, Integer.valueOf((i5 >> 3) & 112));
    ...
    public static final void FlowColumn(Modifier modifier, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, int i, Function3<? super FlowColumnScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Composer m2263constructorimpl = Updater.m2263constructorimpl(composer);
        Updater.m2270setimpl(m2263constructorimpl, columnMeasurementHelper, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m2270setimpl(m2263constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
        if (m2263constructorimpl.getInserting() || !Intrinsics.areEqual(m2263constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            m2263constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
    ...
    public static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int i, Composer composer, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m428flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), i);
    ...
    public static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, int i, Composer composer, int i2) {
        ...
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m428flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), i);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        MeasurePolicy measurePolicy = (MeasurePolicy) rememberedValue;
    ...
    public static final MeasurePolicy m428flowMeasurePolicybs7tms(final LayoutOrientation layoutOrientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float f, final SizeMode sizeMode, final CrossAxisAlignment crossAxisAlignment, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function52, final float f2, final int i) {
        return new MeasurePolicy(function5, f, sizeMode, crossAxisAlignment, i, f2, function52) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                final FlowResult m427breakDownItemsw1Onq5I = FlowLayoutKt.m427breakDownItemsw1Onq5I(measure, rowColumnMeasurementHelper, LayoutOrientation.this, OrientationIndependentConstraints.m449constructorimpl(j, LayoutOrientation.this), this.$maxItemsInMainAxis);
                MutableVector<RowColumnMeasureHelperResult> items = m427breakDownItemsw1Onq5I.getItems();
                ...
                int crossAxisTotalSize = m427breakDownItemsw1Onq5I.getCrossAxisTotalSize() + (measure.mo319roundToPx0680j_4(this.$crossAxisArrangementSpacing) * (items.getSize() - 1));
                ...
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    crossAxisTotalSize = m427breakDownItemsw1Onq5I.getMainAxisTotalSize();
                    mainAxisTotalSize = crossAxisTotalSize;
                } else {
                    mainAxisTotalSize = m427breakDownItemsw1Onq5I.getMainAxisTotalSize();
                }
    ...
    private static final int m429measureAndCache6m2dt9o(Measurable measurable, long j, LayoutOrientation layoutOrientation, Function1<? super Placeable, Unit> function1) {
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable)) == 0.0f) {
            Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(OrientationIndependentConstraints.m462toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m451copyyUG9Ft0$default(j, 0, 0, 0, 0, 14, null), layoutOrientation));
            function1.invoke(mo3866measureBRTryo0);
            return mainAxisSize(mo3866measureBRTryo0, layoutOrientation);
        }
    ...
    public static final FlowResult m427breakDownItemsw1Onq5I(MeasureScope breakDownItems, RowColumnMeasurementHelper measureHelper, LayoutOrientation orientation, long j, int i) {
        ...
        int ceil = (int) Math.ceil(breakDownItems.mo325toPx0680j_4(measureHelper.getArrangementSpacing()));
        long m447constructorimpl = OrientationIndependentConstraints.m447constructorimpl(m4831getMinWidthimpl, m4829getMaxWidthimpl, 0, m4828getMaxHeightimpl);
        Measurable measurable = (Measurable) CollectionsKt.getOrNull(measurables, 0);
        Integer valueOf = measurable != null ? Integer.valueOf(m429measureAndCache6m2dt9o(measurable, m447constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
        ...
        while (i3 < size) {
            ...
            Integer valueOf2 = measurable2 != null ? Integer.valueOf(m429measureAndCache6m2dt9o(measurable2, m447constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
            ...
            int min = Math.min(Math.max(m4831getMinWidthimpl, i7), m4829getMaxWidthimpl);
            numArr[i6] = Integer.valueOf(i8);
            i6++;
            i2 = m4829getMaxWidthimpl;
            valueOf2 = valueOf2 != null ? Integer.valueOf(valueOf2.intValue() - ceil) : null;
            i5 = i8;
            i4 = 0;
            m4831getMinWidthimpl = min;
            i3 = i8;
            valueOf = valueOf2;
        }
        int i9 = m4831getMinWidthimpl;
        long m462toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m462toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m451copyyUG9Ft0$default(m447constructorimpl, i9, 0, 0, 0, 14, null), orientation);
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        Integer num = (Integer) ArraysKt.getOrNull(numArr, 0);
        while (num != null) {
            RowColumnMeasureHelperResult m507measureWithoutPlacing_EkL_Y = measureHelper.m507measureWithoutPlacing_EkL_Y(breakDownItems, m462toBoxConstraintsOenEA2s, i10, num.intValue());
            i11 += m507measureWithoutPlacing_EkL_Y.getCrossAxisSize();
            i9 = Math.max(i9, m507measureWithoutPlacing_EkL_Y.getMainAxisSize());
            mutableVector.add(m507measureWithoutPlacing_EkL_Y);
            i10 = num.intValue();
            i12++;
            num = (Integer) ArraysKt.getOrNull(numArr, i12);
        }
        return new FlowResult(Math.max(i9, Constraints.m4831getMinWidthimpl(j)), Math.max(i11, Constraints.m4830getMinHeightimpl(j)), mutableVector);
    }
}
