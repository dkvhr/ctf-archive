...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        ...
        node.m444setX0680j_4(this.x);
        node.m445setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.x, offsetElement.x) && Dp.m4878equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m4879hashCodeimpl(this.x) * 31) + Dp.m4879hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m4884toStringimpl(this.x)) + ", y=" + ((Object) Dp.m4884toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
