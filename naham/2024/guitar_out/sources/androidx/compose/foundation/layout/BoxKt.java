...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo11measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j) {
            Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
            Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
            return MeasureScope.layout$default(MeasurePolicy, Constraints.m4831getMinWidthimpl(j), Constraints.m4830getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final void Box(Modifier modifier, Alignment alignment, boolean z, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i, int i2) {
        ...
        modifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer)), composer, Integer.valueOf((i4 >> 3) & 112));
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo11measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j) {
                boolean matchesParentSize;
                boolean matchesParentSize2;
                boolean matchesParentSize3;
                int m4831getMinWidthimpl;
                final Placeable mo3866measureBRTryo0;
                int i;
                Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (measurables.isEmpty()) {
                    return MeasureScope.layout$default(MeasurePolicy, Constraints.m4831getMinWidthimpl(j), Constraints.m4830getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        }
                ...
                long m4820copyZbe2FdA$default = z ? j : Constraints.m4820copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    matchesParentSize3 = BoxKt.getMatchesParentSize(measurable);
                    if (!matchesParentSize3) {
                        Placeable mo3866measureBRTryo02 = measurable.mo3866measureBRTryo0(m4820copyZbe2FdA$default);
                        int max = Math.max(Constraints.m4831getMinWidthimpl(j), mo3866measureBRTryo02.getWidth());
                        i = Math.max(Constraints.m4830getMinHeightimpl(j), mo3866measureBRTryo02.getHeight());
                        mo3866measureBRTryo0 = mo3866measureBRTryo02;
                        m4831getMinWidthimpl = max;
                    } else {
                        m4831getMinWidthimpl = Constraints.m4831getMinWidthimpl(j);
                        int m4830getMinHeightimpl = Constraints.m4830getMinHeightimpl(j);
                        mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(Constraints.m4831getMinWidthimpl(j), Constraints.m4830getMinHeightimpl(j)));
                        i = m4830getMinHeightimpl;
                    }
                    final Alignment alignment2 = alignment;
                    final int i2 = m4831getMinWidthimpl;
                    final int i3 = i;
                    return MeasureScope.layout$default(MeasurePolicy, m4831getMinWidthimpl, i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                ...
                intRef.element = Constraints.m4831getMinWidthimpl(j);
                final Ref.IntRef intRef2 = new Ref.IntRef();
                intRef2.element = Constraints.m4830getMinHeightimpl(j);
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    if (matchesParentSize2) {
                        ...
                        Placeable mo3866measureBRTryo03 = measurable2.mo3866measureBRTryo0(m4820copyZbe2FdA$default);
                        placeableArr[i4] = mo3866measureBRTryo03;
                        intRef.element = Math.max(intRef.element, mo3866measureBRTryo03.getWidth());
                        intRef2.element = Math.max(intRef2.element, mo3866measureBRTryo03.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ...
                        if (matchesParentSize) {
                            placeableArr[i5] = measurable3.mo3866measureBRTryo0(Constraints);
                        }
                    }
                }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i, int i2, Alignment alignment) {
        ...
        Placeable.PlacementScope.m3923place70tqf50$default(placementScope, placeable, ((boxChildDataNode == null || (alignment2 = boxChildDataNode.getAlignment()) == null) ? alignment : alignment2).mo2280alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            modifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i3 >> 3) & 112));
