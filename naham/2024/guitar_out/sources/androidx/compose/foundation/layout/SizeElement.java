...
public final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public void update(SizeNode node) {
        ...
        node.m543setMinWidth0680j_4(this.minWidth);
        node.m542setMinHeight0680j_4(this.minHeight);
        node.m541setMaxWidth0680j_4(this.maxWidth);
        node.m540setMaxHeight0680j_4(this.maxHeight);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.minWidth, sizeElement.minWidth) && Dp.m4878equalsimpl0(this.minHeight, sizeElement.minHeight) && Dp.m4878equalsimpl0(this.maxWidth, sizeElement.maxWidth) && Dp.m4878equalsimpl0(this.maxHeight, sizeElement.maxHeight) && this.enforceIncoming == sizeElement.enforceIncoming;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m4879hashCodeimpl(this.minWidth) * 31) + Dp.m4879hashCodeimpl(this.minHeight)) * 31) + Dp.m4879hashCodeimpl(this.maxWidth)) * 31) + Dp.m4879hashCodeimpl(this.maxHeight)) * 31) + Boolean.hashCode(this.enforceIncoming);
    }
}
