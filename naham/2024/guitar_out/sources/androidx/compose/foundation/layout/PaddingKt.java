...
public final class PaddingKt {
    ...
    public static final Modifier m483paddingqDBjuR0(Modifier padding, final float f, final float f2, final float f3, final float f4) {
        ...
        return padding.then(new PaddingElement(f, f2, f3, f4, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$padding$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("start", Dp.m4871boximpl(f));
                $receiver.getProperties().set("top", Dp.m4871boximpl(f2));
                $receiver.getProperties().set("end", Dp.m4871boximpl(f3));
                $receiver.getProperties().set("bottom", Dp.m4871boximpl(f4));
            }
        }, null));
    }

    /* renamed from: padding-VpY3zN4, reason: not valid java name */
    public static final Modifier m481paddingVpY3zN4(Modifier padding, final float f, final float f2) {
        Intrinsics.checkNotNullParameter(padding, "$this$padding");
        return padding.then(new PaddingElement(f, f2, f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$padding$2
            ...
            public final void invoke2(InspectorInfo $receiver) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                $receiver.setName("padding");
                $receiver.getProperties().set("horizontal", Dp.m4871boximpl(f));
                $receiver.getProperties().set("vertical", Dp.m4871boximpl(f2));
            }
        }, null));
    }

    /* renamed from: padding-3ABfNKs, reason: not valid java name */
    public static final Modifier m480padding3ABfNKs(Modifier padding, final float f) {
        Intrinsics.checkNotNullParameter(padding, "$this$padding");
        return padding.then(new PaddingElement(f, f, f, f, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$padding$3
            ...
            public final void invoke2(InspectorInfo $receiver) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                $receiver.setName("padding");
                $receiver.setValue(Dp.m4871boximpl(f));
            }
        }, null));
    }
    ...
    public static final Modifier m478absolutePaddingqDBjuR0(Modifier absolutePadding, final float f, final float f2, final float f3, final float f4) {
        ...
        return absolutePadding.then(new PaddingElement(f, f2, f3, f4, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$absolutePadding$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("left", Dp.m4871boximpl(f));
                $receiver.getProperties().set("top", Dp.m4871boximpl(f2));
                $receiver.getProperties().set("right", Dp.m4871boximpl(f3));
                $receiver.getProperties().set("bottom", Dp.m4871boximpl(f4));
            }
        }, null));
    }
    ...
    public static final float calculateStartPadding(PaddingValues paddingValues, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            return paddingValues.mo431calculateLeftPaddingu2uoSUM(layoutDirection);
        }
        return paddingValues.mo432calculateRightPaddingu2uoSUM(layoutDirection);
    }
    ...
    public static final PaddingValues m473PaddingValues0680j_4(float f) {
        return new PaddingValuesImpl(f, f, f, f, null);
    }

    /* renamed from: PaddingValues-YgX7TsA, reason: not valid java name */
    public static final PaddingValues m474PaddingValuesYgX7TsA(float f, float f2) {
        return new PaddingValuesImpl(f, f2, f, f2, null);
    }

    /* renamed from: PaddingValues-a9UjIt4, reason: not valid java name */
    public static final PaddingValues m476PaddingValuesa9UjIt4(float f, float f2, float f3, float f4) {
        return new PaddingValuesImpl(f, f2, f3, f4, null);
    }

    /* renamed from: padding-qDBjuR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m484paddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4873constructorimpl(0);
        }
        if ((i & 2) != 0) {
            f2 = Dp.m4873constructorimpl(0);
        }
        if ((i & 4) != 0) {
            f3 = Dp.m4873constructorimpl(0);
        }
        if ((i & 8) != 0) {
            f4 = Dp.m4873constructorimpl(0);
        }
        return m483paddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: padding-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m482paddingVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4873constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m481paddingVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absolutePadding-qDBjuR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m479absolutePaddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4873constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m478absolutePaddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: PaddingValues-YgX7TsA$default, reason: not valid java name */
    public static /* synthetic */ PaddingValues m475PaddingValuesYgX7TsA$default(float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4873constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m474PaddingValuesYgX7TsA(f, f2);
    }

    /* renamed from: PaddingValues-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ PaddingValues m477PaddingValuesa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4873constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m476PaddingValuesa9UjIt4(f, f2, f3, f4);
    }
}
