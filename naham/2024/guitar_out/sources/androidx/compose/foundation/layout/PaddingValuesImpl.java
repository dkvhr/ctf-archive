...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m497getBottomD9Ej5fM$annotations() {
    }

    /* renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m498getEndD9Ej5fM$annotations() {
    }

    /* renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m499getStartD9Ej5fM$annotations() {
    }

    /* renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m500getTopD9Ej5fM$annotations() {
    }
    ...
    public final float m501getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public final float m504getTopD9Ej5fM() {
        return this.top;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m4878equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m4878equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m4878equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m4879hashCodeimpl(this.start) * 31) + Dp.m4879hashCodeimpl(this.top)) * 31) + Dp.m4879hashCodeimpl(this.end)) * 31) + Dp.m4879hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m4884toStringimpl(this.start)) + ", top=" + ((Object) Dp.m4884toStringimpl(this.top)) + ", end=" + ((Object) Dp.m4884toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m4884toStringimpl(this.bottom)) + ')';
    }
