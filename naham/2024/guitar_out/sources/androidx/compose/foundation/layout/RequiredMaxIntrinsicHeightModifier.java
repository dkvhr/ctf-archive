...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo434calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(calculateContentConstraints, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.INSTANCE.m4838fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m4829getMaxWidthimpl(j)));
    }
