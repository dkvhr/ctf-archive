...
public final class SpacerKt {
    public static final void Spacer(Modifier modifier, Composer composer, int i) {
        ...
        Updater.m2270setimpl(m2263constructorimpl, spacerMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        ...
        modifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer)), composer, Integer.valueOf((i2 >> 3) & 112));
