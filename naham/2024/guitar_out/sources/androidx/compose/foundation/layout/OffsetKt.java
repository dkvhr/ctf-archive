...
public final class OffsetKt {
    ...
    public static final Modifier m440offsetVpY3zN4(Modifier offset, final float f, final float f2) {
        ...
        return offset.then(new OffsetElement(f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("x", Dp.m4871boximpl(f));
                $receiver.getProperties().set("y", Dp.m4871boximpl(f2));
            }
        }, null));
    }

    /* renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m438absoluteOffsetVpY3zN4(Modifier absoluteOffset, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m441offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m440offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m439absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4873constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m438absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
