...
public final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final void m469setBottom0680j_4(float f) {
        this.bottom = f;
    }

    /* renamed from: setEnd-0680j_4, reason: not valid java name */
    public final void m470setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m471setStart0680j_4(float f) {
        this.start = f;
    }

    /* renamed from: setTop-0680j_4, reason: not valid java name */
    public final void m472setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    private PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if (f >= 0.0f || Dp.m4878equalsimpl0(f, Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM())) {
            float f5 = this.top;
            if (f5 >= 0.0f || Dp.m4878equalsimpl0(f5, Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM())) {
                float f6 = this.end;
                if (f6 >= 0.0f || Dp.m4878equalsimpl0(f6, Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM())) {
                    float f7 = this.bottom;
                    if (f7 >= 0.0f || Dp.m4878equalsimpl0(f7, Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM())) {
                        return;
                    }
                }
            }
    ...
    public void update(PaddingNode node) {
        ...
        node.m491setStart0680j_4(this.start);
        node.m492setTop0680j_4(this.top);
        node.m490setEnd0680j_4(this.end);
        node.m489setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m4879hashCodeimpl(this.start) * 31) + Dp.m4879hashCodeimpl(this.top)) * 31) + Dp.m4879hashCodeimpl(this.end)) * 31) + Dp.m4879hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement paddingElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return paddingElement != null && Dp.m4878equalsimpl0(this.start, paddingElement.start) && Dp.m4878equalsimpl0(this.top, paddingElement.top) && Dp.m4878equalsimpl0(this.end, paddingElement.end) && Dp.m4878equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m4873constructorimpl(0) : f, (i & 2) != 0 ? Dp.m4873constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m4873constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m4873constructorimpl(0) : f4, z, function1, null);
    }
}
