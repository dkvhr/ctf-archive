...
final class FixedDpInsets implements WindowInsets {
    ...
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m4884toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m4884toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m4884toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m4884toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m4878equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m4878equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m4878equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m4879hashCodeimpl(this.leftDp) * 31) + Dp.m4879hashCodeimpl(this.topDp)) * 31) + Dp.m4879hashCodeimpl(this.rightDp)) * 31) + Dp.m4879hashCodeimpl(this.bottomDp);
    }
}
