...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m4873constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            ...
            public static float m399getSpacingD9Ej5fM(Horizontal horizontal) {
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m407getSpacingD9Ej5fM(Vertical vertical) {
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m401getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
    ...
    public final HorizontalOrVertical m391spacedBy0680j_4(float space) {
    ...
    public final Horizontal m392spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m393spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m4873constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m4873constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(Dp.m4873constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m402copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m404copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m404copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m4878equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }
        ...
        public final float m405getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m4879hashCodeimpl = Dp.m4879hashCodeimpl(this.space) * 31;
            boolean z = this.rtlMirror;
            int i = z;
            if (z != 0) {
                i = 1;
            }
            int i2 = (m4879hashCodeimpl + i) * 31;
        ...
        public void arrange(Density density, int i, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            if (!z) {
                ...
                while (i4 < length) {
                    ...
                    outPositions[i5] = min;
                    int min2 = Math.min(mo319roundToPx0680j_4, (i - min) - i6);
                ...
                for (int length2 = sizes.length - 1; -1 < length2; length2--) {
                    ...
                    i3 = Math.min(mo319roundToPx0680j_4, (i - min3) - i8);
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m4884toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
