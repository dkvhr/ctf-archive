...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m4827getHasFixedWidthimpl(j) ? Constraints.m4829getMaxWidthimpl(j) : 0, Constraints.m4826getHasFixedHeightimpl(j) ? Constraints.m4828getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
