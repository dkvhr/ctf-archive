...
public interface PaddingValues {
    ...
    float mo431calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM */
    float mo432calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m493getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations, reason: not valid java name */
        private static /* synthetic */ void m494getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations, reason: not valid java name */
        private static /* synthetic */ void m495getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
        private static /* synthetic */ void m496getTopD9Ej5fM$annotations() {
        }
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateLeftPadding-u2uoSUM */
        public float mo431calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateRightPadding-u2uoSUM */
        public float mo432calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m4878equalsimpl0(this.left, absolute.left) && Dp.m4878equalsimpl0(this.top, absolute.top) && Dp.m4878equalsimpl0(this.right, absolute.right) && Dp.m4878equalsimpl0(this.bottom, absolute.bottom);
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m4884toStringimpl(this.left)) + ", top=" + ((Object) Dp.m4884toStringimpl(this.top)) + ", right=" + ((Object) Dp.m4884toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m4884toStringimpl(this.bottom)) + ')';
        }

        public /* synthetic */ Absolute(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? Dp.m4873constructorimpl(0) : f, (i & 2) != 0 ? Dp.m4873constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m4873constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m4873constructorimpl(0) : f4, null);
        }
    }
}
