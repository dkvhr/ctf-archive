...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        ...
        node.m549setMinWidth0680j_4(this.minWidth);
        node.m548setMinHeight0680j_4(this.minHeight);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m4871boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m4871boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m4878equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m4879hashCodeimpl(this.minWidth) * 31) + Dp.m4879hashCodeimpl(this.minHeight);
    }
}
