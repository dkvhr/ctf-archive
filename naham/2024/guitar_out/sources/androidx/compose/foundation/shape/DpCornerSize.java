...
public final /* data */ class DpCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ DpCornerSize m730copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m731copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final DpCornerSize m731copy0680j_4(float size) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DpCornerSize) && Dp.m4878equalsimpl0(this.size, ((DpCornerSize) other).size);
    }

    /* renamed from: getValueOverride-D9Ej5fM, reason: not valid java name */
    public float m732getValueOverrideD9Ej5fM() {
        return this.size;
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m4871boximpl(m732getValueOverrideD9Ej5fM());
    }

    @Override // androidx.compose.foundation.shape.CornerSize
    /* renamed from: toPx-TmRCtEA */
    public float mo724toPxTmRCtEA(long shapeSize, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo325toPx0680j_4(this.size);
    }
