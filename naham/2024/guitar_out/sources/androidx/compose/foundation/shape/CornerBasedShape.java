...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo716createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection);
    ...
    public final Outline mo208createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        float mo724toPxTmRCtEA = this.topStart.mo724toPxTmRCtEA(size, density);
        float mo724toPxTmRCtEA2 = this.topEnd.mo724toPxTmRCtEA(size, density);
        float mo724toPxTmRCtEA3 = this.bottomEnd.mo724toPxTmRCtEA(size, density);
        float mo724toPxTmRCtEA4 = this.bottomStart.mo724toPxTmRCtEA(size, density);
        float m2458getMinDimensionimpl = Size.m2458getMinDimensionimpl(size);
        float f = mo724toPxTmRCtEA + mo724toPxTmRCtEA4;
        if (f > m2458getMinDimensionimpl) {
            float f2 = m2458getMinDimensionimpl / f;
            mo724toPxTmRCtEA *= f2;
            mo724toPxTmRCtEA4 *= f2;
        }
        float f3 = mo724toPxTmRCtEA4;
        float f4 = mo724toPxTmRCtEA2 + mo724toPxTmRCtEA3;
        if (f4 > m2458getMinDimensionimpl) {
            float f5 = m2458getMinDimensionimpl / f4;
            mo724toPxTmRCtEA2 *= f5;
            mo724toPxTmRCtEA3 *= f5;
        }
        if (mo724toPxTmRCtEA < 0.0f || mo724toPxTmRCtEA2 < 0.0f || mo724toPxTmRCtEA3 < 0.0f || f3 < 0.0f) {
            throw new IllegalArgumentException(("Corner size in Px can't be negative(topStart = " + mo724toPxTmRCtEA + ", topEnd = " + mo724toPxTmRCtEA2 + ", bottomEnd = " + mo724toPxTmRCtEA3 + ", bottomStart = " + f3 + ")!").toString());
        }
        return mo716createOutlineLjSzlW0(size, mo724toPxTmRCtEA, mo724toPxTmRCtEA2, mo724toPxTmRCtEA3, f3, layoutDirection);
    }
