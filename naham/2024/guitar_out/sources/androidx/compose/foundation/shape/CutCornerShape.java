...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo716createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2459getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m2459getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m2459getWidthimpl(size), Size.m2456getHeightimpl(size) - f2);
        Path.lineTo(Size.m2459getWidthimpl(size) - f2, Size.m2456getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m2456getHeightimpl(size));
        Path.lineTo(0.0f, Size.m2456getHeightimpl(size) - bottomEnd);
        Path.close();
