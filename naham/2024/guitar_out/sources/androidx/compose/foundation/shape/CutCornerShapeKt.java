...
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m726CutCornerShape0680j_4(float f) {
        return CutCornerShape(CornerSizeKt.m725CornerSize0680j_4(f));
    }
    ...
    public static final CutCornerShape m727CutCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new CutCornerShape(CornerSizeKt.m725CornerSize0680j_4(f), CornerSizeKt.m725CornerSize0680j_4(f2), CornerSizeKt.m725CornerSize0680j_4(f3), CornerSizeKt.m725CornerSize0680j_4(f4));
    }
    ...
    public static /* synthetic */ CutCornerShape m728CutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m727CutCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
