...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m179copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m181copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m181copy8Feqmps(float width, Brush brush, Shape shape) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4878equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }
    ...
    public final float m182getWidthD9Ej5fM() {
        return this.width;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m4879hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m4884toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void update(BorderModifierNode node) {
        ...
        node.m178setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m4871boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m2619boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m2619boximpl(((SolidColor) this.brush).getValue()));
        } else {
