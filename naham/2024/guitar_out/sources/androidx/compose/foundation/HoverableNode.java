...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo142onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m3698equalsimpl0(type, PointerEventType.INSTANCE.m3702getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m3698equalsimpl0(type, PointerEventType.INSTANCE.m3703getExit7fucELk())) {
