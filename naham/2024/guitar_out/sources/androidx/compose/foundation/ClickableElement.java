...
public final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public void update(ClickableNode node) {
        ...
        node.m201updateXHw0xAI(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode2 + (role != null ? Role.m4243hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
