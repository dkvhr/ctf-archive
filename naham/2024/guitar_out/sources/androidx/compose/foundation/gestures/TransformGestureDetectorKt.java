...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long m2394minusMKHz9U = Offset.m2394minusMKHz9U(pointerInputChange2.getPreviousPosition(), calculateCentroid2);
                long m2394minusMKHz9U2 = Offset.m2394minusMKHz9U(position, calculateCentroid);
                float m351anglek4lQ0M = m351anglek4lQ0M(m2394minusMKHz9U2) - m351anglek4lQ0M(m2394minusMKHz9U);
                float m2388getDistanceimpl = Offset.m2388getDistanceimpl(Offset.m2395plusMKHz9U(m2394minusMKHz9U2, m2394minusMKHz9U)) / 2.0f;
                if (m351anglek4lQ0M > 180.0f) {
                    m351anglek4lQ0M -= 360.0f;
                } else if (m351anglek4lQ0M < -180.0f) {
                    m351anglek4lQ0M += 360.0f;
                }
                f2 += m351anglek4lQ0M * m2388getDistanceimpl;
                f += m2388getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m351anglek4lQ0M(long j) {
        if (Offset.m2390getXimpl(j) == 0.0f && Offset.m2391getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m2390getXimpl(j), Offset.m2391getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m2387equalsimpl0(calculateCentroid, Offset.INSTANCE.m2405getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m2406getZeroF1C5BW0();
        }
        return Offset.m2394minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                f += Offset.m2388getDistanceimpl(Offset.m2394minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), calculateCentroid));
                i++;
            }
        }
        return f / i;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long m2406getZeroF1C5BW0 = Offset.INSTANCE.m2406getZeroF1C5BW0();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                m2406getZeroF1C5BW0 = Offset.m2395plusMKHz9U(m2406getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m2385divtuRUvjQ(m2406getZeroF1C5BW0, i);
    }
}
