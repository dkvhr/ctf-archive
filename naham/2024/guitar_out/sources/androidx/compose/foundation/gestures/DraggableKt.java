...
public final class DraggableKt {
    ...
    */
    ...
    public static final Object m287awaitDragSu4bsnU(AwaitPointerEventScope awaitPointerEventScope, PointerInputChange pointerInputChange, long j, final VelocityTracker velocityTracker, final SendChannel<? super DragEvent> sendChannel, final boolean z, Orientation orientation, Continuation<? super Boolean> continuation) {
        ...
        sendChannel.mo6664trySendJP2dKIU(new DragEvent.DragStarted(Offset.m2394minusMKHz9U(pointerInputChange.getPosition(), OffsetKt.Offset(Offset.m2390getXimpl(j) * Math.signum(Offset.m2390getXimpl(pointerInputChange.getPosition())), Offset.m2391getYimpl(j) * Math.signum(Offset.m2391getYimpl(pointerInputChange.getPosition())))), defaultConstructorMarker));
        sendChannel.mo6664trySendJP2dKIU(new DragEvent.DragDelta(z ? Offset.m2397timestuRUvjQ(j, -1.0f) : j, defaultConstructorMarker));
        return m288onDragOrUpAxegvzg(awaitPointerEventScope, orientation, pointerInputChange.getId(), new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableKt$awaitDrag$2
            ...
            public final void invoke2(PointerInputChange event) {
                ...
                if (z) {
                    positionChange = Offset.m2397timestuRUvjQ(positionChange, -1.0f);
                }
                sendChannel2.mo6664trySendJP2dKIU(new DragEvent.DragDelta(positionChange, null));
            }
        }, continuation);
    }
