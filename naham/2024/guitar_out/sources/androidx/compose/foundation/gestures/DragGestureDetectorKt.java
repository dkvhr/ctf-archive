...
public final class DragGestureDetectorKt {
    ...
    public static final /* synthetic */ boolean m255access$isPointerUpDmW0f2w(PointerEvent pointerEvent, long j) {
        return m273isPointerUpDmW0f2w(pointerEvent, j);
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00d7, code lost:
        ...
        if (((androidx.compose.ui.geometry.Offset.m2391getYimpl(androidx.compose.ui.input.pointer.PointerEventKt.positionChangeIgnoreConsumed(r11)) == 0.0f ? 1 : 0) ^ 1) != 0) goto L112;
     */
    /* JADX WARN: Removed duplicated region for block: B:12:0x007b  */
    /* JADX WARN: Removed duplicated region for block: B:18:0x0097  */
    /* JADX WARN: Removed duplicated region for block: B:27:0x0099  */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00d7, code lost:
        ...
        if (((androidx.compose.ui.geometry.Offset.m2390getXimpl(androidx.compose.ui.input.pointer.PointerEventKt.positionChangeIgnoreConsumed(r11)) == 0.0f ? 1 : 0) ^ 1) != 0) goto L112;
     */
    /* JADX WARN: Removed duplicated region for block: B:12:0x007b  */
    /* JADX WARN: Removed duplicated region for block: B:18:0x0097  */
    /* JADX WARN: Removed duplicated region for block: B:27:0x0099  */
    ...
    */
    ...
    private static final Object m270dragVnAYq1g$$forInline(AwaitPointerEventScope awaitPointerEventScope, long j, Function1<? super PointerInputChange, Unit> function1, Function1<? super PointerInputChange, Float> function12, Function1<? super PointerInputChange, Boolean> function13, Continuation<? super PointerInputChange> continuation) {
        ...
        long j2 = j;
        if (m273isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j2)) {
            return null;
        }
        while (true) {
    ...
    */
    ...
    private static final Object m263awaitPointerSlopOrCancellationwtdNQyU$$forInline(AwaitPointerEventScope awaitPointerEventScope, long j, int i, PointerDirectionConfig pointerDirectionConfig, boolean z, Function2<? super PointerInputChange, ? super Offset, Unit> function2, Continuation<? super PointerInputChange> continuation) {
        float f;
        PointerInputChange pointerInputChange;
        float m2388getDistanceimpl;
        long m2394minusMKHz9U;
        PointerInputChange pointerInputChange2;
        if (m273isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
            return null;
        }
        float m274pointerSlopE8SPZFQ = m274pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = j;
        float f2 = 0.0f;
        float f3 = 0.0f;
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float mo277mainAxisDeltak4lQ0M = f + (pointerDirectionConfig.mo277mainAxisDeltak4lQ0M(position) - pointerDirectionConfig.mo277mainAxisDeltak4lQ0M(previousPosition));
                f3 += pointerDirectionConfig.mo276crossAxisDeltak4lQ0M(position) - pointerDirectionConfig.mo276crossAxisDeltak4lQ0M(previousPosition);
                if (z) {
                    m2388getDistanceimpl = Math.abs(mo277mainAxisDeltak4lQ0M);
                } else {
                    m2388getDistanceimpl = Offset.m2388getDistanceimpl(pointerDirectionConfig.mo278offsetFromChangesdBAh8RU(mo277mainAxisDeltak4lQ0M, f3));
                }
                if (m2388getDistanceimpl < m274pointerSlopE8SPZFQ) {
                    ...
                    f = mo277mainAxisDeltak4lQ0M;
                } else {
                    if (z) {
                        m2394minusMKHz9U = pointerDirectionConfig.mo278offsetFromChangesdBAh8RU(mo277mainAxisDeltak4lQ0M - (Math.signum(mo277mainAxisDeltak4lQ0M) * m274pointerSlopE8SPZFQ), f3);
                    } else {
                        long mo278offsetFromChangesdBAh8RU = pointerDirectionConfig.mo278offsetFromChangesdBAh8RU(mo277mainAxisDeltak4lQ0M, f3);
                        m2394minusMKHz9U = Offset.m2394minusMKHz9U(mo278offsetFromChangesdBAh8RU, Offset.m2397timestuRUvjQ(Offset.m2385divtuRUvjQ(mo278offsetFromChangesdBAh8RU, m2388getDistanceimpl), m274pointerSlopE8SPZFQ));
                    }
                    function2.invoke(pointerInputChange3, Offset.m2379boximpl(m2394minusMKHz9U));
                    if (pointerInputChange3.isConsumed()) {
                        return pointerInputChange3;
                    }
                    f3 = 0.0f;
    ...
    static {
        float m4873constructorimpl = Dp.m4873constructorimpl((float) 0.125d);
        mouseSlop = m4873constructorimpl;
        float m4873constructorimpl2 = Dp.m4873constructorimpl(18);
        defaultTouchSlop = m4873constructorimpl2;
        mouseToTouchSlopRatio = m4873constructorimpl / m4873constructorimpl2;
    }
