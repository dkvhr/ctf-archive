...
public final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float pixels) {
        ...
        value.m335dispatchScroll3eAAhYA(this.latestScrollScope, value.m344toOffsettuRUvjQ(pixels), NestedScrollSource.INSTANCE.m3645getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float delta) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m338performRawScrollMKHz9U(value.m344toOffsettuRUvjQ(delta));
    }
}
