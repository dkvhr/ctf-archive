...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final Function1<Offset, Offset> function1 = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                    return Offset.m2379boximpl(m347invokeMKHz9U(offset.getPackedValue()));
                }

                /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                public final long m347invokeMKHz9U(long j2) {
                    ScrollingLogic scrollingLogic4 = ScrollingLogic.this;
                    return scrollingLogic4.m339reverseIfNeededMKHz9U(scrollingLogic4.m335dispatchScroll3eAAhYA(scrollScope, scrollingLogic4.m339reverseIfNeededMKHz9U(j2), NestedScrollSource.INSTANCE.m3646getFlingWNlRxjI()));
                }
            };
            ...
            ScrollScope scrollScope2 = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic5.m343toFloatk4lQ0M(function1.invoke(Offset.m2379boximpl(scrollingLogic5.m344toOffsettuRUvjQ(pixels))).getPackedValue());
                }
            };
            ...
            float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m342toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m345updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
