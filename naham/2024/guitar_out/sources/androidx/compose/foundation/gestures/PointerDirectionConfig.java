...
public interface PointerDirectionConfig {
    ...
    float mo276crossAxisDeltak4lQ0M(long offset);

    /* renamed from: mainAxisDelta-k-4lQ0M */
    float mo277mainAxisDeltak4lQ0M(long offset);

    /* renamed from: offsetFromChanges-dBAh8RU */
    long mo278offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}
