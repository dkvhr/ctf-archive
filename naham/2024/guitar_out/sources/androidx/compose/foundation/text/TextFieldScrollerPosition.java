...
public final class TextFieldScrollerPosition {
    ...
    public final void m823setPreviousSelection5zctL8(long j) {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m4409getZerod9O1mEE();
    ...
    public final int m821getOffsetToFollow5zctL8(long selection) {
        return TextRange.m4404getStartimpl(selection) != TextRange.m4404getStartimpl(this.previousSelection) ? TextRange.m4404getStartimpl(selection) : TextRange.m4399getEndimpl(selection) != TextRange.m4399getEndimpl(this.previousSelection) ? TextRange.m4399getEndimpl(selection) : TextRange.m4402getMinimpl(selection);
    }
