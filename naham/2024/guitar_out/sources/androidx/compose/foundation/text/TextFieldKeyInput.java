...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m813typedCommandZmokQxo(KeyEvent event) {
        Integer m757consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m818isTypedEventZmokQxo(event) || (m757consumeZmokQxo = this.keyCombiner.m757consumeZmokQxo(event)) == null) {
            return null;
        }
        String sb = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), m757consumeZmokQxo.intValue()).toString();
    ...
    public final boolean m814processZmokQxo(KeyEvent event) {
        final KeyCommand mo759mapZmokQxo;
        Intrinsics.checkNotNullParameter(event, "event");
        CommitTextCommand m813typedCommandZmokQxo = m813typedCommandZmokQxo(event);
        if (m813typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(m813typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m3608equalsimpl0(KeyEvent_androidKt.m3616getTypeZmokQxo(event), KeyEventType.INSTANCE.m3612getKeyDownCS__XNY()) || (mo759mapZmokQxo = this.keyMapping.mo759mapZmokQxo(event)) == null || (mo759mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
            ...
            public final void invoke2(TextFieldPreparedSelection commandExecutionContext) {
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[KeyCommand.this.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> deleteIfSelectedOr = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr2) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m4399getEndimpl(deleteIfSelectedOr2.getSelection()) - deleteIfSelectedOr2.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> deleteIfSelectedOr2 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr3) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m4399getEndimpl(deleteIfSelectedOr3.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> deleteIfSelectedOr3 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr4) {
                                ...
                                if (previousWordOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4399getEndimpl(deleteIfSelectedOr4.getSelection()) - previousWordOffset.intValue(), 0);
                                } else {
                    ...
                    case 23:
                        List<EditCommand> deleteIfSelectedOr4 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr5) {
                                ...
                                return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m4399getEndimpl(deleteIfSelectedOr5.getSelection())) : null;
                            }
                        });
                        ...
                        List<EditCommand> deleteIfSelectedOr5 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr6) {
                                ...
                                if (lineStartByOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4399getEndimpl(deleteIfSelectedOr6.getSelection()) - lineStartByOffset.intValue(), 0);
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 25:
                        List<EditCommand> deleteIfSelectedOr6 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr7) {
                                ...
                                return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m4399getEndimpl(deleteIfSelectedOr7.getSelection())) : null;
                            }
                        });
                    ...
                    case 26:
                        ...
                        i = this.imeAction;
                        onImeActionPerformed.invoke(ImeAction.m4548boximpl(i));
                        return;
                    case 27:
                        if (!this.getSingleLine()) {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m4397equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
