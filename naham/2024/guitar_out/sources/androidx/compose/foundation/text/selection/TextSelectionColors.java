...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m2630equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m2636hashCodeimpl(this.handleColor) * 31) + Color.m2636hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m2637toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m2637toStringimpl(this.backgroundColor)) + ')';
    }
}
