...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo874calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (i == 1) {
            return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m4991getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m4992getYimpl(this.offset));
        }
        if (i == 2) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4991getXimpl(this.offset)) - IntSize.m5033getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m4992getYimpl(this.offset));
        }
        if (i == 3) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4991getXimpl(this.offset)) - (IntSize.m5033getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m4992getYimpl(this.offset));
        }
