...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0, final Function0<TextLayoutResult> function02, boolean z) {
        if (z) {
            ?? r12 = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
                ...
                public void mo803onStartk4lQ0M(long startPoint) {
                    boolean m861outOfBoundary2x9bVx0;
                    ...
                    if (invoke != null) {
                        ...
                        m861outOfBoundary2x9bVx0 = SelectionControllerKt.m861outOfBoundary2x9bVx0(function03.invoke(), startPoint, startPoint);
                        if (m861outOfBoundary2x9bVx0) {
                            selectionRegistrar2.notifySelectionUpdateSelectAll(j2);
                        } else {
                            selectionRegistrar2.mo935notifySelectionUpdateStartd4ec7I(invoke, startPoint, SelectionAdjustment.INSTANCE.getWord());
                        }
                ...
                public void mo802onDragk4lQ0M(long delta) {
                    ...
                    if (invoke != null) {
                        ...
                        if (invoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                            long m2395plusMKHz9U = Offset.m2395plusMKHz9U(this.dragTotalDistance, delta);
                            this.dragTotalDistance = m2395plusMKHz9U;
                            long m2395plusMKHz9U2 = Offset.m2395plusMKHz9U(this.lastPosition, m2395plusMKHz9U);
                            m861outOfBoundary2x9bVx0 = SelectionControllerKt.m861outOfBoundary2x9bVx0(function03.invoke(), this.lastPosition, m2395plusMKHz9U2);
                            if (m861outOfBoundary2x9bVx0 || !selectionRegistrar2.mo934notifySelectionUpdate5iVPX68(invoke, m2395plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                                return;
                            }
                            this.lastPosition = m2395plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m2406getZeroF1C5BW0();
                        }
                    }
                }
        ...
        ?? r11 = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo863onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo934notifySelectionUpdate5iVPX68(invoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone())) {
            ...
            public boolean mo864onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo934notifySelectionUpdate5iVPX68(invoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone())) {
                    return true;
                }
            ...
            public boolean mo865onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar2.mo935notifySelectionUpdateStartd4ec7I(invoke, downPosition, adjustment);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
            ...
            public boolean mo862onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo934notifySelectionUpdate5iVPX68(invoke, dragPosition, this.lastPosition, false, adjustment)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
    ...
    public static final boolean m861outOfBoundary2x9bVx0(TextLayoutResult textLayoutResult, long j, long j2) {
        ...
        int m4376getOffsetForPositionk4lQ0M = textLayoutResult.m4376getOffsetForPositionk4lQ0M(j);
        int m4376getOffsetForPositionk4lQ0M2 = textLayoutResult.m4376getOffsetForPositionk4lQ0M(j2);
        int i = length - 1;
        return (m4376getOffsetForPositionk4lQ0M >= i && m4376getOffsetForPositionk4lQ0M2 >= i) || (m4376getOffsetForPositionk4lQ0M < 0 && m4376getOffsetForPositionk4lQ0M2 < 0);
    }
}
