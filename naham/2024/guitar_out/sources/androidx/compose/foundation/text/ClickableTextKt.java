...
public final class ClickableTextKt {
    ...
    */
    ...
    public static final Integer ClickableText_03UYbkw$getOffset(MutableState<TextLayoutResult> mutableState, long j) {
        ...
        if (!m746containsWithinBoundsUv8p0NA(multiParagraph, j)) {
            multiParagraph = null;
        }
        if (multiParagraph != null) {
            return Integer.valueOf(multiParagraph.m4292getOffsetForPositionk4lQ0M(j));
        }
        return null;
    }

    /* renamed from: containsWithinBounds-Uv8p0NA, reason: not valid java name */
    private static final boolean m746containsWithinBoundsUv8p0NA(MultiParagraph multiParagraph, long j) {
        float m2380component1impl = Offset.m2380component1impl(j);
        float m2381component2impl = Offset.m2381component2impl(j);
        return m2380component1impl > 0.0f && m2381component2impl >= 0.0f && m2380component1impl <= multiParagraph.getWidth() && m2381component2impl <= multiParagraph.getHeight();
    }
}
