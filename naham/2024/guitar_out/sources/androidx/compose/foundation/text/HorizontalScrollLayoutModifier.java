...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m4828getMaxHeightimpl(j)) < Constraints.m4829getMaxWidthimpl(j) ? j : Constraints.m4820copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo3866measureBRTryo0.getWidth(), Constraints.m4829getMaxWidthimpl(j));
        return MeasureScope.layout$default(measure, min, mo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo3866measureBRTryo0.getWidth()), min, mo3866measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, mo3866measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
