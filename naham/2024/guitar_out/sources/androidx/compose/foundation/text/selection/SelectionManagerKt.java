...
public final class SelectionManagerKt {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null) {
            ...
            if (offset > anchorSelectable$foundation_release.getLastVisibleOffset()) {
                return Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
            }
            Offset m915getCurrentDragPosition_m7T9E = selectionManager.m915getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(m915getCurrentDragPosition_m7T9E);
            float m2390getXimpl = Offset.m2390getXimpl(layoutCoordinates.mo3874localPositionOfR5De75A(containerLayoutCoordinates, m915getCurrentDragPosition_m7T9E.getPackedValue()));
            long mo876getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo876getRangeOfLineContainingjx7JFs(offset);
            Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m4402getMinimpl(mo876getRangeOfLineContainingjx7JFs));
            Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m4401getMaximpl(mo876getRangeOfLineContainingjx7JFs) - 1, TextRange.m4402getMinimpl(mo876getRangeOfLineContainingjx7JFs)));
            float coerceIn = RangesKt.coerceIn(m2390getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
            if (Math.abs(m2390getXimpl - coerceIn) > IntSize.m5033getWidthimpl(j) / 2) {
                return Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(coerceIn, Offset.m2391getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m2420getCenterF1C5BW0())));
        }
        return Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m926calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager manager, long j) {
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m2428Rect0a9Yr6o(layoutCoordinates.mo3878windowToLocalMKHz9U(boundsInWindow.m2425getTopLeftF1C5BW0()), layoutCoordinates.mo3878windowToLocalMKHz9U(boundsInWindow.m2419getBottomRightF1C5BW0()));
    }

    /* renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m927containsInclusiveUv8p0NA(Rect containsInclusive, long j) {
