...
public interface Selectable {
    ...
    long mo875getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo876getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo877updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection);

    /* renamed from: updateSelection-qCDeeow$default, reason: not valid java name */
    static /* synthetic */ Pair m883updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        if (obj == null) {
            return selectable.mo877updateSelectionqCDeeow(j, j2, offset, (i & 8) != 0 ? true : z, layoutCoordinates, selectionAdjustment, (i & 64) != 0 ? null : selection);
        }
