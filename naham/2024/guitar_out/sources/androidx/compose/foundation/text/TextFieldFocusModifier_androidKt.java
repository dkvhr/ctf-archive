    ...
    public static final Modifier interceptDPadAndMoveFocus(Modifier modifier, final TextFieldState state, final FocusManager focusManager) {
        ...
        return KeyInputModifierKt.onPreviewKeyEvent(modifier, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.text.TextFieldFocusModifier_androidKt$interceptDPadAndMoveFocus$1
            ...
            public final Boolean m812invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean m811isKeyCodeYhN2O0w;
                boolean m811isKeyCodeYhN2O0w2;
                boolean m811isKeyCodeYhN2O0w3;
                boolean m811isKeyCodeYhN2O0w4;
                boolean m811isKeyCodeYhN2O0w5;
                ...
                if (device != null && device.supportsSource(InputDeviceCompat.SOURCE_DPAD) && !device.isVirtual() && KeyEventType.m3608equalsimpl0(KeyEvent_androidKt.m3616getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m3612getKeyDownCS__XNY())) {
                    m811isKeyCodeYhN2O0w = TextFieldFocusModifier_androidKt.m811isKeyCodeYhN2O0w(keyEvent, 19);
                    if (m811isKeyCodeYhN2O0w) {
                        z = FocusManager.this.mo2327moveFocus3ESFkO8(FocusDirection.INSTANCE.m2326getUpdhqQ8s());
                    } else {
                        m811isKeyCodeYhN2O0w2 = TextFieldFocusModifier_androidKt.m811isKeyCodeYhN2O0w(keyEvent, 20);
                        if (m811isKeyCodeYhN2O0w2) {
                            z = FocusManager.this.mo2327moveFocus3ESFkO8(FocusDirection.INSTANCE.m2317getDowndhqQ8s());
                        } else {
                            m811isKeyCodeYhN2O0w3 = TextFieldFocusModifier_androidKt.m811isKeyCodeYhN2O0w(keyEvent, 21);
                            if (m811isKeyCodeYhN2O0w3) {
                                z = FocusManager.this.mo2327moveFocus3ESFkO8(FocusDirection.INSTANCE.m2321getLeftdhqQ8s());
                            } else {
                                m811isKeyCodeYhN2O0w4 = TextFieldFocusModifier_androidKt.m811isKeyCodeYhN2O0w(keyEvent, 22);
                                if (m811isKeyCodeYhN2O0w4) {
                                    z = FocusManager.this.mo2327moveFocus3ESFkO8(FocusDirection.INSTANCE.m2325getRightdhqQ8s());
                                } else {
                                    m811isKeyCodeYhN2O0w5 = TextFieldFocusModifier_androidKt.m811isKeyCodeYhN2O0w(keyEvent, 23);
                                    if (m811isKeyCodeYhN2O0w5) {
