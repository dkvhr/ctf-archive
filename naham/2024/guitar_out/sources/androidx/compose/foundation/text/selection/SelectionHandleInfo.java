...
public final /* data */ class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m890copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m892copyUv8p0NA(handle, j);
    }
    ...
    public final SelectionHandleInfo m892copyUv8p0NA(Handle handle, long position) {
    ...
    public boolean equals(Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m2387equalsimpl0(this.position, selectionHandleInfo.position);
    }
    ...
    public final long m893getPositionF1C5BW0() {
        return this.position;
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m2392hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m2398toStringimpl(this.position)) + ')';
    }
