...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m870SelectionHandle8fL75g(final long j, final boolean z, final ResolvedTextDirection direction, final boolean z2, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((374491 & i3) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            m869HandlePopupULxng0E(j, handleReferencePoint, ComposableLambdaKt.composableLambda(startRestartGroup, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function2 == null) {
                            ...
                            Offset m2379boximpl = Offset.m2379boximpl(j);
                            final boolean z3 = z;
                            final long j2 = j;
                            composer2.startReplaceableGroup(511388516);
                            ComposerKt.sourceInformation(composer2, "CC(remember)P(1,2):Composables.kt#9igjgp");
                            boolean changed = composer2.changed(valueOf) | composer2.changed(m2379boximpl);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(Composer composer2, int i4) {
                AndroidSelectionHandles_androidKt.m870SelectionHandle8fL75g(j, z, direction, z2, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void DefaultSelectionHandle(final Modifier modifier, final boolean z, final ResolvedTextDirection direction, final boolean z2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m529sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), z, direction, z2), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawSelectionHandle(Modifier modifier, final boolean z, final ResolvedTextDirection direction, final boolean z2) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Object[] objArr = {Color.m2619boximpl(handleColor), Boolean.valueOf(z), direction, Boolean.valueOf(z2)};
                final boolean z3 = z;
                ...
                if (z5 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final ImageBitmap createHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, Size.m2459getWidthimpl(drawWithCache.m2296getSizeNHjbRc()) / 2.0f);
                            final ColorFilter m2670tintxETnrds$default = ColorFilter.Companion.m2670tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            final boolean z6 = z3;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    if (isLeft) {
                                        ...
                                        ColorFilter colorFilter = m2670tintxETnrds$default;
                                        long mo3171getCenterF1C5BW0 = contentDrawScope.mo3171getCenterF1C5BW0();
                                        DrawContext drawContext = contentDrawScope.getDrawContext();
                                        long mo3097getSizeNHjbRc = drawContext.mo3097getSizeNHjbRc();
                                        drawContext.getCanvas().save();
                                        drawContext.getTransform().mo3104scale0AR0LA0(-1.0f, 1.0f, mo3171getCenterF1C5BW0);
                                        DrawScope.m3157drawImagegbVJVH8$default(contentDrawScope, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                        drawContext.getCanvas().restore();
                                        drawContext.mo3098setSizeuvyYCjk(mo3097getSizeNHjbRc);
                                        return;
                                    }
                                    DrawScope.m3157drawImagegbVJVH8$default(onDrawWithContent, createHandleImage, 0L, 0.0f, null, m2670tintxETnrds$default, 0, 46, null);
                                }
                            });
                        }
                    };
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || ceil > imageBitmap.getWidth() || ceil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2851ImageBitmapx__hDU$default(ceil, ceil, ImageBitmapConfig.INSTANCE.m2845getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        DrawScope.m3167drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m2655getBlack0d7_KjU(), 0L, canvasDrawScope3.mo3172getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m2546getClear0nO6VwU(), 58, null);
        DrawScope.m3167drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m2406getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        DrawScope.m3154drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        canvas2.restore();
        CanvasDrawScope.DrawParams drawParams3 = canvasDrawScope2.getDrawParams();
        drawParams3.setDensity(density);
        drawParams3.setLayoutDirection(layoutDirection2);
        drawParams3.setCanvas(canvas3);
        drawParams3.m3096setSizeuvyYCjk(size);
        return imageBitmap2;
    }

    /* renamed from: HandlePopup-ULxng0E, reason: not valid java name */
    public static final void m869HandlePopupULxng0E(final long j, final HandleReferencePoint handleReferencePoint, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            long IntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2390getXimpl(j)), MathKt.roundToInt(Offset.m2391getYimpl(j)));
            IntOffset m4982boximpl = IntOffset.m4982boximpl(IntOffset);
            startRestartGroup.startReplaceableGroup(511388516);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1,2):Composables.kt#9igjgp");
            boolean changed = startRestartGroup.changed(m4982boximpl) | startRestartGroup.changed(handleReferencePoint);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$HandlePopup$1
            ...
            public final void invoke(Composer composer2, int i3) {
                AndroidSelectionHandles_androidKt.m869HandlePopupULxng0E(j, handleReferencePoint, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
