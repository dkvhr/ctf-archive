...
public final class SelectionHandlesKt {
    ...
    public static final long m894getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2390getXimpl(j), Offset.m2391getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m4873constructorimpl(f);
        HandleHeight = Dp.m4873constructorimpl(f);
    }
}
