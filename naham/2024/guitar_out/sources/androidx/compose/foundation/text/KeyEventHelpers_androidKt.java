...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m758cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3608equalsimpl0(KeyEvent_androidKt.m3616getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m3613getKeyUpCS__XNY());
    }
}
