    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        if (invoke != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Pair pair = rect != null ? new Pair(measurables.get(i).mo3866measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m4982boximpl(IntOffsetKt.IntOffset(MathKt.roundToInt(rect.getLeft()), MathKt.roundToInt(rect.getTop())))) : null;
                if (pair != null) {
                    arrayList2.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measure, Constraints.m4829getMaxWidthimpl(j), Constraints.m4828getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (list != null) {
                    ...
                    for (int i2 = 0; i2 < size2; i2++) {
                        ...
                        Placeable.PlacementScope.m3923place70tqf50$default(layout, pair2.component1(), pair2.component2().getPackedValue(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
