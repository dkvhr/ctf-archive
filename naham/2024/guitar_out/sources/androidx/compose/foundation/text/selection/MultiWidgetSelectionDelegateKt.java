    ...
    */
    public static final kotlin.Pair<androidx.compose.foundation.text.selection.Selection, java.lang.Boolean> m881getTextSelectionInfoyM0VcXU(androidx.compose.ui.text.TextLayoutResult r15, long r16, long r18, androidx.compose.ui.geometry.Offset r20, long r21, androidx.compose.foundation.text.selection.SelectionAdjustment r23, androidx.compose.foundation.text.selection.Selection r24, boolean r25) {
        /*
            ...
            long r2 = r15.getSize()
            int r2 = androidx.compose.ui.unit.IntSize.m5033getWidthimpl(r2)
            float r2 = (float) r2
            long r3 = r15.getSize()
            int r3 = androidx.compose.ui.unit.IntSize.m5032getHeightimpl(r3)
            float r3 = (float) r3
            r4 = 0
            r0.<init>(r4, r4, r2, r3)
            ...
            r11 = r16
            r13 = r18
            boolean r2 = r9.m933isSelected2x9bVx0$foundation_release(r10, r11, r13)
            r9 = 0
            r3 = 0
            if (r2 != 0) goto L41
        ...
        L41:
            r4 = r16
            int r10 = m880getOffsetForPosition0AR0LA0(r15, r0, r4)
            r4 = r18
            int r11 = m880getOffsetForPosition0AR0LA0(r15, r0, r4)
            if (r20 == 0) goto L58
            long r4 = r20.getPackedValue()
            int r0 = m880getOffsetForPosition0AR0LA0(r15, r0, r4)
            goto L59
        L58:
            r0 = -1
        L59:
            ...
            if (r8 == 0) goto L6a
            long r2 = r24.m884toTextRanged9O1mEE()
            androidx.compose.ui.text.TextRange r0 = androidx.compose.ui.text.TextRange.m4392boximpl(r2)
            r6 = r0
            goto L6b
        L6a:
            r6 = r3
        L6b:
            ...
            r4 = r12
            r5 = r25
            long r0 = r0.mo885adjustZXO7KMw(r1, r2, r4, r5, r6)
            boolean r2 = androidx.compose.ui.text.TextRange.m4403getReversedimpl(r0)
            r3 = r21
            r5 = r15
            androidx.compose.foundation.text.selection.Selection r0 = m879getAssembledSelectionInfovJH6DeI(r0, r2, r3, r5)
        ...
        L92:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.MultiWidgetSelectionDelegateKt.m881getTextSelectionInfoyM0VcXU(androidx.compose.ui.text.TextLayoutResult, long, long, androidx.compose.ui.geometry.Offset, long, androidx.compose.foundation.text.selection.SelectionAdjustment, androidx.compose.foundation.text.selection.Selection, boolean):kotlin.Pair");
    }

    /* renamed from: getOffsetForPosition-0AR0LA0, reason: not valid java name */
    public static final int m880getOffsetForPosition0AR0LA0(TextLayoutResult textLayoutResult, Rect bounds, long j) {
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        Intrinsics.checkNotNullParameter(bounds, "bounds");
        int length = textLayoutResult.getLayoutInput().getText().length();
        if (bounds.m2416containsk4lQ0M(j)) {
            return RangesKt.coerceIn(textLayoutResult.m4376getOffsetForPositionk4lQ0M(j), 0, length);
        }
        if (SelectionMode.Vertical.mo932compare3MmeM6k$foundation_release(j, bounds) < 0) {
            return 0;
        }
        return length;
    }
    ...
    public static final Selection m879getAssembledSelectionInfovJH6DeI(long j, boolean z, long j2, TextLayoutResult textLayoutResult) {
        return new Selection(new Selection.AnchorInfo(textLayoutResult.getBidiRunDirection(TextRange.m4404getStartimpl(j)), TextRange.m4404getStartimpl(j), j2), new Selection.AnchorInfo(textLayoutResult.getBidiRunDirection(Math.max(TextRange.m4399getEndimpl(j) - 1, 0)), TextRange.m4399getEndimpl(j), j2), z);
    }
}
