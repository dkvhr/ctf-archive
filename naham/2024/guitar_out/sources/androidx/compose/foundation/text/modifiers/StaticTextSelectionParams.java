...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m4804boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m4804boximpl(layoutInput.getOverflow());
        int m4816getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m4816getVisiblegIe3tQ8();
        if (m4804boximpl == null) {
            return false;
        }
        return TextOverflow.m4807equalsimpl0(m4804boximpl.getValue(), m4816getVisiblegIe3tQ8);
    }
