...
public final class MinLinesConstrainer {
    ...
    public final long m842coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        String str2;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            f = ParagraphKt.m4303ParagraphUdtVg6A$default(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, null, null, 1, false, 96, null).getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            f2 = ParagraphKt.m4303ParagraphUdtVg6A$default(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, null, null, 2, false, 96, null).getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (minLines != 1) {
            m4830getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(f + (f2 * (minLines - 1))), 0), Constraints.m4828getMaxHeightimpl(inConstraints));
        } else {
            m4830getMinHeightimpl = Constraints.m4830getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m4831getMinWidthimpl(inConstraints), Constraints.m4829getMaxWidthimpl(inConstraints), m4830getMinHeightimpl, Constraints.m4828getMaxHeightimpl(inConstraints));
    }
}
