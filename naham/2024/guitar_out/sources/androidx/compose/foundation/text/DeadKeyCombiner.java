...
public final class DeadKeyCombiner {
    ...
    public final Integer m757consumeZmokQxo(KeyEvent event) {
        ...
        if ((Integer.MIN_VALUE & m3617getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(m3617getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num != null) {
            this.deadKeyCode = null;
            Integer valueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), m3617getUtf16CodePointZmokQxo));
            Integer num2 = valueOf.intValue() != 0 ? valueOf : null;
            return num2 == null ? Integer.valueOf(m3617getUtf16CodePointZmokQxo) : num2;
        }
        return Integer.valueOf(m3617getUtf16CodePointZmokQxo);
    }
}
