...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m833getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m835getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m835getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m832coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m4376getOffsetForPositionk4lQ0M(m834relativeToInputTextMKHz9U(position));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m2391getYimpl(m834relativeToInputTextMKHz9U(m832coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m836isPositionOnTextk4lQ0M(long offset) {
        long m834relativeToInputTextMKHz9U = m834relativeToInputTextMKHz9U(m832coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m2391getYimpl(m834relativeToInputTextMKHz9U));
        return Offset.m2390getXimpl(m834relativeToInputTextMKHz9U) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m2390getXimpl(m834relativeToInputTextMKHz9U) <= this.value.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: relativeToInputText-MK-Hz9U, reason: not valid java name */
    private final long m834relativeToInputTextMKHz9U(long j) {
        Offset offset;
        ...
        if (layoutCoordinates2 != null) {
            offset = Offset.m2379boximpl((layoutCoordinates.isAttached() && layoutCoordinates2.isAttached()) ? layoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates2, j) : j);
        } else {
            offset = null;
        }
    ...
    */
    private final long m832coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        /*
            r5 = this;
        ...
        L1e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L24:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m837access$coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m832coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
