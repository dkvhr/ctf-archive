        ...
        if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m584invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyListMeasureResult m584invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    int i6;
                    float spacing;
                    ...
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(paddingValues.mo431calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i6 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(paddingValues.mo432calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    ...
                    final long m4845offsetNN6EwU = ConstraintsKt.m4845offsetNN6EwU(j, -i10, -i9);
                    ...
                    invoke.getItemScope().setMaxSize(Constraints.m4829getMaxWidthimpl(m4845offsetNN6EwU), Constraints.m4828getMaxHeightimpl(m4845offsetNN6EwU));
                    if (z2) {
                    ...
                    lazyListState.m593setPremeasureConstraintsBRTryo0$foundation_release(lazyListMeasuredItemProvider.getChildConstraints());
                    ...
                    try {
                        ...
                        try {
                            ...
                            LazyListMeasureResult m587measureLazyListCD5nmq0 = LazyListMeasureKt.m587measureLazyListCD5nmq0(itemCount, lazyListMeasuredItemProvider, i15, i12, i13, i14, updateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, lazyListState.getScrollToBeConsumed(), m4845offsetNN6EwU, z2, invoke.getHeaderIndexes(), vertical5, horizontal5, z, lazyLayoutMeasureScope2, lazyListState.getPlacementAnimator(), i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyListState.getPinnedItems(), lazyListState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                            ...
                            lazyListState.applyMeasureResult$foundation_release(m587measureLazyListCD5nmq0);
                            return m587measureLazyListCD5nmq0;
                        } finally {
