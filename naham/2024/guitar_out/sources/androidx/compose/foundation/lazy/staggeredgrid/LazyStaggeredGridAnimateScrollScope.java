...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public Integer getTargetItemOffset(int index) {
        ...
        return Integer.valueOf(this.state.getIsVertical() ? IntOffset.m4992getYimpl(offset) : IntOffset.m4991getXimpl(offset));
    }
    ...
    public float expectedDistanceTo(int index, int targetScrollOffset) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            i += this.state.getIsVertical() ? IntSize.m5032getHeightimpl(lazyStaggeredGridItemInfo.getSize()) : IntSize.m5033getWidthimpl(lazyStaggeredGridItemInfo.getSize());
        }
