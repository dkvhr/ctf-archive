...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m618getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m619getAndMeasure3p2s80s(i, i2, j);
    }

    /* renamed from: getAndMeasure-3p2s80s, reason: not valid java name */
    public final LazyGridMeasuredItem m619getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> mo638measure0kLqBqw = this.measureScope.mo638measure0kLqBqw(index, constraints);
        if (Constraints.m4827getHasFixedWidthimpl(constraints)) {
            m4830getMinHeightimpl = Constraints.m4831getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m4826getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            m4830getMinHeightimpl = Constraints.m4830getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, m4830getMinHeightimpl, mainAxisSpacing, mo638measure0kLqBqw);
    }
