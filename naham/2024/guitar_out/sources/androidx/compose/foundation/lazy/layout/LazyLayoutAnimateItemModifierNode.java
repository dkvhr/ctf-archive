...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public LazyLayoutAnimateItemModifierNode(FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m4982boximpl(IntOffset.INSTANCE.m5001getZeronOccac()), null, 2, null);
    ...
    public final void m624animatePlacementDeltagyyYBs(long delta) {
        long m625getPlacementDeltanOccac = m625getPlacementDeltanOccac();
        long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m625getPlacementDeltanOccac) - IntOffset.m4991getXimpl(delta), IntOffset.m4992getYimpl(m625getPlacementDeltanOccac) - IntOffset.m4992getYimpl(delta));
        m623setPlacementDeltagyyYBs(IntOffset);
