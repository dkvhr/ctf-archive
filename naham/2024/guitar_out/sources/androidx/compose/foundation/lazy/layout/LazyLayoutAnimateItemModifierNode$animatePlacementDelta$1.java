    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!animatable2.isRunning()) {
                ...
                this.label = 1;
                if (animatable3.snapTo(IntOffset.m4982boximpl(this.$totalDelta), this) == coroutine_suspended) {
        ...
        final long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(packedValue) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(packedValue) - IntOffset.m4992getYimpl(j));
        ...
        this.L$0 = null;
        this.label = 2;
        if (Animatable.animateTo$default(animatable5, m4982boximpl, finiteAnimationSpec2, null, new Function1<Animatable<IntOffset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutAnimateItemModifierNode$animatePlacementDelta$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
