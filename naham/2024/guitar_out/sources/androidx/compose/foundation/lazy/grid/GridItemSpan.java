...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m595boximpl(long j) {
        return new GridItemSpan(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m596constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m597equalsimpl(long j, Object obj) {
    ...
    public static final int m599getCurrentLineSpanimpl(long j) {
        return (int) j;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m600hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m601toStringimpl(long j) {
        return "GridItemSpan(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m597equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m600hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m601toStringimpl(this.packedValue);
    }
