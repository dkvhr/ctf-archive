...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final long m590getOffsetBjo55l4(int index) {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long m590getOffsetBjo55l4 = m590getOffsetBjo55l4(i);
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                long m625getPlacementDeltanOccac = lazyLayoutAnimateItemModifierNode.m625getPlacementDeltanOccac();
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m590getOffsetBjo55l4) + IntOffset.m4991getXimpl(m625getPlacementDeltanOccac), IntOffset.m4992getYimpl(m590getOffsetBjo55l4) + IntOffset.m4992getYimpl(m625getPlacementDeltanOccac));
                if ((m589getMainAxisgyyYBs(m590getOffsetBjo55l4) <= mainAxisSize && m589getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m589getMainAxisgyyYBs(m590getOffsetBjo55l4) >= i2 && m589getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                m590getOffsetBjo55l4 = IntOffset;
            }
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    m4991getXimpl = (this.mainAxisLayoutSize - IntOffset.m4991getXimpl(m590getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4991getXimpl = IntOffset.m4991getXimpl(m590getOffsetBjo55l4);
                }
                if (this.isVertical) {
                    m4992getYimpl = (this.mainAxisLayoutSize - IntOffset.m4992getYimpl(m590getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4992getYimpl = IntOffset.m4992getYimpl(m590getOffsetBjo55l4);
                }
                m590getOffsetBjo55l4 = IntOffsetKt.IntOffset(m4991getXimpl, m4992getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m590getOffsetBjo55l4) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(m590getOffsetBjo55l4) + IntOffset.m4992getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3926placeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3925placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            }
        }
    }

    /* renamed from: getMainAxis--gyyYBs, reason: not valid java name */
    private final int m589getMainAxisgyyYBs(long j) {
        return this.isVertical ? IntOffset.m4992getYimpl(j) : IntOffset.m4991getXimpl(j);
    }
    ...
    private final long m588copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int m4991getXimpl = this.isVertical ? IntOffset.m4991getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m4991getXimpl(j))).intValue();
        boolean z = this.isVertical;
        int m4992getYimpl = IntOffset.m4992getYimpl(j);
        if (z) {
            m4992getYimpl = function1.invoke(Integer.valueOf(m4992getYimpl)).intValue();
        }
        return IntOffsetKt.IntOffset(m4991getXimpl, m4992getYimpl);
    }
