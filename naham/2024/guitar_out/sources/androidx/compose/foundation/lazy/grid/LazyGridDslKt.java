        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new GridSlotCache(new Function2<Density, Constraints, LazyGridSlots>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridDslKt$rememberColumnWidthSums$1$1
                ...
                public final LazyGridSlots m608invoke0kLqBqw(Density $receiver, long j) {
                    ...
                    int[] intArray = CollectionsKt.toIntArray(gridCells2.calculateCrossAxisCellSizes($receiver, m4829getMaxWidthimpl, $receiver.mo319roundToPx0680j_4(horizontal2.getSpacing())));
                    int[] iArr = new int[intArray.length];
                    horizontal2.arrange($receiver, m4829getMaxWidthimpl, intArray, LayoutDirection.Ltr, iArr);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new GridSlotCache(new Function2<Density, Constraints, LazyGridSlots>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridDslKt$rememberRowHeightSums$1$1
                ...
                public final LazyGridSlots m609invoke0kLqBqw(Density $receiver, long j) {
                    ...
                    int[] intArray = CollectionsKt.toIntArray(gridCells2.calculateCrossAxisCellSizes($receiver, m4828getMaxHeightimpl, $receiver.mo319roundToPx0680j_4(vertical2.getSpacing())));
                    int[] iArr = new int[intArray.length];
                    vertical2.arrange($receiver, m4828getMaxHeightimpl, intArray, iArr);
                    return new LazyGridSlots(intArray, iArr);
                }
            });
            composer.updateRememberedValue(rememberedValue);
