...
public final class LazyStaggeredGridMeasureKt {
        ...
        try {
            ...
            try {
                ...
                if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release.length == lazyStaggeredGridMeasureContext.getLaneCount()) {
                    ...
                    int i6 = 0;
                    while (i6 < laneCount) {
                        if (i6 >= updateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (m663maxInRangejy6DScQ = updateScrollPositionIfTheFirstItemWasMoved$foundation_release[i6]) == -1) {
                            m663maxInRangejy6DScQ = i6 == 0 ? 0 : m663maxInRangejy6DScQ(iArr, SpanRange.m673constructorimpl(0, i6)) + 1;
                        }
                        iArr[i6] = m663maxInRangejy6DScQ;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:108:0x06b4, code lost:
        ...
        r25 = r3;
        r3 = r11;
        r10 = r14.m660getSpanRangelOCCd4c(r38.getItemProvider(), r1, r5);
        r2 = r38.getLaneInfo();
        r15 = r6;
        r5 = (int) (r10 & 4294967295L);
        r7 = (int) (r10 >> 32);
        r8 = r5 - r7;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:111:0x06e4, code lost:
        ...
        r2.setLane(r1, r6);
        r2 = r38.getMeasuredItemProvider().m668getAndMeasurejy6DScQ(r1, r10);
        r6 = m663maxInRangejy6DScQ(r12, r10);
     */
            ...
            for (ArrayDeque<LazyStaggeredGridMeasuredItem> arrayDeque2 : arrayDequeArr) {
                if (!arrayDeque2.isEmpty()) {
                    ...
                    if (removeFirst.getLane() == i3) {
                        long m673constructorimpl = SpanRange.m673constructorimpl(removeFirst.getLane(), removeFirst.getSpan());
                        ...
                        if (removeFirst.getPlaceablesCount() != 0) {
                            removeFirst.position(m663maxInRangejy6DScQ, i6, i);
                            arrayList.add(removeFirst);
                            int i7 = (int) (m673constructorimpl & 4294967295L);
                            for (int i8 = (int) (m673constructorimpl >> 32); i8 < i7; i8++) {
                                iArr[i8] = removeFirst.getSizeWithSpacings() + m663maxInRangejy6DScQ;
                            }
                        }
                    }
                }
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateExtraItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, Function1<? super LazyStaggeredGridMeasuredItem, Unit> function1, Function1<? super Integer, Boolean> function12) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (function12.invoke(Integer.valueOf(intValue)).booleanValue()) {
                ...
                function1.invoke(m668getAndMeasurejy6DScQ);
