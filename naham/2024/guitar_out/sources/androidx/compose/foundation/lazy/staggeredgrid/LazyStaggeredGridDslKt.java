        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberColumnSlots$1$1
                ...
                public final LazyStaggeredGridSlots m652invoke0kLqBqw(Density $receiver, long j) {
                    ...
                    int m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(j) - $receiver.mo319roundToPx0680j_4(Dp.m4873constructorimpl(PaddingKt.calculateStartPadding(PaddingValues.this, LayoutDirection.Ltr) + PaddingKt.calculateEndPadding(PaddingValues.this, LayoutDirection.Ltr)));
                    StaggeredGridCells staggeredGridCells2 = staggeredGridCells;
                    Arrangement.Horizontal horizontal2 = horizontal;
                    int[] calculateCrossAxisCellSizes = staggeredGridCells2.calculateCrossAxisCellSizes($receiver, m4829getMaxWidthimpl, $receiver.mo319roundToPx0680j_4(horizontal2.getSpacing()));
                    int[] iArr = new int[calculateCrossAxisCellSizes.length];
                    horizontal2.arrange($receiver, m4829getMaxWidthimpl, calculateCrossAxisCellSizes, LayoutDirection.Ltr, iArr);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new LazyStaggeredGridSlotCache(new Function2<Density, Constraints, LazyStaggeredGridSlots>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridDslKt$rememberRowSlots$1$1
                ...
                public final LazyStaggeredGridSlots m653invoke0kLqBqw(Density $receiver, long j) {
                    ...
                    int m4828getMaxHeightimpl = Constraints.m4828getMaxHeightimpl(j) - $receiver.mo319roundToPx0680j_4(Dp.m4873constructorimpl(PaddingValues.this.getTop() + PaddingValues.this.getBottom()));
                    StaggeredGridCells staggeredGridCells2 = staggeredGridCells;
                    Arrangement.Vertical vertical2 = vertical;
                    int[] calculateCrossAxisCellSizes = staggeredGridCells2.calculateCrossAxisCellSizes($receiver, m4828getMaxHeightimpl, $receiver.mo319roundToPx0680j_4(vertical2.getSpacing()));
                    int[] iArr = new int[calculateCrossAxisCellSizes.length];
                    vertical2.arrange($receiver, m4828getMaxHeightimpl, calculateCrossAxisCellSizes, iArr);
                    return new LazyStaggeredGridSlots(iArr, calculateCrossAxisCellSizes);
                }
            });
            composer.updateRememberedValue(rememberedValue);
