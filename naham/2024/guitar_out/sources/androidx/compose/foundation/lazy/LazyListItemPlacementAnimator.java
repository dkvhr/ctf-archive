...
public final class LazyListItemPlacementAnimator {
    ...
    private final void initializeNode(LazyListMeasuredItem item, int mainAxisOffset) {
        long m4987copyiSbpLlY$default;
        long m590getOffsetBjo55l4 = item.m590getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            m4987copyiSbpLlY$default = IntOffset.m4987copyiSbpLlY$default(m590getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            m4987copyiSbpLlY$default = IntOffset.m4987copyiSbpLlY$default(m590getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        int placeablesCount = item.getPlaceablesCount();
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutAnimateItemModifierNode node = getNode(item.getParentData(i));
            if (node != null) {
                long m590getOffsetBjo55l42 = item.m590getOffsetBjo55l4(i);
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m590getOffsetBjo55l42) - IntOffset.m4991getXimpl(m590getOffsetBjo55l4), IntOffset.m4992getYimpl(m590getOffsetBjo55l42) - IntOffset.m4992getYimpl(m590getOffsetBjo55l4));
                node.m627setRawOffsetgyyYBs(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m4987copyiSbpLlY$default) + IntOffset.m4991getXimpl(IntOffset), IntOffset.m4992getYimpl(m4987copyiSbpLlY$default) + IntOffset.m4992getYimpl(IntOffset)));
            }
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00bf, code lost:
        ...
        r15 = r14.m590getOffsetBjo55l4(0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00ca, code lost:
        ...
        r13 = androidx.compose.ui.unit.IntOffset.m4992getYimpl(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x00cf, code lost:
        ...
        r13 = androidx.compose.ui.unit.IntOffset.m4991getXimpl(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00fb, code lost:
        ...
        if (androidx.compose.ui.unit.IntOffset.m4990equalsimpl0(r7.getRawOffset(), androidx.compose.foundation.lazy.layout.LazyLayoutAnimateItemModifierNode.INSTANCE.m628getNotInitializednOccac()) != false) goto L111;
     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00fd, code lost:
    
        r1 = r7.getRawOffset();
        r7.m627setRawOffsetgyyYBs(androidx.compose.ui.unit.IntOffsetKt.IntOffset(androidx.compose.ui.unit.IntOffset.m4991getXimpl(r1) + androidx.compose.ui.unit.IntOffset.m4991getXimpl(r10), androidx.compose.ui.unit.IntOffset.m4992getYimpl(r1) + androidx.compose.ui.unit.IntOffset.m4992getYimpl(r10)));
     */
    ...
    */
    ...
    private final void startAnimationsIfNeeded(LazyListMeasuredItem item) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutAnimateItemModifierNode node = getNode(item.getParentData(i));
            if (node != null) {
                long m590getOffsetBjo55l4 = item.m590getOffsetBjo55l4(i);
                long rawOffset = node.getRawOffset();
                if (!IntOffset.m4990equalsimpl0(rawOffset, LazyLayoutAnimateItemModifierNode.INSTANCE.m628getNotInitializednOccac()) && !IntOffset.m4990equalsimpl0(rawOffset, m590getOffsetBjo55l4)) {
                    node.m624animatePlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m590getOffsetBjo55l4) - IntOffset.m4991getXimpl(rawOffset), IntOffset.m4992getYimpl(m590getOffsetBjo55l4) - IntOffset.m4992getYimpl(rawOffset)));
                }
                node.m627setRawOffsetgyyYBs(m590getOffsetBjo55l4);
            }
        }
    }
