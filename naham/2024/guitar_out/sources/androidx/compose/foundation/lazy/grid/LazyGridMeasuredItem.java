...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    private LazyGridMeasuredItem(int i, Object key, boolean z, int i2, int i3, boolean z2, LayoutDirection layoutDirection, int i4, int i5, List<? extends Placeable> placeables, long j, Object obj) {
        ...
        this.size = IntSize;
        this.offset = IntOffset.INSTANCE.m5001getZeronOccac();
        this.row = -1;
        this.column = -1;
    }
    ...
    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m4991getXimpl(getOffset()) : IntOffset.m4992getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(offset) + IntOffset.m4991getXimpl(m625getPlacementDeltanOccac), IntOffset.m4992getYimpl(offset) + IntOffset.m4992getYimpl(m625getPlacementDeltanOccac));
                if ((m617getMainAxisgyyYBs(offset) <= mainAxisSize && m617getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m617getMainAxisgyyYBs(offset) >= i2 && m617getMainAxisgyyYBs(IntOffset) >= i2)) {
            ...
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    m4991getXimpl = (this.mainAxisLayoutSize - IntOffset.m4991getXimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    m4991getXimpl = IntOffset.m4991getXimpl(offset);
                }
                if (this.isVertical) {
                    m4992getYimpl = (this.mainAxisLayoutSize - IntOffset.m4992getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    m4992getYimpl = IntOffset.m4992getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(m4991getXimpl, m4992getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(offset) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(offset) + IntOffset.m4992getYimpl(j));
            if (this.isVertical) {
    ...
    private final int m617getMainAxisgyyYBs(long j) {
    ...
    private final long m616copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
