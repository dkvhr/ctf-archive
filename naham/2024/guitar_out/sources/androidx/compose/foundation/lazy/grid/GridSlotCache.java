...
final class GridSlotCache implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public LazyGridSlots m603invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m4817boximpl(constraints));
