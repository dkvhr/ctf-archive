...
public final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int m4831getMinWidthimpl = roundToInt != Integer.MAX_VALUE ? roundToInt : Constraints.m4831getMinWidthimpl(j);
        int m4830getMinHeightimpl = roundToInt2 != Integer.MAX_VALUE ? roundToInt2 : Constraints.m4830getMinHeightimpl(j);
        if (roundToInt == Integer.MAX_VALUE) {
            roundToInt = Constraints.m4829getMaxWidthimpl(j);
        }
        if (roundToInt2 == Integer.MAX_VALUE) {
            roundToInt2 = Constraints.m4828getMaxHeightimpl(j);
        }
        final Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(ConstraintsKt.Constraints(m4831getMinWidthimpl, roundToInt, m4830getMinHeightimpl, roundToInt2));
        return MeasureScope.layout$default(measure, mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
