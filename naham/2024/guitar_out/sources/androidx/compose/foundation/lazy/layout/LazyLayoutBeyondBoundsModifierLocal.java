...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo634layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        if (m632isForward4vf7U8o(direction)) {
        ...
        T t = null;
        while (t == null && m631hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t2 = (T) m630addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            t = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                ...
                public boolean getHasMoreContent() {
                    ...
                    m631hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsModifierLocal.this.m631hasMoreContentFR3nfPY(objectRef.element, direction);
    ...
    private final boolean m632isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3852getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3851getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3850getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3853getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3854getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3855getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m630addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m631hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m633isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        if (m632isForward4vf7U8o(i)) {
    ...
    private final boolean m633isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3850getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3853getBelowhoxUOeE())) {
            if (this.orientation == Orientation.Horizontal) {
                return true;
            }
        } else if (BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3854getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3855getRighthoxUOeE())) {
            if (this.orientation == Orientation.Vertical) {
                return true;
            }
        } else if (!BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3852getBeforehoxUOeE()) && !BeyondBoundsLayout.LayoutDirection.m3846equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3851getAfterhoxUOeE())) {
            LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
            throw new KotlinNothingValueException();
        }
        return false;
