        ...
        if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m614invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }
                ...
                public final LazyGridMeasureResult m614invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i4;
                    int i5;
                    float spacing;
                    int m4829getMaxWidthimpl;
                    long IntOffset;
                    int firstVisibleItemScrollOffset;
                    int i6;
                    Intrinsics.checkNotNullParameter(lazyLayoutMeasureScope, "$this$null");
                    CheckScrollableContainerConstraintsKt.m187checkScrollableContainerConstraintsK40F9xA(j, z2 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z2) {
                        i4 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(paddingValues.mo431calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i4 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(paddingValues.mo432calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i7 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(paddingValues.getTop());
                    int i8 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(paddingValues.getBottom());
                    final int i9 = i7 + i8;
                    final int i10 = i4 + i5;
                    boolean z4 = z2;
                    int i11 = z4 ? i9 : i10;
                    ...
                    long m4845offsetNN6EwU = ConstraintsKt.m4845offsetNN6EwU(j, -i10, -i9);
                    ...
                    final LazyGridSlots invoke2 = function2.invoke(lazyLayoutMeasureScope, Constraints.m4817boximpl(j));
                    ...
                    final int i14 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(spacing);
                    final int itemCount = invoke.getItemCount();
                    if (z2) {
                        m4829getMaxWidthimpl = Constraints.m4828getMaxHeightimpl(j) - i9;
                    } else {
                        m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(j) - i10;
                    }
                    int i15 = m4829getMaxWidthimpl;
                    if (!z || i15 > 0) {
                    ...
                    final boolean z8 = z2;
                    final ?? r2 = new LazyGridMeasuredLineProvider(z8, invoke2, itemCount, i14, r18, spanLayoutProvider) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1
                        final /* synthetic */ boolean $isVertical;
                    ...
                    lazyGridState.setPrefetchInfoRetriever$foundation_release(new Function1<Integer, ArrayList<Pair<? extends Integer, ? extends Constraints>>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.1
                        ...
                        public final ArrayList<Pair<Integer, Constraints>> invoke(int i17) {
                            ...
                            for (int i19 = 0; i19 < size; i19++) {
                                int m599getCurrentLineSpanimpl = GridItemSpan.m599getCurrentLineSpanimpl(spans.get(i19).getPackedValue());
                                arrayList.add(TuplesKt.to(Integer.valueOf(firstItemIndex), Constraints.m4817boximpl(lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1.m620childConstraintsJhjzzOo$foundation_release(i18, m599getCurrentLineSpanimpl))));
                                firstItemIndex++;
                                i18 += m599getCurrentLineSpanimpl;
                            }
                            return arrayList;
                        }
                    });
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release >= itemCount && itemCount > 0) {
                                ...
                                LazyGridMeasureResult m615measureLazyGridZRKPzZ8 = LazyGridMeasureKt.m615measureLazyGridZRKPzZ8(itemCount, (LazyGridMeasuredLineProvider) r2, (LazyGridMeasuredItemProvider) r18, i15, i12, i13, i14, i6, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), m4845offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridState.getPlacementAnimator(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(3);
                                    }
                                    ...
                                    public final MeasureResult invoke(int i17, int i18, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                        ...
                                        return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m4843constrainWidthK40F9xA(j, i17 + i10), ConstraintsKt.m4842constrainHeightK40F9xA(j, i18 + i9), MapsKt.emptyMap(), placement);
                                    }
                                });
                                lazyGridState.applyMeasureResult$foundation_release(m615measureLazyGridZRKPzZ8);
                                return m615measureLazyGridZRKPzZ8;
                            }
                            ...
                            createNonObservableSnapshot.dispose();
                            LazyGridMeasureResult m615measureLazyGridZRKPzZ82 = LazyGridMeasureKt.m615measureLazyGridZRKPzZ8(itemCount, (LazyGridMeasuredLineProvider) r2, (LazyGridMeasuredItemProvider) r18, i15, i12, i13, i14, i6, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), m4845offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridState.getPlacementAnimator(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                            ...
                            lazyGridState.applyMeasureResult$foundation_release(m615measureLazyGridZRKPzZ82);
                            return m615measureLazyGridZRKPzZ82;
                        } finally {
