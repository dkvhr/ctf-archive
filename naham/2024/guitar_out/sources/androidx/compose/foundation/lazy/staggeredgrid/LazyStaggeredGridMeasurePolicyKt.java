        ...
        if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final LazyStaggeredGridMeasureResult m666invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    ...
                    CheckScrollableContainerConstraintsKt.m187checkScrollableContainerConstraintsK40F9xA(j, Orientation.this);
                    LazyStaggeredGridSlots invoke = slots.invoke(lazyLayoutMeasureScope, Constraints.m4817boximpl(j));
                    ...
                    int i3 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(beforePadding);
                    ...
                    int i4 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(afterPadding);
                    ...
                    int i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(startPadding);
                    int m4828getMaxHeightimpl = ((z3 ? Constraints.m4828getMaxHeightimpl(j) : Constraints.m4829getMaxWidthimpl(j)) - i3) - i4;
                    if (z3) {
                    ...
                    LazyStaggeredGridMeasureResult m664measureStaggeredGriddSVRQoE = LazyStaggeredGridMeasureKt.m664measureStaggeredGriddSVRQoE(lazyLayoutMeasureScope, state, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke2, state.getPinnedItems(), state.getBeyondBoundsInfo()), invoke2, invoke, Constraints.m4820copyZbe2FdA$default(j, ConstraintsKt.m4843constrainWidthK40F9xA(j, i6), 0, ConstraintsKt.m4842constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo319roundToPx0680j_4(Dp.m4873constructorimpl(paddingValues2.getTop() + paddingValues2.getBottom()))), 0, 10, null), z3, z, j2, m4828getMaxHeightimpl, lazyLayoutMeasureScope.mo319roundToPx0680j_4(f), i3, i4);
                    state.applyMeasureResult$foundation_release(m664measureStaggeredGriddSVRQoE);
                    return m664measureStaggeredGriddSVRQoE;
                }
            };
