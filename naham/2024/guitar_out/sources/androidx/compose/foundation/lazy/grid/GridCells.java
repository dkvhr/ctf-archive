...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float f) {
            ...
            if (Dp.m4872compareTo0680j_4(f, Dp.m4873constructorimpl(0)) <= 0) {
                throw new IllegalArgumentException(("Provided min size " + ((Object) Dp.m4884toStringimpl(f)) + " should be larger than zero.").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            List<Integer> calculateCellsCrossAxisSizeImpl;
            Intrinsics.checkNotNullParameter(density, "<this>");
            calculateCellsCrossAxisSizeImpl = LazyGridDslKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.mo319roundToPx0680j_4(this.minSize) + i2), 1), i2);
            return calculateCellsCrossAxisSizeImpl;
        }

        public int hashCode() {
            return Dp.m4879hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m4878equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float f) {
            this.size = f;
            if (Dp.m4872compareTo0680j_4(f, Dp.m4873constructorimpl(0)) <= 0) {
                throw new IllegalArgumentException(("Provided size " + ((Object) Dp.m4884toStringimpl(f)) + " should be larger than zero.").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            int mo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(this.size);
            int i3 = mo319roundToPx0680j_4 + i2;
            int i4 = i2 + i;
            if (i3 < i4) {
                int i5 = i4 / i3;
                ArrayList arrayList = new ArrayList(i5);
                for (int i6 = 0; i6 < i5; i6++) {
                    arrayList.add(Integer.valueOf(mo319roundToPx0680j_4));
                }
                return arrayList;
            }
        ...
        public int hashCode() {
            return Dp.m4879hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m4878equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
