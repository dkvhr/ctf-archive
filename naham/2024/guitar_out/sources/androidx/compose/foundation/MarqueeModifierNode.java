...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing spacing, float f) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m221boximpl(i2), null, 2, null);
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m4843constrainWidthK40F9xA(j, mo3866measureBRTryo0.getWidth()));
        setContentWidth(mo3866measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measure, getContainerWidth(), mo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m2456getHeightimpl = Size.m2456getHeightimpl(contentDrawScope2.mo3172getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3100clipRectN_I0leg(floatValue, 0.0f, floatValue + getContainerWidth(), m2456getHeightimpl, m2618getIntersectrtfAjoo);
        if (z) {
