...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m2406getZeroF1C5BW0();
        ...
        public final void m146setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    ...
    public boolean mo143onPreKeyEventZmokQxo(KeyEvent event) {
    ...
    public static /* synthetic */ void m140updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        abstractClickableNode.m144updateCommonXHw0xAI(mutableInteractionSource, z, str, role, function0);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: updateCommon-XHw0xAI, reason: not valid java name */
    public final void m144updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public void mo142onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        getClickablePointerInputNode().mo142onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo141onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (this.enabled && Clickable_androidKt.m207isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3304boximpl(KeyEvent_androidKt.m3615getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), defaultConstructorMarker);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m3304boximpl(KeyEvent_androidKt.m3615getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m205isClickZmokQxo(event)) {
            PressInteraction.Press remove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3304boximpl(KeyEvent_androidKt.m3615getKeyZmokQxo(event)));
            if (remove != null) {
