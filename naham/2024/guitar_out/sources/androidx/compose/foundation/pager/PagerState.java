...
public abstract class PagerState implements ScrollableState {
    ...
    public final void m702setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public PagerState(int i, float f) {
        ...
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2379boximpl(Offset.INSTANCE.m2406getZeroF1C5BW0()), null, 2, null);
    ...
    public final long m701getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m703setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m2379boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(this.density.mo325toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    private final void notifyPrefetch(float delta) {
        ...
        if (this.prefetchingEnabled) {
            ...
            if (!layoutInfo$foundation_release.getVisiblePagesInfo().isEmpty()) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m639schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
        }
    }
