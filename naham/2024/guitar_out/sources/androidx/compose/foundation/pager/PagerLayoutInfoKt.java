...
public final class PagerLayoutInfoKt {
    ...
    public static final int getMainAxisViewportSize(PagerLayoutInfo pagerLayoutInfo) {
        ...
        return pagerLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m5032getHeightimpl(pagerLayoutInfo.mo694getViewportSizeYbymL2g()) : IntSize.m5033getWidthimpl(pagerLayoutInfo.mo694getViewportSizeYbymL2g());
    }
}
