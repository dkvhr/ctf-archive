...
public final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m684consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Velocity.m5094copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m5094copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    /* renamed from: consumeOnOrientation-8S9VItk, reason: not valid java name */
    public final long m683consumeOnOrientation8S9VItk(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Offset.m2384copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
        }
        return Offset.m2384copydBAh8RU$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo333onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m3640equalsimpl0(source, NestedScrollSource.INSTANCE.m3646getFlingWNlRxjI()) ? m683consumeOnOrientation8S9VItk(available, this.orientation) : Offset.INSTANCE.m2406getZeroF1C5BW0();
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo332onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m5089boximpl(m684consumeOnOrientationQWom1Mo(j2, this.orientation));
    }
}
