...
public final class PagerMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m698rememberPagerMeasurePolicyBxUkNYg(final Function0<PagerLazyLayoutItemProvider> itemProviderLambda, final PagerState state, final PaddingValues contentPadding, final boolean z, final Orientation orientation, final int i, final float f, final PageSize pageSize, final Alignment.Horizontal horizontal, final Alignment.Vertical vertical, final Function0<Integer> pageCount, Composer composer, int i2, int i3) {
        ...
        Object[] objArr = {contentPadding, Dp.m4871boximpl(f), pageSize, state, contentPadding, Boolean.valueOf(z), orientation, horizontal, vertical, pageCount};
        ...
        if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m699invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final PagerMeasureResult m699invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    int i6;
                    ...
                    CheckScrollableContainerConstraintsKt.m187checkScrollableContainerConstraintsK40F9xA(j, z3 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z3) {
                        i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(contentPadding.mo431calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(PaddingKt.calculateStartPadding(contentPadding, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z3) {
                        i6 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(contentPadding.mo432calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(PaddingKt.calculateEndPadding(contentPadding, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i7 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(contentPadding.getTop());
                    int i8 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(contentPadding.getBottom());
                    final int i9 = i7 + i8;
                    final int i10 = i5 + i6;
                    int i11 = z3 ? i9 : i10;
                    ...
                    int i14 = lazyLayoutMeasureScope.mo319roundToPx0680j_4(f);
                    if (z3) {
                        m4829getMaxWidthimpl = Constraints.m4828getMaxHeightimpl(j) - i9;
                    } else {
                        m4829getMaxWidthimpl = Constraints.m4829getMaxWidthimpl(j) - i10;
                    }
                    if (!z || m4829getMaxWidthimpl > 0) {
                        IntOffset = IntOffsetKt.IntOffset(i5, i7);
                    } else {
                        if (!z3) {
                            i5 += m4829getMaxWidthimpl;
                        }
                        if (z3) {
                            i7 += m4829getMaxWidthimpl;
                        }
                        IntOffset = IntOffsetKt.IntOffset(i5, i7);
                    }
                    long j2 = IntOffset;
                    int calculateMainAxisPageSize = pageSize.calculateMainAxisPageSize(lazyLayoutMeasureScope2, m4829getMaxWidthimpl, i14);
                    state.m702setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, Orientation.this == Orientation.Vertical ? Constraints.m4829getMaxWidthimpl(m4845offsetNN6EwU) : calculateMainAxisPageSize, 0, Orientation.this != Orientation.Vertical ? Constraints.m4828getMaxHeightimpl(m4845offsetNN6EwU) : calculateMainAxisPageSize, 5, null));
                        ...
                        try {
                            ...
                            PagerMeasureResult m697measurePagerntgEbfI = PagerMeasureKt.m697measurePagerntgEbfI(lazyLayoutMeasureScope, pageCount.invoke().intValue(), invoke, m4829getMaxWidthimpl, i12, i13, i14, firstVisiblePage$foundation_release, i15, state.getScrollToBeConsumed(), m4845offsetNN6EwU, Orientation.this, vertical, horizontal, z, j2, calculateMainAxisPageSize, i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, state.getPinnedPages(), state.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1.2
                                ...
                                public final MeasureResult invoke(int i16, int i17, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                    ...
                                    return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m4843constrainWidthK40F9xA(j, i16 + i10), ConstraintsKt.m4842constrainHeightK40F9xA(j, i17 + i9), MapsKt.emptyMap(), placement);
                                }
                            });
                            state.applyMeasureResult$foundation_release(m697measurePagerntgEbfI);
