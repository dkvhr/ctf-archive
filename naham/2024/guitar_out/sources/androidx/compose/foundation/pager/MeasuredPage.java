...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long m687getOffsetBjo55l4 = m687getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    m4991getXimpl = (this.mainAxisLayoutSize - IntOffset.m4991getXimpl(m687getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4991getXimpl = IntOffset.m4991getXimpl(m687getOffsetBjo55l4);
                }
                if (this.isVertical) {
                    m4992getYimpl = (this.mainAxisLayoutSize - IntOffset.m4992getYimpl(m687getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m4992getYimpl = IntOffset.m4992getYimpl(m687getOffsetBjo55l4);
                }
                m687getOffsetBjo55l4 = IntOffsetKt.IntOffset(m4991getXimpl, m4992getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m687getOffsetBjo55l4) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(m687getOffsetBjo55l4) + IntOffset.m4992getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3926placeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3925placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            }
        }
    }

    /* renamed from: getOffset-Bjo55l4, reason: not valid java name */
    private final long m687getOffsetBjo55l4(int index) {
    ...
    private final long m686copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
