...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m697measurePagerntgEbfI(final LazyLayoutMeasureScope measurePager, int i, final PagerLazyLayoutItemProvider pagerItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> pinnedPages, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), 0, i8, i5, i4, orientation, -i3, i2 + i4, false, 0.0f, null, null, 0, false, layout.invoke(Integer.valueOf(Constraints.m4831getMinWidthimpl(j)), Integer.valueOf(Constraints.m4830getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$2
        ...
        final long Constraints$default = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m4829getMaxWidthimpl(j) : i8, 0, orientation != Orientation.Vertical ? Constraints.m4828getMaxHeightimpl(j) : i8, 5, null);
        int i27 = i6;
        if (i27 >= i) {
            i27 = i - 1;
            i10 = 0;
        ...
        while (i31 < 0 && i27 > 0) {
            ...
            int i36 = i26;
            MeasuredPage m696getAndMeasureSGf7dI0 = m696getAndMeasureSGf7dI0(measurePager, i33, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
            arrayDeque6.add(i36, m696getAndMeasureSGf7dI0);
            i32 = Math.max(i32, m696getAndMeasureSGf7dI0.getCrossAxisSize());
            i31 += i34;
            coerceAtLeast = i34;
        ...
        while (true) {
            ...
            int i60 = i43;
            MeasuredPage m696getAndMeasureSGf7dI02 = m696getAndMeasureSGf7dI0(measurePager, i50, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
            i49 += i37;
            if (i49 <= i54) {
                i25 = i58;
                if (i25 != i57 - 1) {
            ...
            int max = Math.max(i56, m696getAndMeasureSGf7dI02.getCrossAxisSize());
            arrayDeque4 = arrayDeque9;
            arrayDeque4.add(m696getAndMeasureSGf7dI02);
            i53 = i55;
            i51 = max;
            i50 = i25 + 1;
            i42 = i2;
        ...
        if (i16 < i17) {
            ...
            while (i65 < i62 && i63 > 0) {
                ...
                MeasuredPage m696getAndMeasureSGf7dI03 = m696getAndMeasureSGf7dI0(measurePager, i66, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, measurePager.getLayoutDirection(), z, i8);
                arrayDeque11.add(0, m696getAndMeasureSGf7dI03);
                i64 = Math.max(i64, m696getAndMeasureSGf7dI03.getCrossAxisSize());
                i65 += i37;
                i62 = i3;
        ...
        List<MeasuredPage> createPagesBeforeList = createPagesBeforeList(i19, i9, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int i74) {
                MeasuredPage m696getAndMeasureSGf7dI04;
                LazyLayoutMeasureScope lazyLayoutMeasureScope = LazyLayoutMeasureScope.this;
                m696getAndMeasureSGf7dI04 = PagerMeasureKt.m696getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i74, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                return m696getAndMeasureSGf7dI04;
            }
        });
        ...
        List<MeasuredPage> createPagesAfterList = createPagesAfterList(((MeasuredPage) arrayDeque3.last()).getIndex(), i, i9, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
            ...
            public final MeasuredPage invoke(int i77) {
                MeasuredPage m696getAndMeasureSGf7dI04;
                LazyLayoutMeasureScope lazyLayoutMeasureScope = LazyLayoutMeasureScope.this;
                m696getAndMeasureSGf7dI04 = PagerMeasureKt.m696getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i77, Constraints$default, pagerItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                return m696getAndMeasureSGf7dI04;
            }
        });
        ...
        int m4843constrainWidthK40F9xA = ConstraintsKt.m4843constrainWidthK40F9xA(j3, i24);
        if (orientation == Orientation.Vertical) {
            i77 = i76;
        }
        int m4842constrainHeightK40F9xA = ConstraintsKt.m4842constrainHeightK40F9xA(j3, i77);
        LazyLayoutMeasureScope lazyLayoutMeasureScope = measurePager;
        int i79 = i18;
        final List<MeasuredPage> calculatePagesOffsets = calculatePagesOffsets(measurePager, arrayDeque, createPagesBeforeList, createPagesAfterList, m4843constrainWidthK40F9xA, m4842constrainHeightK40F9xA, i76, i2, i69, orientation, z, lazyLayoutMeasureScope, i5, i8);
        if (z3) {
        ...
        int i81 = orientation == Orientation.Vertical ? m4842constrainHeightK40F9xA : m4843constrainWidthK40F9xA;
        if (list.isEmpty()) {
            measuredPage2 = null;
            z2 = true;
        } else {
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical m394spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m394spacedBy0680j_4(lazyLayoutMeasureScope.mo322toDpu2uoSUM(i7));
            if (orientation == Orientation.Vertical) {
                m394spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
            } else {
                m394spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
            }
