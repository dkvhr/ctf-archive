...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle style, View view, Density density, float initialZoom) {
        ...
        long mo326toSizeXkaWNTQ = density.mo326toSizeXkaWNTQ(style.getSize());
        float mo325toPx0680j_4 = density.mo325toPx0680j_4(style.getCornerRadius());
        float mo325toPx0680j_42 = density.mo325toPx0680j_4(style.getElevation());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo326toSizeXkaWNTQ != Size.INSTANCE.m2467getUnspecifiedNHjbRc()) {
            builder.setSize(MathKt.roundToInt(Size.m2459getWidthimpl(mo326toSizeXkaWNTQ)), MathKt.roundToInt(Size.m2456getHeightimpl(mo326toSizeXkaWNTQ)));
        }
        if (!Float.isNaN(mo325toPx0680j_4)) {
            builder.setCornerRadius(mo325toPx0680j_4);
        }
        if (!Float.isNaN(mo325toPx0680j_42)) {
            builder.setElevation(mo325toPx0680j_42);
        }
