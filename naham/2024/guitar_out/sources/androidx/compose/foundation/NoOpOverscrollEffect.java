...
public final class NoOpOverscrollEffect implements OverscrollEffect {
    ...
    public long mo154applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        Intrinsics.checkNotNullParameter(performScroll, "performScroll");
        return performScroll.invoke(Offset.m2379boximpl(delta)).getPackedValue();
    }

    @Override // androidx.compose.foundation.OverscrollEffect
    /* renamed from: applyToFling-BMRW4eQ */
    public Object mo153applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object invoke = function2.invoke(Velocity.m5089boximpl(j), continuation);
