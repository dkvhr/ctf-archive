...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m4817boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4818constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4821equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4822equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl, reason: not valid java name */
    private static final int m4823getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public static int m4832hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m4821equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4832hashCodeimpl(this.value);
    }
    ...
    public static final int m4831getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m4823getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m4829getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m4823getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m4830getMinHeightimpl(long j) {
        int m4823getFocusIndeximpl = m4823getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[m4823getFocusIndeximpl])) & HeightMask[m4823getFocusIndeximpl];
    }

    /* renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m4828getMaxHeightimpl(long j) {
        int m4823getFocusIndeximpl = m4823getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[m4823getFocusIndeximpl] + 31))) & HeightMask[m4823getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m4825getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m4823getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m4824getHasBoundedHeightimpl(long j) {
        int m4823getFocusIndeximpl = m4823getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[m4823getFocusIndeximpl] + 31))) & HeightMask[m4823getFocusIndeximpl]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl, reason: not valid java name */
    public static final boolean m4827getHasFixedWidthimpl(long j) {
        return m4829getMaxWidthimpl(j) == m4831getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m4826getHasFixedHeightimpl(long j) {
        return m4828getMaxHeightimpl(j) == m4830getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m4833isZeroimpl(long j) {
        return m4829getMaxWidthimpl(j) == 0 || m4828getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default, reason: not valid java name */
    public static /* synthetic */ long m4820copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m4831getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m4829getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m4830getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m4828getMaxHeightimpl(j);
        }
        return m4819copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m4819copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        if (i3 < 0 || i < 0) {
        ...
        return INSTANCE.m4836createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
    }
    ...
    public static String m4834toStringimpl(long j) {
        int m4829getMaxWidthimpl = m4829getMaxWidthimpl(j);
        String valueOf = m4829getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m4829getMaxWidthimpl);
        int m4828getMaxHeightimpl = m4828getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m4831getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m4830getMinHeightimpl(j) + ", maxHeight = " + (m4828getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(m4828getMaxHeightimpl) : "Infinity") + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4837fixedJhjzzOo(int width, int height) {
            if (width < 0 || height < 0) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m4836createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m4839fixedWidthOenEA2s(int width) {
            if (width < 0) {
                throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
            }
            return m4836createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m4838fixedHeightOenEA2s(int height) {
            if (height < 0) {
                throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
            }
            return m4836createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m4836createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j;
            ...
            return Constraints.m4818constructorimpl((i3 << 33) | j | (minWidth << Constraints.MinFocusHeight) | (minHeight << i5) | (i4 << (i5 + 31)));
        }
