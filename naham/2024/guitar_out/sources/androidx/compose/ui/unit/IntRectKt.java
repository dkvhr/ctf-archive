...
public final class IntRectKt {
    ...
    public static final IntRect m5023IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j), IntOffset.m4991getXimpl(j) + IntSize.m5033getWidthimpl(j2), IntOffset.m4992getYimpl(j) + IntSize.m5032getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5022IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j), IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5024IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m4991getXimpl(j) - i, IntOffset.m4992getYimpl(j) - i, IntOffset.m4991getXimpl(j) + i, IntOffset.m4992getYimpl(j) + i);
    }
