...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m5009getSizeYbymL2g$annotations() {
    }
    ...
    public final long m5017getSizeYbymL2g() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: translate--gyyYBs, reason: not valid java name */
    public final IntRect m5021translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m4991getXimpl(offset), this.top + IntOffset.m4992getYimpl(offset), this.right + IntOffset.m4991getXimpl(offset), this.bottom + IntOffset.m4992getYimpl(offset));
    }
