...
public final class FocusDirection {
    ...
    private static final int Next = m2307constructorimpl(1);
    private static final int Previous = m2307constructorimpl(2);
    private static final int Left = m2307constructorimpl(3);
    private static final int Right = m2307constructorimpl(4);
    private static final int Up = m2307constructorimpl(5);
    private static final int Down = m2307constructorimpl(6);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FocusDirection m2306boximpl(int i) {
        return new FocusDirection(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2307constructorimpl(int i) {
        return i;
    }
    ...
    public static String m2311toStringimpl(int i) {
        return m2309equalsimpl0(i, Next) ? "Next" : m2309equalsimpl0(i, Previous) ? "Previous" : m2309equalsimpl0(i, Left) ? "Left" : m2309equalsimpl0(i, Right) ? "Right" : m2309equalsimpl0(i, Up) ? "Up" : m2309equalsimpl0(i, Down) ? "Down" : m2309equalsimpl0(i, Enter) ? "Enter" : m2309equalsimpl0(i, Exit) ? "Exit" : "Invalid FocusDirection";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2313getEnterdhqQ8s$annotations() {
        }

        /* renamed from: getExit-dhqQ-8s$annotations, reason: not valid java name */
        public static /* synthetic */ void m2314getExitdhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m2315getIndhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m2316getOutdhqQ8s$annotations() {
        }
        ...
        public final int m2322getNextdhqQ8s() {
            return FocusDirection.Next;
        }

        /* renamed from: getPrevious-dhqQ-8s, reason: not valid java name */
        public final int m2324getPreviousdhqQ8s() {
            return FocusDirection.Previous;
        }

        /* renamed from: getLeft-dhqQ-8s, reason: not valid java name */
        public final int m2321getLeftdhqQ8s() {
            return FocusDirection.Left;
        }

        /* renamed from: getRight-dhqQ-8s, reason: not valid java name */
        public final int m2325getRightdhqQ8s() {
            return FocusDirection.Right;
        }

        /* renamed from: getUp-dhqQ-8s, reason: not valid java name */
        public final int m2326getUpdhqQ8s() {
            return FocusDirection.Up;
        }

        /* renamed from: getDown-dhqQ-8s, reason: not valid java name */
        public final int m2317getDowndhqQ8s() {
            return FocusDirection.Down;
        }

        /* renamed from: getEnter-dhqQ-8s, reason: not valid java name */
        public final int m2318getEnterdhqQ8s() {
            return FocusDirection.Enter;
        }

        /* renamed from: getExit-dhqQ-8s, reason: not valid java name */
        public final int m2319getExitdhqQ8s() {
            return FocusDirection.Exit;
        }

        /* renamed from: getIn-dhqQ-8s, reason: not valid java name */
        public final int m2320getIndhqQ8s() {
            return FocusDirection.In;
        }

        /* renamed from: getOut-dhqQ-8s, reason: not valid java name */
        public final int m2323getOutdhqQ8s() {
            return FocusDirection.Out;
        }
    }

    static {
        int m2307constructorimpl = m2307constructorimpl(7);
        Enter = m2307constructorimpl;
        int m2307constructorimpl2 = m2307constructorimpl(8);
        Exit = m2307constructorimpl2;
        In = m2307constructorimpl;
        Out = m2307constructorimpl2;
    }
}
