...
public final class FocusTransactionsKt {
    ...
    private static final boolean requestFocusForChild(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        if (i2 == 4) {
            ...
            int m4081constructorimpl2 = NodeKind.m4081constructorimpl(1024);
                    ...
                    while (parent2 != null) {
                        if ((parent2.getKindSet() & m4081constructorimpl2) != 0) {
                            ...
                            while (node3 != null) {
                                ...
                                if ((node3.getKindSet() & m4081constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                                    int i3 = 0;
    ...
    public static final CustomDestinationResult m2341performCustomRequestFocusMxy_nc0(FocusTargetNode performCustomRequestFocus, int i) {
        ...
        if (i2 == 4) {
                    ...
                    while (parent != null) {
                        if ((parent.getKindSet() & m4081constructorimpl) != 0) {
                            ...
                            while (node != null) {
                                ...
                                if ((node.getKindSet() & m4081constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                                    int i3 = 0;
            ...
            CustomDestinationResult m2341performCustomRequestFocusMxy_nc0 = m2341performCustomRequestFocusMxy_nc0(focusTargetNode2, i);
            CustomDestinationResult customDestinationResult = m2341performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? m2341performCustomRequestFocusMxy_nc0 : null;
    ...
    public static final CustomDestinationResult m2338performCustomClearFocusMxy_nc0(FocusTargetNode performCustomClearFocus, int i) {
        ...
        if (i2 != 1) {
            ...
            if (i2 == 3) {
                ...
                CustomDestinationResult m2338performCustomClearFocusMxy_nc0 = m2338performCustomClearFocusMxy_nc0(activeChild, i);
                if (m2338performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    m2338performCustomClearFocusMxy_nc0 = null;
                }
                return m2338performCustomClearFocusMxy_nc0 == null ? m2340performCustomExitMxy_nc0(performCustomClearFocus, i) : m2338performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m2339performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            ...
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2306boximpl(i));
    ...
    private static final CustomDestinationResult m2340performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            ...
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2306boximpl(i));
                if (invoke != FocusRequester.INSTANCE.getDefault()) {
                    if (invoke == FocusRequester.INSTANCE.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
