...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m2355twoDimensionalFocusSearchOMvw8(FocusTargetNode twoDimensionalFocusSearch, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
        Intrinsics.checkNotNullParameter(twoDimensionalFocusSearch, "$this$twoDimensionalFocusSearch");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        int i2 = WhenMappings.$EnumSwitchMapping$0[twoDimensionalFocusSearch.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m2351findChildCorrespondingToFocusEnterOMvw8(twoDimensionalFocusSearch, i, onFound));
            }
            if (i2 == 4) {
        ...
        if (i3 == 1) {
            Boolean m2355twoDimensionalFocusSearchOMvw8 = m2355twoDimensionalFocusSearchOMvw8(activeChild, i, onFound);
            return !Intrinsics.areEqual((Object) m2355twoDimensionalFocusSearchOMvw8, (Object) false) ? m2355twoDimensionalFocusSearchOMvw8 : Boolean.valueOf(m2352generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(activeChild), i, onFound));
        }
        if (i3 == 2 || i3 == 3) {
            return Boolean.valueOf(m2352generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeChild, i, onFound));
        }
        if (i3 == 4) {
            throw new IllegalStateException(NoActiveChild.toString());
        }
    ...
    private static final boolean m2352generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m2354searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2305searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                boolean m2354searchChildren4C6V_qg;
                Intrinsics.checkNotNullParameter(searchBeyondBounds, "$this$searchBeyondBounds");
                m2354searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m2354searchChildren4C6V_qg(FocusTargetNode.this, focusTargetNode2, i, function1);
                Boolean valueOf = Boolean.valueOf(m2354searchChildren4C6V_qg);
    ...
    private static final FocusTargetNode m2350findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect translate;
        if (FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2321getLeftdhqQ8s())) {
            ...
            translate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2326getUpdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m2353isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2321getLeftdhqQ8s())) {
            if (FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2325getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float top2;
        float height;
        if (FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2321getLeftdhqQ8s()) || FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2325getRightdhqQ8s())) {
            f = 2;
            top = rect2.getTop() + (rect2.getHeight() / f);
            top2 = rect.getTop();
            height = rect.getHeight();
        } else {
            if (!FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2326getUpdhqQ8s()) && !FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2317getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m2353isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m2349beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m2349beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final boolean m2349beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2321getLeftdhqQ8s()) || FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2325getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m2351findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode findChildCorrespondingToFocusEnter, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
        Rect rect;
        ...
        if (FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2318getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m2325getRightdhqQ8s();
        }
        if (FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2325getRightdhqQ8s()) || FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2317getDowndhqQ8s())) {
            rect = topLeft(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        } else {
            if (!FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2321getLeftdhqQ8s()) && !FocusDirection.m2309equalsimpl0(i, FocusDirection.INSTANCE.m2326getUpdhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rect = bottomRight(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        }
        FocusTargetNode m2350findBestCandidate4WY_MpI = m2350findBestCandidate4WY_MpI(mutableVector, rect, i);
        if (m2350findBestCandidate4WY_MpI != null) {
            return onFound.invoke(m2350findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m2354searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode m2350findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((node.getAggregateChildKindSet() & m4081constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((node.getKindSet() & m4081constructorimpl) != 0) {
        ...
        while (mutableVector.isNotEmpty() && (m2350findBestCandidate4WY_MpI = m2350findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetNode2), i)) != null) {
            if (m2350findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(m2350findBestCandidate4WY_MpI).booleanValue();
            }
            if (m2352generateAndSearchChildren4C6V_qg(m2350findBestCandidate4WY_MpI, focusTargetNode2, i, function1)) {
                return true;
            }
            mutableVector.remove(m2350findBestCandidate4WY_MpI);
        }
        return false;
    }
