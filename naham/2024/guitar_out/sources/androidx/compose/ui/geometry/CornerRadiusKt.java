...
public final class CornerRadiusKt {
    ...
    public static final long m2376lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2365getXimpl(j), CornerRadius.m2365getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m2366getYimpl(j), CornerRadius.m2366getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m2359constructorimpl((Float.floatToIntBits(f2) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }
}
