        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            AndroidDialog_androidKt$DialogLayout$1 androidDialog_androidKt$DialogLayout$1 = new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$DialogLayout$1
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    int width3 = placeable2 != null ? placeable2.getWidth() : Constraints.m4831getMinWidthimpl(j);
                    if (!arrayList2.isEmpty()) {
                    ...
                    return MeasureScope.layout$default(Layout, width3, placeable3 != null ? placeable3.getHeight() : Constraints.m4830getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$DialogLayout$1$measure$1
            ...
            Updater.m2270setimpl(m2263constructorimpl, androidDialog_androidKt$DialogLayout$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            modifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(startRestartGroup)), startRestartGroup, Integer.valueOf((i6 >> 3) & 112));
