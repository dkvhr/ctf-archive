...
public final class KeyEventType {
    ...
    private static final int Unknown = m3606constructorimpl(0);
    private static final int KeyUp = m3606constructorimpl(1);
    private static final int KeyDown = m3606constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m3605boximpl(int i) {
        return new KeyEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3606constructorimpl(int i) {
        return i;
    }
    ...
    public static int m3609hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3607equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3609hashCodeimpl(this.value);
    }
    ...
    public static String m3610toStringimpl(int i) {
        return m3608equalsimpl0(i, KeyUp) ? "KeyUp" : m3608equalsimpl0(i, KeyDown) ? "KeyDown" : m3608equalsimpl0(i, Unknown) ? "Unknown" : "Invalid";
    }
