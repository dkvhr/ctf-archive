...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m2406getZeroF1C5BW0();
    ...
    public final void m3842setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* renamed from: addPosition-Uv8p0NA, reason: not valid java name */
    public final void m3839addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m2390getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m2391getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m3840calculateVelocity9UxMQ8M() {
