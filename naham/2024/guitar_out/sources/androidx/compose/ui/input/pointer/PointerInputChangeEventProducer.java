...
public final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long j;
        boolean down;
        long mo3829screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3728boximpl(pointerInputEventData.m3761getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j = pointerInputEventData.getUptime();
                mo3829screenToLocalMKHz9U = pointerInputEventData.m3762getPositionF1C5BW0();
                down = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j = uptime;
                down = pointerInputData.getDown();
                mo3829screenToLocalMKHz9U = positionCalculator.mo3829screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            linkedHashMap.put(PointerId.m3728boximpl(pointerInputEventData.m3761getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3761getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3762getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j, mo3829screenToLocalMKHz9U, down, false, pointerInputEventData.m3765getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3764getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3728boximpl(pointerInputEventData.m3761getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3763getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3765getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3728boximpl(pointerInputEventData.m3761getIdJ3iCeTQ()));
            }
        }
