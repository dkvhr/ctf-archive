...
public final class NestedScrollSource {
    ...
    private static final int Drag = m3638constructorimpl(1);
    private static final int Fling = m3638constructorimpl(2);
    private static final int Relocate = m3638constructorimpl(3);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m3637boximpl(int i) {
    ...
    public static String m3642toStringimpl(int i) {
        return m3640equalsimpl0(i, Drag) ? "Drag" : m3640equalsimpl0(i, Fling) ? "Fling" : m3640equalsimpl0(i, Relocate) ? "Relocate" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3644getRelocateWNlRxjI$annotations() {
        }
        ...
        public final int m3645getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI, reason: not valid java name */
        public final int m3646getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI, reason: not valid java name */
        public final int m3647getRelocateWNlRxjI() {
