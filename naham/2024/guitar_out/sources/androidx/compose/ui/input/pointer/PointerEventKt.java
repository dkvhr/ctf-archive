...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2387equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m2406getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2387equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m2406getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long m2394minusMKHz9U = Offset.m2394minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? m2394minusMKHz9U : Offset.INSTANCE.m2406getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (Offset.m2387equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m2406getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m3693isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long j) {
        ...
        return m2390getXimpl < 0.0f || m2390getXimpl > ((float) IntSize.m5033getWidthimpl(j)) || m2391getYimpl < 0.0f || m2391getYimpl > ((float) IntSize.m5032getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m3694isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long j, long j2) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m3819equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m3826getTouchT8wyACA())) {
            return m3693isOutOfBoundsO0kMr_c(isOutOfBounds, j);
        }
        long position = isOutOfBounds.getPosition();
        float m2390getXimpl = Offset.m2390getXimpl(position);
        float m2391getYimpl = Offset.m2391getYimpl(position);
        return m2390getXimpl < (-Size.m2459getWidthimpl(j2)) || m2390getXimpl > ((float) IntSize.m5033getWidthimpl(j)) + Size.m2459getWidthimpl(j2) || m2391getYimpl < (-Size.m2456getHeightimpl(j2)) || m2391getYimpl > ((float) IntSize.m5032getHeightimpl(j)) + Size.m2456getHeightimpl(j2);
    }
}
