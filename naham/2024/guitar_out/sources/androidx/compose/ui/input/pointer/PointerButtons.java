...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m3681boximpl(int i) {
    ...
    public static String m3686toStringimpl(int i) {
        return "PointerButtons(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m3683equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3685hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m3686toStringimpl(this.packedValue);
    }
