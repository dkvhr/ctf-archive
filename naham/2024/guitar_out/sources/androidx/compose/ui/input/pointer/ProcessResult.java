...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m3830boximpl(int i) {
        return new ProcessResult(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3831constructorimpl(int i) {
        return i;
    }
    ...
    public static final boolean m3834getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m3835getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3836hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3837toStringimpl(int i) {
    ...
    public int hashCode() {
        return m3836hashCodeimpl(this.value);
    }
