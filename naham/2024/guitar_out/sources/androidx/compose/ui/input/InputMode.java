...
public final class InputMode {
    ...
    private static final int Touch = m3291constructorimpl(1);
    private static final int Keyboard = m3291constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputMode m3290boximpl(int i) {
    ...
    public static String m3295toStringimpl(int i) {
        return m3293equalsimpl0(i, Touch) ? "Touch" : m3293equalsimpl0(i, Keyboard) ? "Keyboard" : "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m3298getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* renamed from: getKeyboard-aOaMEAU, reason: not valid java name */
        public final int m3297getKeyboardaOaMEAU() {
