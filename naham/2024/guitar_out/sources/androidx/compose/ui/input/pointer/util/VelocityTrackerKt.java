...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            velocityTracker.m3842setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.getPosition());
        ...
        while (i < size) {
            ...
            long m2394minusMKHz9U = Offset.m2394minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m3842setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2395plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), m2394minusMKHz9U));
            velocityTracker.m3839addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
            i++;
            previousPosition = position;
        }
        velocityTracker.m3842setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2395plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m2394minusMKHz9U(event.getPosition(), previousPosition)));
        velocityTracker.m3839addPositionUv8p0NA(event.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
    }
