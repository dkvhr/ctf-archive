...
public final class PointerEvent {
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.INSTANCE.m3707getScroll7fucELk();
                            case 9:
                                return PointerEventType.INSTANCE.m3702getEnter7fucELk();
                            case 10:
                                return PointerEventType.INSTANCE.m3703getExit7fucELk();
                            default:
                                return PointerEventType.INSTANCE.m3708getUnknown7fucELk();
                        }
                    }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            linkedHashMap.put(PointerId.m3728boximpl(pointerInputChange.getId()), pointerInputChange);
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m3678issuesEnterExitEvent0FcD4WY(pointerInputChange.getId())) {
                    arrayList2.add(new PointerInputEventData(id, uptimeMillis, position, position2, pressed, pressure, type, z, null, 0L, 768, null));
                    i = i2 + 1;
                }
            }
            z = false;
