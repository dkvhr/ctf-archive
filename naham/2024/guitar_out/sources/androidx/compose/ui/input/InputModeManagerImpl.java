...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> onRequestInputModeChange) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3290boximpl(i), null, 2, null);
    ...
    public int mo3299getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode.getValue()).getValue();
    }

    /* renamed from: setInputMode-iuPiT84, reason: not valid java name */
    public void m3301setInputModeiuPiT84(int i) {
        this.inputMode.setValue(InputMode.m3290boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo3300requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m3290boximpl(inputMode)).booleanValue();
    }
}
