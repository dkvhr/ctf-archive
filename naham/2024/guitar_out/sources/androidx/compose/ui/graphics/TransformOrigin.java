...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m3000boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3003constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3006equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3007equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m3010hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3011toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m3006equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3010hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m3011toStringimpl(this.packedValue);
    }
    ...
    public static final float m3001component1impl(long j) {
        return m3008getPivotFractionXimpl(j);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3002component2impl(long j) {
        return m3009getPivotFractionYimpl(j);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m3005copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m3008getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m3009getPivotFractionYimpl(j);
        }
        return m3004copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m3004copyzey9I6w(long j, float f, float f2) {
    ...
    public static final class Companion {
        ...
        public final long m3013getCenterSzJe1aQ() {
            return TransformOrigin.Center;
        }
    }

    /* renamed from: getPivotFractionX-impl, reason: not valid java name */
    public static final float m3008getPivotFractionXimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m3009getPivotFractionYimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
