...
public final class StrokeCap {
    ...
    private static final int Butt = m2969constructorimpl(0);
    private static final int Round = m2969constructorimpl(1);
    private static final int Square = m2969constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeCap m2968boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2975getButtKaPHkGw() {
            return StrokeCap.Butt;
        }

        /* renamed from: getRound-KaPHkGw, reason: not valid java name */
        public final int m2976getRoundKaPHkGw() {
            return StrokeCap.Round;
        }

        /* renamed from: getSquare-KaPHkGw, reason: not valid java name */
        public final int m2977getSquareKaPHkGw() {
    ...
    public static String m2973toStringimpl(int i) {
        return m2971equalsimpl0(i, Butt) ? "Butt" : m2971equalsimpl0(i, Round) ? "Round" : m2971equalsimpl0(i, Square) ? "Square" : "Unknown";
    }
}
