...
public final class StrokeJoin {
    ...
    private static final int Miter = m2979constructorimpl(0);
    private static final int Round = m2979constructorimpl(1);
    private static final int Bevel = m2979constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m2978boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2986getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8, reason: not valid java name */
        public final int m2987getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8, reason: not valid java name */
        public final int m2985getBevelLxFBmk8() {
    ...
    public static String m2983toStringimpl(int i) {
        return m2981equalsimpl0(i, Miter) ? "Miter" : m2981equalsimpl0(i, Round) ? "Round" : m2981equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}
