...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3013getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m2714getAutoNrFUSI();
    private long size = Size.INSTANCE.m2467getUnspecifiedNHjbRc();
    ...
    public void mo2815setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo2816setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m2934setSizeuvyYCjk(long j) {
        this.size = j;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo2817setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setTransformOrigin-__ExYCQ */
    public void mo2818setTransformOrigin__ExYCQ(long j) {
    ...
    public final void reset() {
        ...
        mo2815setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo2817setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo2818setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3013getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo2816setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m2714getAutoNrFUSI());
        m2934setSizeuvyYCjk(Size.INSTANCE.m2467getUnspecifiedNHjbRc());
    }
}
