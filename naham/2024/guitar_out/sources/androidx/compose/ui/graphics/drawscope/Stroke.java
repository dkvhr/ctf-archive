...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m2975getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m2986getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m3237getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m3238getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m2971equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2981equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m2972hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2982hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2973toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2983toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
