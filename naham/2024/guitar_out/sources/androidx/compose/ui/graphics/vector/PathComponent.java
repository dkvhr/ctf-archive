...
public final class PathComponent extends VNode {
    ...
    public final void m3260setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo2524setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m3261setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m3262setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int mo2522getFillTypeRgk1Os = this.renderPath.mo2522getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo2524setFillTypeoQ8Xj4U(mo2522getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m3162drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m3162drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
