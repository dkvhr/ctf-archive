...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2447boximpl(Size.INSTANCE.m2468getZeroNHjbRc()), null, 2, null);
    ...
    public final long m3267getSizeNHjbRc$ui_release() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m3268setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m2447boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m3267getSizeNHjbRc$ui_release();
    }
