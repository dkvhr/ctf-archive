...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2598createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2411isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2469getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset(Offset.m2390getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2459getWidthimpl(size) : Offset.m2390getXimpl(this.center), Offset.m2391getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2456getHeightimpl(size) : Offset.m2391getYimpl(this.center));
        }
        return ShaderKt.m2941SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m2387equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int m2392hashCodeimpl = ((Offset.m2392hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m2392hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m2409isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m2398toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
