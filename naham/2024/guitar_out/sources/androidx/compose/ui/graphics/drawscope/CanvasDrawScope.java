...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo3097getSizeNHjbRc() {
            return CanvasDrawScope.this.getDrawParams().m3095getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public void mo3098setSizeuvyYCjk(long j) {
            CanvasDrawScope.this.getDrawParams().m3096setSizeuvyYCjk(j);
        }
    };
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            ...
            if (!StrokeCap.m2971equalsimpl0(obtainStrokePaint.mo2506getStrokeCapKaPHkGw(), stroke.getCap())) {
                obtainStrokePaint.mo2512setStrokeCapBeK7IIE(stroke.getCap());
            }
            if (obtainStrokePaint.getStrokeMiterLimit() != stroke.getMiter()) {
                obtainStrokePaint.setStrokeMiterLimit(stroke.getMiter());
            }
            if (!StrokeJoin.m2981equalsimpl0(obtainStrokePaint.mo2507getStrokeJoinLxFBmk8(), stroke.getJoin())) {
                obtainStrokePaint.mo2513setStrokeJoinWw9F2mQ(stroke.getJoin());
            }
    ...
    private final Paint m3065configurePaintswdJneE(Brush brush, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        ...
        if (brush != null) {
            brush.mo2576applyToPq9zytI(mo3172getSizeNHjbRc(), selectPaint, alpha);
        ...
        if (!BlendMode.m2542equalsimpl0(selectPaint.get_blendMode(), blendMode)) {
            selectPaint.mo2509setBlendModes9anfk8(blendMode);
        }
        if (!FilterQuality.m2720equalsimpl0(selectPaint.mo2505getFilterQualityfv9h1I(), filterQuality)) {
            selectPaint.mo2511setFilterQualityvDHp3xo(filterQuality);
        }
        return selectPaint;
    }
    ...
    private final Paint m3063configurePaint2qPWKa0(long color, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint selectPaint = selectPaint(style);
        long m3071modulate5vOe2sY = m3071modulate5vOe2sY(color, alpha);
        if (!Color.m2630equalsimpl0(selectPaint.mo2504getColor0d7_KjU(), m3071modulate5vOe2sY)) {
            selectPaint.mo2510setColor8_81llA(m3071modulate5vOe2sY);
        }
    ...
    private final Paint m3067configureStrokePaintQ_0CZUI(long color, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint obtainStrokePaint = obtainStrokePaint();
        long m3071modulate5vOe2sY = m3071modulate5vOe2sY(color, alpha);
        if (!Color.m2630equalsimpl0(obtainStrokePaint.mo2504getColor0d7_KjU(), m3071modulate5vOe2sY)) {
            obtainStrokePaint.mo2510setColor8_81llA(m3071modulate5vOe2sY);
        }
        ...
        if (!BlendMode.m2542equalsimpl0(obtainStrokePaint.get_blendMode(), blendMode)) {
            obtainStrokePaint.mo2509setBlendModes9anfk8(blendMode);
        }
        ...
        if (!StrokeCap.m2971equalsimpl0(obtainStrokePaint.mo2506getStrokeCapKaPHkGw(), cap)) {
            obtainStrokePaint.mo2512setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m2981equalsimpl0(obtainStrokePaint.mo2507getStrokeJoinLxFBmk8(), join)) {
            obtainStrokePaint.mo2513setStrokeJoinWw9F2mQ(join);
        }
        if (!Intrinsics.areEqual(obtainStrokePaint.getPathEffect(), pathEffect)) {
            obtainStrokePaint.setPathEffect(pathEffect);
        }
        if (!FilterQuality.m2720equalsimpl0(obtainStrokePaint.mo2505getFilterQualityfv9h1I(), filterQuality)) {
            obtainStrokePaint.mo2511setFilterQualityvDHp3xo(filterQuality);
        }
        return obtainStrokePaint;
    }
    ...
    private final Paint m3069configureStrokePaintho4zsrM(Brush brush, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint obtainStrokePaint = obtainStrokePaint();
        if (brush != null) {
            brush.mo2576applyToPq9zytI(mo3172getSizeNHjbRc(), obtainStrokePaint, alpha);
    ...
    public static final /* data */ class DrawParams {
        ...
        public /* synthetic */ DrawParams(Density density, LayoutDirection layoutDirection, EmptyCanvas emptyCanvas, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? CanvasDrawScopeKt.access$getDefaultDensity$p() : density, (i & 2) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 4) != 0 ? new EmptyCanvas() : emptyCanvas, (i & 8) != 0 ? Size.INSTANCE.m2468getZeroNHjbRc() : j, null);
        }
    }
}
