...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3275getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m2975getButtKaPHkGw();
        }
        return m3274getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m3274getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m2975getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m2977getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m2976getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m3277getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m2986getMiterLxFBmk8();
        }
        return m3276getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3276getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m2986getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m2985getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m2987getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m2665getUnspecified0d7_KjU;
        int m2571getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(androidVectorParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m2665getUnspecified0d7_KjU = Color.INSTANCE.m2665getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m2665getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m2665getUnspecified0d7_KjU = Color.INSTANCE.m2665getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m2665getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2571getSrcIn0nO6VwU();
        } else if (i == 3) {
            m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2573getSrcOver0nO6VwU();
        } else if (i == 5) {
            m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2571getSrcIn0nO6VwU();
        } else if (i == 9) {
            m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2570getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2562getModulate0nO6VwU();
                    break;
                case 15:
                    m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2567getScreen0nO6VwU();
                    break;
                case 16:
                    m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2565getPlus0nO6VwU();
                    break;
                default:
                    m2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2571getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m2571getSrcIn0nO6VwU;
        float m4873constructorimpl = Dp.m4873constructorimpl(dimension / res.getDisplayMetrics().density);
        float m4873constructorimpl2 = Dp.m4873constructorimpl(dimension2 / res.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m4873constructorimpl, m4873constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m3274getStrokeLineCapCSYIeUk = m3274getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m2975getButtKaPHkGw());
        int m3276getStrokeLineJoinkLtJ_vA = m3276getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m2985getBevelLxFBmk8());
        ...
        builder.m3254addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m2906getNonZeroRgk1Os() : companion.m2905getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3274getStrokeLineCapCSYIeUk, m3276getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
