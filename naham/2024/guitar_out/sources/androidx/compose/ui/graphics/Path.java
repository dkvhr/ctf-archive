...
public interface Path {
    ...
    void mo2521addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo2523opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo2524setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc */
    default void mo2525transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
    }

    /* renamed from: translate-k-4lQ0M */
    void mo2526translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2896transform58bKbWc(Path path, float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            Path.super.mo2525transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m2893addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo2521addPathUv8p0NA(path2, j);
    }
    ...
    public static final class Companion {
        ...
        public final Path m2894combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo2523opN5in7k0(path1, path2, operation)) {
                return Path;
            }
