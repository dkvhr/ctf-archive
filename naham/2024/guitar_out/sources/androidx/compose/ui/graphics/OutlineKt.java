...
public final class OutlineKt {
    public static final void addOutline(Path path, Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.m2893addPathUv8p0NA$default(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }

    /* renamed from: drawOutline-hn5TExg$default */
    public static /* synthetic */ void m2880drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = 1.0f;
        }
        float f2 = f;
        ...
        if ((i2 & 32) != 0) {
            i = DrawScope.INSTANCE.m3173getDefaultBlendMode0nO6VwU();
        }
        m2879drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }
    ...
    public static final void drawOutline(Canvas canvas, Outline outline, Paint paint) {
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            if (roundRectPath != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m2365getXimpl(rounded.getRoundRect().m2438getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m2366getYimpl(rounded.getRoundRect().m2438getBottomLeftCornerRadiuskKHJgLs()), paint);
                return;
            }
        }
        if (!(outline instanceof Outline.Generic)) {
    ...
    public static final boolean hasSameCornerRadius(RoundRect roundRect) {
        return ((CornerRadius.m2365getXimpl(roundRect.m2438getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m2365getXimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2365getXimpl(roundRect.m2438getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m2365getXimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2365getXimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m2365getXimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2365getXimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2365getXimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2365getXimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m2365getXimpl(roundRect.m2440getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2365getXimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2365getXimpl(roundRect.m2440getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0) && ((CornerRadius.m2366getYimpl(roundRect.m2438getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m2366getYimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2366getYimpl(roundRect.m2438getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m2366getYimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2366getYimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m2366getYimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2366getYimpl(roundRect.m2439getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2366getYimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2366getYimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m2366getYimpl(roundRect.m2440getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2366getYimpl(roundRect.m2441getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2366getYimpl(roundRect.m2440getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0);
    }

    /* renamed from: drawOutline-wDX37Ww */
    public static final void m2881drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            drawOutline.mo3089drawRectnJ9OG0(j, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                ...
                drawOutline.mo3091drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2365getXimpl(roundRect.m2438getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), style, f, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo3085drawPathLG529CI(path, j, f, style, colorFilter, i);
    }

    /* renamed from: drawOutline-hn5TExg */
    public static final void m2879drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3088drawRectAsUm42w(brush, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                RoundRect roundRect = rounded.getRoundRect();
                drawOutline.mo3090drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2365getXimpl(roundRect.m2438getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, style, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo3084drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
}
