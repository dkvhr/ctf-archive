...
public final class FilterQuality {
    ...
    private static final int None = m2718constructorimpl(0);
    private static final int Low = m2718constructorimpl(1);
    private static final int Medium = m2718constructorimpl(2);
    private static final int High = m2718constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FilterQuality m2717boximpl(int i) {
    ...
    public static boolean m2719equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m2723unboximpl();
    }
    ...
    public final /* synthetic */ int m2723unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m2727getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I, reason: not valid java name */
        public final int m2725getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I, reason: not valid java name */
        public final int m2726getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I, reason: not valid java name */
        public final int m2724getHighfv9h1I() {
    ...
    public static String m2722toStringimpl(int i) {
        return m2720equalsimpl0(i, None) ? "None" : m2720equalsimpl0(i, Low) ? "Low" : m2720equalsimpl0(i, Medium) ? "Medium" : m2720equalsimpl0(i, High) ? "High" : "Unknown";
    }
}
