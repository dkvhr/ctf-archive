...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2573getSrcOver0nO6VwU();
    }
    ...
    public long mo2504getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2510setColor8_81llA(long j) {
        AndroidPaint_androidKt.m2516setNativeColor4WTKRHQ(this.internalPaint, j);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public void mo2509setBlendModes9anfk8(int i) {
        if (BlendMode.m2542equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m2515setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2508getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo2514setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m2520setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo2506getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo2512setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m2518setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2507getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2513setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m2519setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo2505getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo2511setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m2517setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
