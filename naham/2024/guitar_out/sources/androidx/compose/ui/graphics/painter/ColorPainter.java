...
public final class ColorPainter extends Painter {
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        DrawScope.m3167drawRectnJ9OG0$default(drawScope, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m2630equalsimpl0(this.color, ((ColorPainter) other).color);
    }

    public int hashCode() {
        return Color.m2636hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m2637toStringimpl(this.color)) + ')';
    }
}
