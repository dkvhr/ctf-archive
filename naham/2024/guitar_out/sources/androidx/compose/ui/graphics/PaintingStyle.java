...
public final class PaintingStyle {
    ...
    private static final int Fill = m2884constructorimpl(0);
    private static final int Stroke = m2884constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m2883boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2884constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2885equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2886equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2887hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2885equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2887hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2890getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m2891getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    public String toString() {
        return m2888toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2888toStringimpl(int i) {
        return m2886equalsimpl0(i, Fill) ? "Fill" : m2886equalsimpl0(i, Stroke) ? "Stroke" : "Unknown";
    }
}
