...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m2959constructorimpl(0);
    private static final int Rotate = m2959constructorimpl(1);
    private static final int Morph = m2959constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m2958boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2959constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2960equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2961equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2962hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2960equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2962hashCodeimpl(this.value);
    }
    ...
    public static String m2963toStringimpl(int i) {
        return m2961equalsimpl0(i, Translate) ? "Translate" : m2961equalsimpl0(i, Rotate) ? "Rotate" : m2961equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}
