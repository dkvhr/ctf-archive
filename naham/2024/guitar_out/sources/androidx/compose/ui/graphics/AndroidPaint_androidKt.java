...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2515setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int i) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3025setBlendModeGB0RdKg(setNativeBlendMode, i);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2483toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m2516setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long j) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m2683toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m2520setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int i) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m2886equalsimpl0(i, PaintingStyle.INSTANCE.m2891getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if (style != null && WhenMappings.$EnumSwitchMapping$0[style.ordinal()] == 1) {
            return PaintingStyle.INSTANCE.m2891getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m2890getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m2977getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m2975getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m2518setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int i) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2977getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2976getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2975getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m2985getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m2519setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int i) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m2981equalsimpl0(i, StrokeJoin.INSTANCE.m2986getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m2981equalsimpl0(i, StrokeJoin.INSTANCE.m2985getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m2981equalsimpl0(i, StrokeJoin.INSTANCE.m2987getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        ...
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m2727getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m2725getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m2517setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int i) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m2720equalsimpl0(i, FilterQuality.INSTANCE.m2727getNonefv9h1I()));
    }
