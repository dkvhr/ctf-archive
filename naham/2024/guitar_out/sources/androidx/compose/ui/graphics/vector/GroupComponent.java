...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m2854constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m2863resetimpl(fArr);
        }
        Matrix.m2874translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2866rotateZimpl(fArr, this.rotation);
        Matrix.m2867scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2874translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo3105transform58bKbWc((fArr != null ? Matrix.m2852boximpl(fArr) : null).m2875unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.m3222clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
