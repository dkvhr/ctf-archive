...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m3041connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m3055getPerceptualuksYyKA();
        }
        return m3040connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m3040connectYBCOT_4(ColorSpace connect, ColorSpace destination, int i) {
        ...
        if (connect == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m3050equalsimpl0(i, RenderIntent.INSTANCE.m3055getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m3050equalsimpl0(i, RenderIntent.INSTANCE.m3055getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3029equalsimpl0(connect.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw()) && ColorModel.m3029equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (!ColorModel.m3029equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw())) {
            return colorSpace;
        }
