...
public final class VertexMode {
    ...
    private static final int Triangles = m3015constructorimpl(0);
    private static final int TriangleStrip = m3015constructorimpl(1);
    private static final int TriangleFan = m3015constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m3014boximpl(int i) {
    ...
    public static String m3019toStringimpl(int i) {
        return m3017equalsimpl0(i, Triangles) ? "Triangles" : m3017equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m3017equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
