...
public abstract class Painter {
    ...
    public abstract long mo3241getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3246drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m3247drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m3247drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float m2459getWidthimpl = Size.m2459getWidthimpl(draw.mo3172getSizeNHjbRc()) - Size.m2459getWidthimpl(j);
        float m2456getHeightimpl = Size.m2456getHeightimpl(draw.mo3172getSizeNHjbRc()) - Size.m2456getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, m2459getWidthimpl, m2456getHeightimpl);
        if (f > 0.0f && Size.m2459getWidthimpl(j) > 0.0f && Size.m2456getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m2430Recttz77jQw = RectKt.m2430Recttz77jQw(Offset.INSTANCE.m2406getZeroF1C5BW0(), SizeKt.Size(Size.m2459getWidthimpl(j), Size.m2456getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m2430Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
