...
public final class PathFillType {
    ...
    private static final int NonZero = m2899constructorimpl(0);
    private static final int EvenOdd = m2899constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m2898boximpl(int i) {
        return new PathFillType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2899constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2900equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m2900equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2902hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2906getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m2905getEvenOddRgk1Os() {
    ...
    public static String m2903toStringimpl(int i) {
        return m2901equalsimpl0(i, NonZero) ? "NonZero" : m2901equalsimpl0(i, EvenOdd) ? "EvenOdd" : "Unknown";
    }
}
