...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m5038getZeroYbymL2g();
    ...
    public final void m3248drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5033getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m5032getHeightimpl(size) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2851ImageBitmapx__hDU$default(IntSize.m5033getWidthimpl(size), IntSize.m5032getHeightimpl(size), 0, false, null, 28, null);
        ...
        long m5043toSizeozmzZPI = IntSizeKt.m5043toSizeozmzZPI(size);
        ...
        drawParams2.m3096setSizeuvyYCjk(m5043toSizeozmzZPI);
        canvas.save();
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m3156drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m3167drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m2655getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m2546getClear0nO6VwU(), 62, null);
    }
}
