...
public final class SolidColor extends Brush {
    ...
    public void mo2576applyToPq9zytI(long size, Paint p, float alpha) {
        long m2628copywmQWz5c$default;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (alpha == 1.0f) {
            m2628copywmQWz5c$default = this.value;
        } else {
            long j = this.value;
            m2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(j, Color.m2631getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        }
        p.mo2510setColor8_81llA(m2628copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m2630equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m2637toStringimpl(this.value)) + ')';
    }
}
