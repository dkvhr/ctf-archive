...
public class Connector {
    ...
    private Connector(ColorSpace source, ColorSpace destination, int i) {
        this(source, destination, ColorModel.m3029equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(source, Illuminant.INSTANCE.getD50(), null, 2, null) : source, ColorModel.m3029equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(destination, Illuminant.INSTANCE.getD50(), null, 2, null) : destination, i, INSTANCE.m3045computeTransformYBCOT_4(source, destination, i), null);
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(destination, "destination");
    }
    ...
    public long mo3043transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        return this.transformDestination.mo3039xyzaToColorJlNiLsg$ui_graphics_release(f2, f, z$ui_graphics_release, a, this.destination);
    }
        ...
        */
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r10, androidx.compose.ui.graphics.colorspace.Rgb r11, int r12) {
            /*
                ...
                r9.mSource = r10
                r9.mDestination = r11
                float[] r10 = r9.m3046computeTransformYBCOT_4(r10, r11, r12)
                r9.mTransform = r10
                return
            */
        ...
        private final float[] m3046computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m3050equalsimpl0(intent, RenderIntent.INSTANCE.m3054getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m3045computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m3050equalsimpl0(intent, RenderIntent.INSTANCE.m3054getAbsoluteuksYyKA())) {
                return null;
            }
            boolean m3029equalsimpl0 = ColorModel.m3029equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw());
            boolean m3029equalsimpl02 = ColorModel.m3029equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw());
            if (m3029equalsimpl0 && m3029equalsimpl02) {
                return null;
            }
            if (!m3029equalsimpl0 && !m3029equalsimpl02) {
                return null;
            ...
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = m3029equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = m3029equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            Intrinsics.checkNotNullParameter(source, "source");
            final int m3056getRelativeuksYyKA = RenderIntent.INSTANCE.m3056getRelativeuksYyKA();
            return new Connector(source, m3056getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(source, source, m3056getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.INSTANCE.m3055getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.INSTANCE.m3055getPerceptualuksYyKA(), defaultConstructorMarker);
    }
}
