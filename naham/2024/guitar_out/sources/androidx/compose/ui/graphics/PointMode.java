...
public final class PointMode {
    ...
    private static final int Points = m2921constructorimpl(0);
    private static final int Lines = m2921constructorimpl(1);
    private static final int Polygon = m2921constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointMode m2920boximpl(int i) {
        return new PointMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2921constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2922equalsimpl(int i, Object obj) {
        return (obj instanceof PointMode) && i == ((PointMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2923equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2924hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2928getPointsr_lszbg() {
            return PointMode.Points;
        }

        /* renamed from: getLines-r_lszbg, reason: not valid java name */
        public final int m2927getLinesr_lszbg() {
            return PointMode.Lines;
        }

        /* renamed from: getPolygon-r_lszbg, reason: not valid java name */
        public final int m2929getPolygonr_lszbg() {
    ...
    public static String m2925toStringimpl(int i) {
        return m2923equalsimpl0(i, Points) ? "Points" : m2923equalsimpl0(i, Lines) ? "Lines" : m2923equalsimpl0(i, Polygon) ? "Polygon" : "Unknown";
    }
}
