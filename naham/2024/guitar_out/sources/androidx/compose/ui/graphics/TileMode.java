...
public final class TileMode {
    ...
    private static final int Clamp = m2989constructorimpl(0);
    private static final int Repeated = m2989constructorimpl(1);
    private static final int Mirror = m2989constructorimpl(2);
    private static final int Decal = m2989constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TileMode m2988boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2995getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0, reason: not valid java name */
        public final int m2998getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0, reason: not valid java name */
        public final int m2997getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0, reason: not valid java name */
        public final int m2996getDecal3opZhB0() {
    ...
    public static String m2993toStringimpl(int i) {
        return m2991equalsimpl0(i, Clamp) ? "Clamp" : m2991equalsimpl0(i, Repeated) ? "Repeated" : m2991equalsimpl0(i, Mirror) ? "Mirror" : m2991equalsimpl0(i, Decal) ? "Decal" : "Unknown";
    }
}
