...
public final class Shadow {
    ...
    public static /* synthetic */ void m2944getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m2945getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m2406getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2630equalsimpl0(this.color, shadow.color) && Offset.m2387equalsimpl0(this.offset, shadow.offset) && this.blurRadius == shadow.blurRadius;
    }

    public int hashCode() {
        return (((Color.m2636hashCodeimpl(this.color) * 31) + Offset.m2392hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m2637toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m2398toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default, reason: not valid java name */
    public static /* synthetic */ Shadow m2943copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m2946copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m2946copyqcb84PM(long color, long offset, float blurRadius) {
