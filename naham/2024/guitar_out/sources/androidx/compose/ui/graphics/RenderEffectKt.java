...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m2931BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m2995getClamp3opZhB0();
        }
        return m2930BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs, reason: not valid java name */
    public static final BlurEffect m2930BlurEffect3YTHUZs(float f, float f2, int i) {
