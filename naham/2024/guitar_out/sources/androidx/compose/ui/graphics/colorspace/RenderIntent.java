...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3048constructorimpl(0);
    private static final int Relative = m3048constructorimpl(1);
    private static final int Saturation = m3048constructorimpl(2);
    private static final int Absolute = m3048constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3047boximpl(int i) {
        return new RenderIntent(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3048constructorimpl(int i) {
        return i;
    }
    ...
    public static String m3052toStringimpl(int i) {
        return m3050equalsimpl0(i, Perceptual) ? "Perceptual" : m3050equalsimpl0(i, Relative) ? "Relative" : m3050equalsimpl0(i, Saturation) ? "Saturation" : m3050equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}
