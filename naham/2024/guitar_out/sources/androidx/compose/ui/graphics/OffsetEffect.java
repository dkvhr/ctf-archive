...
public final class OffsetEffect extends RenderEffect {
    ...
    protected android.graphics.RenderEffect getAndroidRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m2933createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.renderEffect, offsetEffect.renderEffect) && Offset.m2387equalsimpl0(this.offset, offsetEffect.offset);
    }

    public int hashCode() {
        RenderEffect renderEffect = this.renderEffect;
        return ((renderEffect != null ? renderEffect.hashCode() : 0) * 31) + Offset.m2392hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + ((Object) Offset.m2398toStringimpl(this.offset)) + ')';
    }
}
