...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m3979requireCoordinator64DMado(node, NodeKind.m4081constructorimpl(8)));
        }
        return DelegatableNodeKt.m3979requireCoordinator64DMado(node, NodeKind.m4081constructorimpl(8)).touchBoundsInRoot();
    }
}
