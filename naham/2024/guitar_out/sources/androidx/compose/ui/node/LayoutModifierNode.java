...
public interface LayoutModifierNode extends DelegatableNode {
    ...
    MeasureResult mo237measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$minIntrinsicWidth$1
            ...
            public final MeasureResult mo3871measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long j) {
                ...
                return LayoutModifierNode.this.mo237measure3p2s80s(minWidth, intrinsicMeasurable, j);
            }
    ...
    default int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$minIntrinsicHeight$1
            ...
            public final MeasureResult mo3871measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long j) {
                ...
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return LayoutModifierNode.this.mo237measure3p2s80s(minHeight, intrinsicMeasurable, j);
            }
        }, intrinsicMeasureScope, measurable, i);
    }
    ...
    default int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicWidth$1
            ...
            public final MeasureResult mo3871measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long j) {
                ...
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return LayoutModifierNode.this.mo237measure3p2s80s(maxWidth, intrinsicMeasurable, j);
            }
        }, intrinsicMeasureScope, measurable, i);
    }
    ...
    default int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicHeight$1
            ...
            public final MeasureResult mo3871measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long j) {
                ...
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return LayoutModifierNode.this.mo237measure3p2s80s(maxHeight, intrinsicMeasurable, j);
            }
        }, intrinsicMeasureScope, measurable, i);
    }
}
