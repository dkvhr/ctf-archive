...
public final class NodeKindKt {
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m4081constructorimpl = NodeKind.m4081constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m4081constructorimpl |= NodeKind.m4081constructorimpl(32768);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? m4081constructorimpl | NodeKind.m4081constructorimpl(131072) : m4081constructorimpl;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m4081constructorimpl | NodeKind.m4081constructorimpl(128) : m4081constructorimpl;
    }
}
