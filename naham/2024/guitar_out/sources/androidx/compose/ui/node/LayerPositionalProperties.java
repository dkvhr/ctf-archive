...
public final class LayerPositionalProperties {
    ...
    public final void copyFrom(GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo2814getTransformOriginSzJe1aQ();
    }

    public final boolean hasSameValuesAs(LayerPositionalProperties other) {
        Intrinsics.checkNotNullParameter(other, "other");
        return this.scaleX == other.scaleX && this.scaleY == other.scaleY && this.translationX == other.translationX && this.translationY == other.translationY && this.rotationX == other.rotationX && this.rotationY == other.rotationY && this.rotationZ == other.rotationZ && this.cameraDistance == other.cameraDistance && TransformOrigin.m3007equalsimpl0(this.transformOrigin, other.transformOrigin);
    }
}
