...
final class CenteredArray {
    ...
    public static int[] m3966constructorimpl(int[] data) {
    ...
    public static final int m3969getimpl(int[] iArr, int i) {
        return iArr[i + m3970getMidimpl(iArr)];
    }

    /* renamed from: set-impl, reason: not valid java name */
    public static final void m3972setimpl(int[] iArr, int i, int i2) {
        iArr[i + m3970getMidimpl(iArr)] = i2;
    }
}
