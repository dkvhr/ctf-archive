...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo3866measureBRTryo0(long constraints) {
            ...
            LookaheadDelegate.m4031access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForLayoutModifierNode, constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m4817boximpl(constraints);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateForLayoutModifierNode, layoutModifierNodeCoordinator.getLayoutModifierNode().mo237measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    /* renamed from: measure-BRTryo0 */
    public Placeable mo3866measureBRTryo0(long constraints) {
        MeasureResult mo237measure3p2s80s;
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            mo237measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m3868intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, IntSize, constraints2.getValue());
        } else {
            mo237measure3p2s80s = layoutModifierNode.mo237measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(mo237measure3p2s80s);
    ...
    public void mo3867placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int m5033getWidthimpl = IntSize.m5033getWidthimpl(getMeasuredSize());
        ...
        Placeable.PlacementScope.parentWidth = m5033getWidthimpl;
    ...
    static {
        ...
        Paint.mo2510setColor8_81llA(Color.INSTANCE.m2656getBlue0d7_KjU());
