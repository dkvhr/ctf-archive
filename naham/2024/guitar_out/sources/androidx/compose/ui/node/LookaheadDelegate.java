...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4034setPositiongyyYBs(long j) {
        this.position = j;
    }

    /* renamed from: access$setMeasurementConstraints-BRTryo0 */
    public static final /* synthetic */ void m4031access$setMeasurementConstraintsBRTryo0(LookaheadDelegate lookaheadDelegate, long j) {
        lookaheadDelegate.m3922setMeasurementConstraintsBRTryo0(j);
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m3921setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m3921setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5038getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo3867placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo3867placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m4990equalsimpl0(getPosition(), position)) {
            m4034setPositiongyyYBs(position);
    ...
    public final Placeable m4032performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4033positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long m5001getZeronOccac = IntOffset.INSTANCE.m5001getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            long position = lookaheadDelegate.getPosition();
            m5001getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(m5001getZeronOccac) + IntOffset.m4991getXimpl(position), IntOffset.m4992getYimpl(m5001getZeronOccac) + IntOffset.m4992getYimpl(position));
