...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo3866measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m3922setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo11measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo3866measureBRTryo0(long constraints) {
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo11measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    public void mo3867placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo3867placeAtf8xVGno(position, zIndex, layerBlock);
    ...
    */
    public void mo4000hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator.HitTestSource r18, long r19, androidx.compose.ui.node.HitTestResult r21, boolean r22, boolean r23) {
        /*
            r17 = this;
            r0 = r17
            r8 = r18
            ...
            r3 = 0
            if (r1 == 0) goto L40
            boolean r1 = r0.m4075withinLayerBoundsk4lQ0M(r9)
            if (r1 == 0) goto L28
            r12 = r23
        L26:
            r3 = r2
        ...
        L28:
            if (r22 == 0) goto L40
            long r4 = r17.m4066getMinimumTouchTargetSizeNHjbRc()
            float r1 = r0.m4063distanceInMinimumTouchTargettz77jQw(r9, r4)
        ...
        L5c:
            ...
            r6 = r22
            r7 = r12
            r1.mo4076childHitTestYqVAtuI(r2, r3, r5, r6, r7)
        ...
        L91:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.mo4000hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, boolean, boolean):void");
    }
    ...
    static {
        ...
        Paint.mo2510setColor8_81llA(Color.INSTANCE.m2663getRed0d7_KjU());
