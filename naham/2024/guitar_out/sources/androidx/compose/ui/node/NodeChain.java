    ...
    */
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        ...
        for (Modifier.Node parent = start.getParent(); parent != null; parent = parent.getParent()) {
            ...
            if (parent == nodeChainKt$SentinelHead$1) {
                ...
                if ((NodeKind.m4081constructorimpl(2) & parent.getKindSet()) != 0) {
                    return;
                }
    ...
    public final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((NodeKind.m4081constructorimpl(2) & child.getKindSet()) != 0) {
    ...
    public final boolean m4044hasH91voCI$ui_release(int type) {
    ...
    public final /* synthetic */ <T> T m4043firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public final /* synthetic */ <T> void m4046headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
    ...
    public final /* synthetic */ <T> void m4048tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
    ...
    public final /* synthetic */ <T> T m4047tailH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
                if ((tail.getKindSet() & type) != 0) {
                    Object obj = (T) tail;
    ...
    public final /* synthetic */ <T> T m4045headH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Object obj = (T) head;
