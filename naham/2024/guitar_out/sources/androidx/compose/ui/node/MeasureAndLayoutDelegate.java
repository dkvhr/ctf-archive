...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4038updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 != null && Constraints.m4822equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        this.rootConstraints = Constraints.m4817boximpl(constraints);
    ...
    private final boolean m4035doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4004lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m4004lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4008lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4004lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4004lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4004lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4004lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m4036doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4005remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m4005remeasure_Sx5XlM$ui_release$default = layoutNode.m4009remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4005remeasure_Sx5XlM$ui_release$default = LayoutNode.m4005remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4005remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4005remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4037measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (!this.duringMeasureLayout) {
            if (this.rootConstraints != null) {
                ...
                try {
                    ...
                    boolean m4035doLookaheadRemeasuresdFAvZA = m4035doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4817boximpl(constraints));
                    m4036doRemeasuresdFAvZA(layoutNode, Constraints.m4817boximpl(constraints));
                    if ((m4035doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        boolean m4035doLookaheadRemeasuresdFAvZA;
        boolean m4036doRemeasuresdFAvZA;
        int i = 0;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            m4035doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) ? m4035doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            m4036doRemeasuresdFAvZA = m4036doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4036doRemeasuresdFAvZA = false;
            m4035doLookaheadRemeasuresdFAvZA = false;
        }
        if ((m4035doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && affectsLookahead) {
            layoutNode.lookaheadReplace$ui_release();
        }
        if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
            if (layoutNode == this.root) {
        ...
        return m4036doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m4035doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m4036doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
