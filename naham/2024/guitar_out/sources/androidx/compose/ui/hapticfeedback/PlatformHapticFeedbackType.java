...
public final class PlatformHapticFeedbackType {
    ...
    private static final int LongPress = HapticFeedbackType.m3280constructorimpl(0);
    private static final int TextHandleMove = HapticFeedbackType.m3280constructorimpl(9);

    /* renamed from: getLongPress-5zf0vsI, reason: not valid java name */
    public final int m3288getLongPress5zf0vsI() {
        return LongPress;
    }

    /* renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
    public final int m3289getTextHandleMove5zf0vsI() {
