    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!this.$consumed) {
                ...
                this.label = 1;
                if (nestedScrollDispatcher2.m3633dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m5109getZero9UxMQ8M(), this.$viewVelocity, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                nestedScrollDispatcher = this.this$0.dispatcher;
                this.label = 2;
                if (nestedScrollDispatcher.m3633dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m5109getZero9UxMQ8M(), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
