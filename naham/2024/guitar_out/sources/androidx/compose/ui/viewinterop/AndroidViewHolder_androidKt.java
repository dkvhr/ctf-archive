...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int roundToInt = MathKt.roundToInt(Offset.m2390getXimpl(positionInRoot));
        int roundToInt2 = MathKt.roundToInt(Offset.m2391getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.INSTANCE.m3645getDragWNlRxjI();
        }
        return NestedScrollSource.INSTANCE.m3646getFlingWNlRxjI();
    }
}
