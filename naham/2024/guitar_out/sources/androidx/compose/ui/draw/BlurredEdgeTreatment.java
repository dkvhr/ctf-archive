...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m2287constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m2287constructorimpl(null);
    private final Shape shape;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ BlurredEdgeTreatment m2286boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Shape m2287constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2288equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m2292unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2289equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2290hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m2291toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m2288equalsimpl(this.shape, obj);
    }
    ...
    public int hashCode() {
        return m2290hashCodeimpl(this.shape);
    }

    public String toString() {
        return m2291toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Shape m2292unboximpl() {
        return this.shape;
    }
