    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m2379boximpl(OffsetKt.Offset(Math.abs(Offset.m2390getXimpl(semanticsNode4.getBoundsInRoot().m2420getCenterF1C5BW0()) - Offset.m2390getXimpl(semanticsNode3.getBoundsInRoot().m2420getCenterF1C5BW0())), Math.abs(Offset.m2391getYimpl(semanticsNode4.getBoundsInRoot().m2420getCenterF1C5BW0()) - Offset.m2391getYimpl(semanticsNode3.getBoundsInRoot().m2420getCenterF1C5BW0())))));
        ...
        if (emptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m2379boximpl(Offset.m2395plusMKHz9U(((Offset) first).getPackedValue(), ((Offset) emptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m2381component2impl(packedValue) < Offset.m2380component1impl(packedValue);
    }
