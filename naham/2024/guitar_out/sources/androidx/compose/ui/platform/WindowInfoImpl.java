...
public final class WindowInfoImpl implements WindowInfo {
    ...
    public static /* synthetic */ void m4227getKeyboardModifiersk7X9c1A$annotations() {
    }
    ...
    public int mo4226getKeyboardModifiersk7X9c1A() {
        return GlobalKeyboardModifiers.getValue().getPackedValue();
    }

    /* renamed from: setKeyboardModifiers-5xRPYO0, reason: not valid java name */
    public void m4228setKeyboardModifiers5xRPYO0(int i) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m3809boximpl(i));
    }
    ...
    static {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m3809boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
