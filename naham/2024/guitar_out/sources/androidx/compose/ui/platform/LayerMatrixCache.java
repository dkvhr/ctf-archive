...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4198calculateMatrixGrdbGEg(T target) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m2854constructorimpl$default(null, 1, null);
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m2502setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m4197calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4195invertToJiSxe2E(m4198calculateMatrixGrdbGEg(target), fArr);
