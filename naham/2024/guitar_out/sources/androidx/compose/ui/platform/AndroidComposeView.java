...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
        ...
        Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m4161invokeZmokQxo(keyEvent.m3604unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m4161invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection mo4135getFocusDirectionP8AzH3I = AndroidComposeView.this.mo4135getFocusDirectionP8AzH3I(it);
                if (mo4135getFocusDirectionP8AzH3I == null || !KeyEventType.m3608equalsimpl0(KeyEvent_androidKt.m3616getTypeZmokQxo(it), KeyEventType.INSTANCE.m3612getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(AndroidComposeView.this.getFocusOwner().mo2327moveFocus3ESFkO8(mo4135getFocusDirectionP8AzH3I.getValue()));
            }
        });
        ...
        this.viewToWindowMatrix = Matrix.m2854constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m2854constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m2404getInfiniteF1C5BW0();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m3298getTouchaOaMEAU() : InputMode.INSTANCE.m3297getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m4160invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m4160invokeiuPiT84(int i) {
                boolean requestFocusFromTouch;
                if (InputMode.m3293equalsimpl0(i, InputMode.INSTANCE.m3298getTouchaOaMEAU())) {
                    requestFocusFromTouch = AndroidComposeView.this.isInTouchMode();
                } else {
                    requestFocusFromTouch = InputMode.m3293equalsimpl0(i, InputMode.INSTANCE.m3297getKeyboardaOaMEAU()) ? AndroidComposeView.this.isInTouchMode() ? AndroidComposeView.this.requestFocusFromTouch() : true : false;
                }
    ...
    public static final void touchModeChangeListener$lambda$3(AndroidComposeView this$0, boolean z) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0._inputModeManager.m3301setInputModeiuPiT84(z ? InputMode.INSTANCE.m3298getTouchaOaMEAU() : InputMode.INSTANCE.m3297getKeyboardaOaMEAU());
    }
    ...
    public static final void sendHoverExitEvent$lambda$5(AndroidComposeView this$0) {
        ...
        this$0.m4159sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public boolean mo4137sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return getFocusOwner().mo2328dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || getFocusOwner().mo2329dispatchKeyEventZmokQxo(keyEvent);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (isFocused()) {
            this._windowInfo.m4228setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m3810constructorimpl(event.getMetaState()));
            return getFocusOwner().mo2329dispatchKeyEventZmokQxo(KeyEvent.m3599constructorimpl(event)) || super.dispatchKeyEvent(event);
        }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return (isFocused() && getFocusOwner().mo2328dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m3599constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
                    ...
                    androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1 r0 = new kotlin.jvm.functions.Function1<androidx.compose.ui.node.LayoutNode, java.lang.Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$addAndroidView$1$onInitializeAccessibilityNodeInfo$parentId$1
                        ...
                        public final java.lang.Boolean invoke(androidx.compose.ui.node.LayoutNode r2) {
                            /*
                                ...
                                boolean r2 = r2.m4044hasH91voCI$ui_release(r0)
    ...
    private final int m4154component1VKZWuLQ(long j) {
        return (int) ULong.m5335constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m4155component2VKZWuLQ(long j) {
        return (int) ULong.m5335constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m4158packZIaKswc(int a, int b) {
        return ULong.m5335constructorimpl(ULong.m5335constructorimpl(b) | ULong.m5335constructorimpl(ULong.m5335constructorimpl(a) << 32));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m4156convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m4158packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m4158packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m4158packZIaKswc(size, size);
        }
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int m4983component1impl = IntOffset.m4983component1impl(j);
        int m4984component2impl = IntOffset.m4984component2impl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (m4983component1impl != i || m4984component2impl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (m4983component1impl != Integer.MAX_VALUE && m4984component2impl != Integer.MAX_VALUE) {
    ...
    public FocusDirection mo4135getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long m3615getKeyZmokQxo = KeyEvent_androidKt.m3615getKeyZmokQxo(keyEvent);
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3543getTabEK5gGoQ())) {
            return FocusDirection.m2306boximpl(KeyEvent_androidKt.m3621isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m2324getPreviousdhqQ8s() : FocusDirection.INSTANCE.m2322getNextdhqQ8s());
        }
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3384getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2325getRightdhqQ8s());
        }
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3383getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2321getLeftdhqQ8s());
        }
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3385getDirectionUpEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2326getUpdhqQ8s());
        }
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3380getDirectionDownEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2317getDowndhqQ8s());
        }
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3379getDirectionCenterEK5gGoQ()) || Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3393getEnterEK5gGoQ()) || Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3485getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2318getEnterdhqQ8s());
        }
        if (Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3322getBackEK5gGoQ()) || Key.m3307equalsimpl0(m3615getKeyZmokQxo, Key.INSTANCE.m3396getEscapeEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2319getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m3301setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m3298getTouchaOaMEAU() : InputMode.INSTANCE.m3297getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == 8) {
            ...
            return ProcessResult.m3835getDispatchedToAPointerInputModifierimpl(m4157handleMotionEvent8iAsVTc(event));
        }
        return super.dispatchGenericMotionEvent(event);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int m4157handleMotionEvent8iAsVTc = m4157handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m3834getAnyMovementConsumedimpl(m4157handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m3835getDispatchedToAPointerInputModifierimpl(m4157handleMotionEvent8iAsVTc);
    }
    ...
    private final int m4157handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                ...
                return m4159sendMotionEvent8iAsVTc(motionEvent);
            } finally {
                Trace.endSection();
            }
        } finally {
    ...
    private final int m4159sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m4228setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m3810constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (convertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m3762getPositionF1C5BW0();
            }
            int m3767processBIzXfog = this.pointerInputEventProcessor.m3767processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked != 0 && actionMasked != 5) || ProcessResult.m3835getDispatchedToAPointerInputModifierimpl(m3767processBIzXfog)) {
                return m3767processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i4 < pointerCount) {
            ...
            long mo3828localToScreenMKHz9U = mo3828localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m2390getXimpl(mo3828localToScreenMKHz9U);
            pointerCoords.y = Offset.m2391getYimpl(mo3828localToScreenMKHz9U);
            i4++;
        }
        ...
        this.pointerInputEventProcessor.m3767processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.accessibilityDelegate.m4164canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.accessibilityDelegate.m4164canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo3828localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long m2860mapMKHz9U = Matrix.m2860mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m2390getXimpl(m2860mapMKHz9U) + Offset.m2390getXimpl(this.windowPosition), Offset.m2391getYimpl(m2860mapMKHz9U) + Offset.m2391getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo3829screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        return Matrix.m2860mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(Offset.m2390getXimpl(positionOnScreen) - Offset.m2390getXimpl(this.windowPosition), Offset.m2391getYimpl(positionOnScreen) - Offset.m2391getYimpl(this.windowPosition)));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long m2860mapMKHz9U = Matrix.m2860mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m2390getXimpl(m2860mapMKHz9U), motionEvent.getRawY() - Offset.m2391getYimpl(m2860mapMKHz9U));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo4171calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m4195invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public long mo4133calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m2860mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo4134calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m2860mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    */
    ...
    public void mo4136measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m4037measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0058, code lost:
        ...
        if (androidx.compose.ui.unit.Constraints.m4822equalsimpl0(r0.getValue(), r8) == false) goto L13;
     */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    protected void onMeasure(int r8, int r9) {
        ...
        L12:
            long r0 = r7.m4156convertMeasureSpecI7RO_PI(r8)     // Catch: java.lang.Throwable -> La5
            r8 = 32
            long r2 = r0 >>> r8
            long r2 = kotlin.ULong.m5335constructorimpl(r2)     // Catch: java.lang.Throwable -> La5
            int r2 = (int) r2     // Catch: java.lang.Throwable -> La5
            r3 = 4294967295(0xffffffff, double:2.1219957905E-314)
            long r0 = r0 & r3
            long r0 = kotlin.ULong.m5335constructorimpl(r0)     // Catch: java.lang.Throwable -> La5
            int r0 = (int) r0     // Catch: java.lang.Throwable -> La5
            long r5 = r7.m4156convertMeasureSpecI7RO_PI(r9)     // Catch: java.lang.Throwable -> La5
            long r8 = r5 >>> r8
            long r8 = kotlin.ULong.m5335constructorimpl(r8)     // Catch: java.lang.Throwable -> La5
            int r8 = (int) r8     // Catch: java.lang.Throwable -> La5
            long r3 = r3 & r5
            long r3 = kotlin.ULong.m5335constructorimpl(r3)     // Catch: java.lang.Throwable -> La5
            ...
            if (r0 != 0) goto L4d
            androidx.compose.ui.unit.Constraints r0 = androidx.compose.ui.unit.Constraints.m4817boximpl(r8)     // Catch: java.lang.Throwable -> La5
        ...
        L50:
            ...
            boolean r0 = androidx.compose.ui.unit.Constraints.m4822equalsimpl0(r0, r8)     // Catch: java.lang.Throwable -> La5
            if (r0 != 0) goto L5d
        L5a:
            r0 = 1
            r7.wasMeasuredWithMultipleConstraints = r0     // Catch: java.lang.Throwable -> La5
        L5d:
            ...
            r0.m4038updateRootConstraintsBRTryo0(r8)     // Catch: java.lang.Throwable -> La5
