...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m4209setFontSizeR2X_6o(m4181decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m4210setFontStylemLjRB2g(FontStyle.m4497boximpl(m4179decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m4206setBackground8_81llA(m4178decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m4207setBaselineShift_isdbwI(BaselineShift.m4660boximpl(m4176decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m4212setLetterSpacingR2X_6o(m4181decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m4211setFontSynthesistDdu0R4(FontSynthesis.m4506boximpl(m4180decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m4208setColor8_81llA(m4178decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m4178decodeColor0d7_KjU() {
        return Color.m2625constructorimpl(m4177decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m4181decodeTextUnitXSAIIZE() {
        long m5088getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m5088getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5087getSpUIouoOA();
        } else if (decodeByte == 2) {
            m5088getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5086getEmUIouoOA();
        } else {
            m5088getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5088getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5082equalsimpl0(m5088getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m5088getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m5065getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5066TextUnitanM5pPY(decodeFloat(), m5088getUnspecifiedUIouoOA);
    }
    ...
    public final int m4179decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.INSTANCE.m4505getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.INSTANCE.m4504getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m4505getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m4180decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.INSTANCE.m4516getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.INSTANCE.m4515getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.INSTANCE.m4517getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.INSTANCE.m4518getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m4516getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m4176decodeBaselineShifty9eOQZs() {
        return BaselineShift.m4661constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4178decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m4177decodeULongsVKNKU() {
        return ULong.m5335constructorimpl(this.parcel.readLong());
    }
