...
public final class AndroidComposeViewAccessibilityDelegateCompat_androidKt {
    ...
    public static final /* synthetic */ String m4166access$toLegacyClassNameV4PA4sw(int i) {
        return m4167toLegacyClassNameV4PA4sw(i);
    }
    ...
    public static final String m4167toLegacyClassNameV4PA4sw(int i) {
        if (Role.m4242equalsimpl0(i, Role.INSTANCE.m4246getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m4242equalsimpl0(i, Role.INSTANCE.m4247getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m4242equalsimpl0(i, Role.INSTANCE.m4250getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m4242equalsimpl0(i, Role.INSTANCE.m4249getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m4242equalsimpl0(i, Role.INSTANCE.m4248getDropdownListo7Vup1c())) {
