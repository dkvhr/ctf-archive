...
public final /* data */ class DeviceRenderNodeData {
    ...
    public final int m4187getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.m2711hashCodeimpl(this.compositingStrategy);
    }
    ...
    public final void m4188setCompositingStrategyaDBOjCE(int i) {
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append((Object) CompositingStrategy.m2712toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
