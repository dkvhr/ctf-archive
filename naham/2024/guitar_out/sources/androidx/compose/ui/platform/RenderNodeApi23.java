...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m2714getAutoNrFUSI();
    ...
    public void mo4183setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m2710equalsimpl0(i, CompositingStrategy.INSTANCE.m2716getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2710equalsimpl0(i, CompositingStrategy.INSTANCE.m2715getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2710equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m2716getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m2600clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
