...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m4657toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m4656toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m4657toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m2981equalsimpl0(i, StrokeJoin.INSTANCE.m2986getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m2981equalsimpl0(i, StrokeJoin.INSTANCE.m2987getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m2981equalsimpl0(i, StrokeJoin.INSTANCE.m2985getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m4656toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2975getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2976getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2977getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
