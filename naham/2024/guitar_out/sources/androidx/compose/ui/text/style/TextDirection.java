...
public final class TextDirection {
    ...
    private static final int Ltr = m4774constructorimpl(1);
    private static final int Rtl = m4774constructorimpl(2);
    private static final int Content = m4774constructorimpl(3);
    private static final int ContentOrLtr = m4774constructorimpl(4);
    private static final int ContentOrRtl = m4774constructorimpl(5);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextDirection m4773boximpl(int i) {
    ...
    public static String m4778toStringimpl(int i) {
        return m4776equalsimpl0(i, Ltr) ? "Ltr" : m4776equalsimpl0(i, Rtl) ? "Rtl" : m4776equalsimpl0(i, Content) ? "Content" : m4776equalsimpl0(i, ContentOrLtr) ? "ContentOrLtr" : m4776equalsimpl0(i, ContentOrRtl) ? "ContentOrRtl" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4783getLtrs_7Xco() {
            return TextDirection.Ltr;
        }

        /* renamed from: getRtl-s_7X-co, reason: not valid java name */
        public final int m4784getRtls_7Xco() {
            return TextDirection.Rtl;
        }

        /* renamed from: getContent-s_7X-co, reason: not valid java name */
        public final int m4780getContents_7Xco() {
            return TextDirection.Content;
        }

        /* renamed from: getContentOrLtr-s_7X-co, reason: not valid java name */
        public final int m4781getContentOrLtrs_7Xco() {
            return TextDirection.ContentOrLtr;
        }

        /* renamed from: getContentOrRtl-s_7X-co, reason: not valid java name */
        public final int m4782getContentOrRtls_7Xco() {
