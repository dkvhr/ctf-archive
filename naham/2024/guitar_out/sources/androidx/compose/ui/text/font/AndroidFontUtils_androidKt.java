...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4454getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m4500equalsimpl0(i, FontStyle.INSTANCE.m4504getItalic_LCdwA()));
    }
}
