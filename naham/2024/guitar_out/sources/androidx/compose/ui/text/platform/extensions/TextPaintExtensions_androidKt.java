...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, Density density, boolean z) {
        ...
        long m5053getTypeUIouoOA = TextUnit.m5053getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m5082equalsimpl0(m5053getTypeUIouoOA, TextUnitType.INSTANCE.m5087getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo324toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m5082equalsimpl0(m5053getTypeUIouoOA, TextUnitType.INSTANCE.m5086getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m5054getValueimpl(style.getFontSize()));
        }
        if (hasFontAttributes(style)) {
            ...
            androidTextPaint.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, m4497boximpl, FontSynthesis.m4506boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4515getAllGVVA2EU())));
        }
        ...
        androidTextPaint.m4641setColor8_81llA(style.m4363getColor0d7_KjU());
        androidTextPaint.m4640setBrush12SF9DM(style.getBrush(), Size.INSTANCE.m2467getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m5082equalsimpl0(TextUnit.m5053getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5087getSpUIouoOA()) && TextUnit.m5054getValueimpl(style.getLetterSpacing()) != 0.0f) {
            float textSize = androidTextPaint.getTextSize() * androidTextPaint.getTextScaleX();
            float mo324toPxR2X_6o = density.mo324toPxR2X_6o(style.getLetterSpacing());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(mo324toPxR2X_6o / textSize);
            }
        } else if (TextUnitType.m5082equalsimpl0(TextUnit.m5053getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5086getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m5054getValueimpl(style.getLetterSpacing()));
        }
        return m4655generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), z, style.getBackground(), style.getBaselineShift());
    }

    /* JADX WARN: Code restructure failed: missing block: B:15:0x004e, code lost:
    
        if (androidx.compose.ui.text.style.BaselineShift.m4663equalsimpl0(r36.m4666unboximpl(), androidx.compose.ui.text.style.BaselineShift.INSTANCE.m4670getNoney9eOQZs()) == false) goto L22;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m4655generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L22
            long r4 = androidx.compose.ui.unit.TextUnit.m5053getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m5087getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m5082equalsimpl0(r4, r6)
            if (r4 == 0) goto L22
            float r4 = androidx.compose.ui.unit.TextUnit.m5054getValueimpl(r31)
            r5 = 0
        ...
        L23:
            ...
            long r5 = r5.m2665getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m2630equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m2664getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m2630equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            r5 = r2
            goto L3e
        ...
        L3e:
            ...
            float r6 = r6.m4670getNoney9eOQZs()
            float r7 = r36.m4666unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m4663equalsimpl0(r7, r6)
            if (r6 != 0) goto L51
            goto L52
        L51:
            r2 = r3
        ...
        L5f:
            ...
            long r6 = r4.m5065getUnspecifiedXSAIIZE()
            r18 = r6
        L67:
            if (r5 == 0) goto L6a
            goto L70
        L6a:
            ...
            long r0 = r0.m2665getUnspecified0d7_KjU()
        L70:
            r23 = r0
            if (r2 == 0) goto L77
            r20 = r36
        ...
        L9b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m4655generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint androidTextPaint, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m4797equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m4802getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m4797equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m4801getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (TextMotion.Linearity.m4797equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m4803getNone4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
        } else {
            androidTextPaint.getFlags();
