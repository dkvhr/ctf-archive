...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m4438boximpl(long j) {
        return new VerticalPaddings(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4439constructorimpl(long j) {
        return j;
    }
    ...
    public static final int m4442getBottomPaddingimpl(long j) {
        return (int) (j & 4294967295L);
    }

    /* renamed from: getTopPadding-impl, reason: not valid java name */
    public static final int m4443getTopPaddingimpl(long j) {
        return (int) (j >> 32);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4444hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4445toStringimpl(long j) {
        return "VerticalPaddings(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m4440equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4444hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4445toStringimpl(this.packedValue);
    }
