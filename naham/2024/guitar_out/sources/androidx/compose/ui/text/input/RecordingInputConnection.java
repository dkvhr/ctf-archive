...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int m4402getMinimpl = composition != null ? TextRange.m4402getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m4402getMinimpl(state.getSelection()), TextRange.m4401getMaximpl(state.getSelection()), m4402getMinimpl, composition2 != null ? TextRange.m4401getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4398getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (editorAction == 0) {
            m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4563getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4565getGoeUduSuo();
                    break;
                case 3:
                    m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4569getSearcheUduSuo();
                    break;
                case 4:
                    m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4570getSendeUduSuo();
                    break;
                case 5:
                    m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4566getNexteUduSuo();
                    break;
                case 6:
                    m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4564getDoneeUduSuo();
                    break;
                case 7:
                    m4563getDefaulteUduSuo = ImeAction.INSTANCE.m4568getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo4577onImeActionKlQnJC8(m4563getDefaulteUduSuo);
        return true;
    }

    @Override // android.view.inputmethod.InputConnection
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4402getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
}
