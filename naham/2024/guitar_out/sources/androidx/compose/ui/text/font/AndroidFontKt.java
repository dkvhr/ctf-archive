...
public final class AndroidFontKt {
    ...
    public static /* synthetic */ Font m4453FontMuC2MFs$default(String str, AssetManager assetManager, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 16) != 0) {
            settings = FontVariation.INSTANCE.m4520Settings6EWAqTQ(fontWeight, i, new FontVariation.Setting[0]);
        }
        return m4452FontMuC2MFs(str, assetManager, fontWeight, i, settings);
    }

    /* renamed from: Font-MuC2MFs, reason: not valid java name */
    public static final Font m4452FontMuC2MFs(String path, AssetManager assetManager, FontWeight weight, int i, FontVariation.Settings variationSettings) {
    ...
    public static /* synthetic */ Font m4451FontEj4NQ78$default(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m4449FontEj4NQ78(file, fontWeight, i, settings);
    }

    /* renamed from: Font-Ej4NQ78, reason: not valid java name */
    public static final Font m4449FontEj4NQ78(File file, FontWeight weight, int i, FontVariation.Settings variationSettings) {
    ...
    /* renamed from: Font-Ej4NQ78$default, reason: not valid java name */
    public static /* synthetic */ Font m4450FontEj4NQ78$default(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m4448FontEj4NQ78(parcelFileDescriptor, fontWeight, i, settings);
    }

    /* renamed from: Font-Ej4NQ78, reason: not valid java name */
    public static final Font m4448FontEj4NQ78(ParcelFileDescriptor fileDescriptor, FontWeight weight, int i, FontVariation.Settings variationSettings) {
