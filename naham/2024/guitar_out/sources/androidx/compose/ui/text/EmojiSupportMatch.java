...
public final class EmojiSupportMatch {
    ...
    private static final int Default = m4281constructorimpl(0);
    private static final int None = m4281constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ EmojiSupportMatch m4280boximpl(int i) {
        return new EmojiSupportMatch(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4281constructorimpl(int i) {
        return i;
    }
    ...
    public static String m4285toStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4287getDefault_3YsG6Y() {
            return EmojiSupportMatch.Default;
        }

        /* renamed from: getNone-_3YsG6Y, reason: not valid java name */
        public final int m4288getNone_3YsG6Y() {
