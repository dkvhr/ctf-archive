...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m4801getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m4802getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m4791copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m4792copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m4792copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return Linearity.m4797equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
    }

    public int hashCode() {
        return (Linearity.m4798hashCodeimpl(this.linearity) * 31) + Boolean.hashCode(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m4795constructorimpl(1);
        private static final int FontHinting = m4795constructorimpl(2);
        private static final int None = m4795constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m4794boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m4795constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4796equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4797equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4798hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object obj) {
            return m4796equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m4798hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m4802getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04, reason: not valid java name */
            public final int m4801getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04, reason: not valid java name */
            public final int m4803getNone4e0Vf04() {
        ...
        public String toString() {
            return m4799toStringimpl(this.value);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m4799toStringimpl(int i) {
            return m4797equalsimpl0(i, Linear) ? "Linearity.Linear" : m4797equalsimpl0(i, FontHinting) ? "Linearity.FontHinting" : m4797equalsimpl0(i, None) ? "Linearity.None" : "Invalid";
        }
    }
}
