...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float f) {
        ...
        if (!z && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m4786from8_81llA(ColorKt.m2680lerpjxsXWHM(start.mo4674getColor0d7_KjU(), stop.mo4674getColor0d7_KjU(), f));
        }
        if (z && (stop instanceof BrushStyle)) {
    ...
    public static final long m4785modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m2628copywmQWz5c$default(j, Color.m2631getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
