...
public final class FontLoadingStrategy {
    ...
    private static final int Blocking = m4485constructorimpl(0);
    private static final int OptionalLocal = m4485constructorimpl(1);
    private static final int Async = m4485constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontLoadingStrategy m4484boximpl(int i) {
        return new FontLoadingStrategy(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4485constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4486equalsimpl(int i, Object obj) {
        return (obj instanceof FontLoadingStrategy) && i == ((FontLoadingStrategy) obj).m4490unboximpl();
    }
    ...
    public static String m4489toStringimpl(int i) {
        return m4487equalsimpl0(i, Blocking) ? "Blocking" : m4487equalsimpl0(i, OptionalLocal) ? "Optional" : m4487equalsimpl0(i, Async) ? "Async" : "Invalid(value=" + i + ')';
    }
    ...
    public static final class Companion {
        ...
        public final int m4492getBlockingPKNRLFQ() {
            return FontLoadingStrategy.Blocking;
        }

        /* renamed from: getOptionalLocal-PKNRLFQ, reason: not valid java name */
        public final int m4493getOptionalLocalPKNRLFQ() {
            return FontLoadingStrategy.OptionalLocal;
        }

        /* renamed from: getAsync-PKNRLFQ, reason: not valid java name */
        public final int m4491getAsyncPKNRLFQ() {
