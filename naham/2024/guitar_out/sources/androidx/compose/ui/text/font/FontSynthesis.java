...
public final class FontSynthesis {
    ...
    private static final int None = m4507constructorimpl(0);
    private static final int All = m4507constructorimpl(1);
    private static final int Weight = m4507constructorimpl(2);
    private static final int Style = m4507constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontSynthesis m4506boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m4508equalsimpl(this.value, obj);
    }
    ...
    public static String m4513toStringimpl(int i) {
        return m4509equalsimpl0(i, None) ? "None" : m4509equalsimpl0(i, All) ? "All" : m4509equalsimpl0(i, Weight) ? "Weight" : m4509equalsimpl0(i, Style) ? "Style" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4516getNoneGVVA2EU() {
            return FontSynthesis.None;
        }

        /* renamed from: getAll-GVVA2EU, reason: not valid java name */
        public final int m4515getAllGVVA2EU() {
            return FontSynthesis.All;
        }

        /* renamed from: getWeight-GVVA2EU, reason: not valid java name */
        public final int m4518getWeightGVVA2EU() {
            return FontSynthesis.Weight;
        }

        /* renamed from: getStyle-GVVA2EU, reason: not valid java name */
        public final int m4517getStyleGVVA2EU() {
            return FontSynthesis.Style;
        }
    }

    /* renamed from: isWeightOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m4512isWeightOnimpl$ui_text_release(int i) {
        return m4509equalsimpl0(i, All) || m4509equalsimpl0(i, Weight);
    }

    /* renamed from: isStyleOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m4511isStyleOnimpl$ui_text_release(int i) {
        return m4509equalsimpl0(i, All) || m4509equalsimpl0(i, Style);
    }
}
