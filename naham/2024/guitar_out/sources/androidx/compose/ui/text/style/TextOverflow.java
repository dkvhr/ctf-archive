...
public final class TextOverflow {
    ...
    private static final int Clip = m4805constructorimpl(1);
    private static final int Ellipsis = m4805constructorimpl(2);
    private static final int Visible = m4805constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m4804boximpl(int i) {
        return new TextOverflow(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4805constructorimpl(int i) {
        return i;
    }
    ...
    public static String m4809toStringimpl(int i) {
        return m4807equalsimpl0(i, Clip) ? "Clip" : m4807equalsimpl0(i, Ellipsis) ? "Ellipsis" : m4807equalsimpl0(i, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4811getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m4812getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m4813getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m4814getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8, reason: not valid java name */
        public final int m4815getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8, reason: not valid java name */
        public final int m4816getVisiblegIe3tQ8() {
