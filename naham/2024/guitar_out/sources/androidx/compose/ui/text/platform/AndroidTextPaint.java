...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m2390getXimpl(this.shadow.getOffset()), Offset.m2391getYimpl(this.shadow.getOffset()), ColorKt.m2683toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m4637setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m4640setBrush12SF9DM(brush, j, f);
    }

    /* renamed from: setBrush-12SF9DM, reason: not valid java name */
    public final void m4640setBrush12SF9DM(Brush brush, long size, float alpha) {
        if (((brush instanceof SolidColor) && ((SolidColor) brush).getValue() != Color.INSTANCE.m2665getUnspecified0d7_KjU()) || ((brush instanceof ShaderBrush) && size != Size.INSTANCE.m2467getUnspecifiedNHjbRc())) {
            brush.mo2576applyToPq9zytI(size, this.composePaint, Float.isNaN(alpha) ? this.composePaint.getAlpha() : RangesKt.coerceIn(alpha, 0.0f, 1.0f));
        } else if (brush == null) {
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
            this.composePaint.mo2514setStylek9PVt8s(PaintingStyle.INSTANCE.m2890getFillTiuSbCo());
            return;
        }
        if (drawStyle instanceof Stroke) {
            this.composePaint.mo2514setStylek9PVt8s(PaintingStyle.INSTANCE.m2891getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            this.composePaint.setStrokeWidth(stroke.getWidth());
            this.composePaint.setStrokeMiterLimit(stroke.getMiter());
            this.composePaint.mo2513setStrokeJoinWw9F2mQ(stroke.getJoin());
            this.composePaint.mo2512setStrokeCapBeK7IIE(stroke.getCap());
            this.composePaint.setPathEffect(stroke.getPathEffect());
        }
    }

    /* renamed from: getBlendMode-0nO6VwU, reason: not valid java name */
    public final int m4638getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m4639setBlendModes9anfk8(int i) {
        this.composePaint.mo2509setBlendModes9anfk8(i);
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m4641setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m2665getUnspecified0d7_KjU()) {
            this.composePaint.mo2510setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }
}
