...
public final /* data */ class ParagraphInfo {
    ...
    public final long m4301toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2390getXimpl(j), Offset.m2391getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2427translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2526translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4300toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4404getStartimpl(j)), toGlobalIndex(TextRange.m4399getEndimpl(j)));
    }
}
