...
public final class Placeholder {
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (!(!TextUnitKt.m5072isUnspecifiedR2X_6o(j2))) {
            throw new IllegalArgumentException("height cannot be TextUnit.Unspecified".toString());
        }
    }

    /* renamed from: copy-K8Q-__8$default, reason: not valid java name */
    public static /* synthetic */ Placeholder m4323copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m4324copyK8Q__8(j3, j4, i);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m4324copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m5051equalsimpl0(this.width, placeholder.width) && TextUnit.m5051equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m4331equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m5055hashCodeimpl(this.width) * 31) + TextUnit.m5055hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m4332hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m5061toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m5061toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m4333toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
