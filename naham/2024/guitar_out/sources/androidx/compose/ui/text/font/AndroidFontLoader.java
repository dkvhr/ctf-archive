...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        } else if (FontLoadingStrategy.m4487equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4493getOptionalLocalPKNRLFQ())) {
            try {
                ...
                m5160constructorimpl = Result.m5160constructorimpl(load);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
            }
            typeface = (android.graphics.Typeface) (Result.m5166isFailureimpl(m5160constructorimpl) ? null : m5160constructorimpl);
        } else {
            if (FontLoadingStrategy.m4487equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4491getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4489toStringimpl(font.getLoadingStrategy())));
        }
