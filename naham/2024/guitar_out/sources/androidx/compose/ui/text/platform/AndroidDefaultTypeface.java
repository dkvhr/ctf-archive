...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4626getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m4454getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4500equalsimpl0(fontStyle, FontStyle.INSTANCE.m4504getItalic_LCdwA()));
    }
}
