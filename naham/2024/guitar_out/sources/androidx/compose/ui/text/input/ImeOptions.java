...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m4590getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m4616getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m4563getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ ImeOptions m4571copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m4572copyuxg59PA(z, i5, z3, i6, i3);
    }

    /* renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m4572copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m4581equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m4596equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m4551equalsimpl0(this.imeAction, imeOptions.imeAction);
    }

    public int hashCode() {
        return (((((((Boolean.hashCode(this.singleLine) * 31) + KeyboardCapitalization.m4582hashCodeimpl(this.capitalization)) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4597hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4552hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m4583toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4598toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4553toStringimpl(this.imeAction)) + ')';
    }
}
