...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m4402getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m4401getMaximpl(textFieldValue.getSelection());
