...
public final class TextStyleKt {
    ...
    public static final int m4436resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int m4780getContents_7Xco = TextDirection.INSTANCE.m4780getContents_7Xco();
        if (textDirection != null && TextDirection.m4776equalsimpl0(textDirection.getValue(), m4780getContents_7Xco)) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i == 1) {
                return TextDirection.INSTANCE.m4781getContentOrLtrs_7Xco();
            }
            if (i == 2) {
                return TextDirection.INSTANCE.m4782getContentOrRtls_7Xco();
            }
        ...
        if (textDirection == null) {
            ...
            if (i2 == 1) {
                return TextDirection.INSTANCE.m4783getLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m4784getRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
