...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5032getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5033getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4376getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m4292getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m4378getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m4293getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m4374copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m4375copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c */
    public final TextLayoutResult m4375copyO0kMr_c(TextLayoutInput layoutInput, long size) {
        Intrinsics.checkNotNullParameter(layoutInput, "layoutInput");
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m5031equalsimpl0(this.size, textLayoutResult.size) && this.firstBaseline == textLayoutResult.firstBaseline && this.lastBaseline == textLayoutResult.lastBaseline && Intrinsics.areEqual(this.placeholderRects, textLayoutResult.placeholderRects);
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5034hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m5036toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
