...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m4830getMinHeightimpl(j) != 0 || Constraints.m4831getMinWidthimpl(j) != 0) {
        ...
        int m4269access$toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4269access$toLayoutAlignAMY3VfE(style.m4433getTextAlignbuA522U());
        TextAlign m4433getTextAlignbuA522U = style.m4433getTextAlignbuA522U();
        int i2 = m4433getTextAlignbuA522U == null ? 0 : TextAlign.m4763equalsimpl0(m4433getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m4769getJustifye0LSkKk()) ? 1 : 0;
        int m4271access$toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m4271access$toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak m4431getLineBreakLgCVezo = style.m4431getLineBreakLgCVezo();
        int m4270access$toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m4270access$toLayoutBreakStrategyu6PBz3U(m4431getLineBreakLgCVezo != null ? LineBreak.Strategy.m4704boximpl(LineBreak.m4695getStrategyfcGXIks(m4431getLineBreakLgCVezo.getMask())) : null);
        LineBreak m4431getLineBreakLgCVezo2 = style.m4431getLineBreakLgCVezo();
        int m4272access$toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m4272access$toLayoutLineBreakStyle4a2g8L8(m4431getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4714boximpl(LineBreak.m4696getStrictnessusljTpc(m4431getLineBreakLgCVezo2.getMask())) : null);
        LineBreak m4431getLineBreakLgCVezo3 = style.m4431getLineBreakLgCVezo();
        int m4273access$toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m4273access$toLayoutLineBreakWordStylegvcdTPQ(m4431getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4725boximpl(LineBreak.m4697getWordBreakjp8hJ3c(m4431getLineBreakLgCVezo3.getMask())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout constructTextLayout = constructTextLayout(m4269access$toLayoutAlignAMY3VfE, i2, truncateAt, i, m4271access$toLayoutHyphenationFrequency0_XeFpE, m4270access$toLayoutBreakStrategyu6PBz3U, m4272access$toLayoutLineBreakStyle4a2g8L8, m4273access$toLayoutLineBreakWordStylegvcdTPQ);
        if (!z || constructTextLayout.getHeight() <= Constraints.m4828getMaxHeightimpl(j) || i <= 1) {
            this.layout = constructTextLayout;
        } else {
            int access$numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.access$numberOfLinesThatFitMaxHeight(constructTextLayout, Constraints.m4828getMaxHeightimpl(j));
            if (access$numberOfLinesThatFitMaxHeight >= 0 && access$numberOfLinesThatFitMaxHeight != i) {
                constructTextLayout = constructTextLayout(m4269access$toLayoutAlignAMY3VfE, i2, truncateAt, RangesKt.coerceAtLeast(access$numberOfLinesThatFitMaxHeight, 1), m4271access$toLayoutHyphenationFrequency0_XeFpE, m4270access$toLayoutBreakStrategyu6PBz3U, m4272access$toLayoutLineBreakStyle4a2g8L8, m4273access$toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = constructTextLayout;
        }
        getTextPaint$ui_text_release().m4640setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m4659setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m4829getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4264getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2391getYimpl(position)), Offset.m2390getXimpl(position));
    }
    ...
    public final void m4262fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4402getMinimpl(range), TextRange.m4401getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4265getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4267paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4641setColor8_81llA(color);
    ...
    public void mo4266paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int m4638getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4638getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4641setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4639setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4639setBlendModes9anfk8(m4638getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo4268painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int m4638getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4638getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4640setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4639setBlendModes9anfk8(blendMode);
