...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo4674getColor0d7_KjU() {
            return Color.INSTANCE.m2665getUnspecified0d7_KjU();
        }
    }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m4786from8_81llA(TextDrawStyleKt.m4785modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
        ...
        public final TextForegroundStyle m4786from8_81llA(long color) {
            return color != Color.INSTANCE.m2665getUnspecified0d7_KjU() ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
    }
}
