...
public final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4675copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m4677copy8_81llA(j);
    }
    ...
    public final ColorStyle m4677copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m2630equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public long mo4674getColor0d7_KjU() {
        return this.value;
    }

    /* renamed from: getValue-0d7_KjU, reason: not valid java name */
    public final long m4678getValue0d7_KjU() {
        return this.value;
    }

    public int hashCode() {
        return Color.m2636hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m2637toStringimpl(this.value)) + ')';
    }
    ...
    public float getAlpha() {
        return Color.m2631getAlphaimpl(mo4674getColor0d7_KjU());
    }
}
