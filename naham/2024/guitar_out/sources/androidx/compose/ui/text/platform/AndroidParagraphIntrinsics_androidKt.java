...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m4633resolveTextDirectionHeuristics9GRLPo0$default(TextDirection textDirection, LocaleList localeList, int i, Object obj) {
        if ((i & 1) != 0) {
            textDirection = null;
        }
        if ((i & 2) != 0) {
        ...
        return m4632resolveTextDirectionHeuristics9GRLPo0(textDirection, localeList);
    }
    ...
    */
    public static final int m4632resolveTextDirectionHeuristics9GRLPo0(androidx.compose.ui.text.style.TextDirection r5, androidx.compose.ui.text.intl.LocaleList r6) {
        /*
            if (r5 == 0) goto L7
            int r5 = r5.getValue()
            goto Ld
        L7:
            ...
            int r5 = r5.m4780getContents_7Xco()
        Ld:
            androidx.compose.ui.text.style.TextDirection$Companion r0 = androidx.compose.ui.text.style.TextDirection.INSTANCE
            int r0 = r0.m4781getContentOrLtrs_7Xco()
            boolean r0 = androidx.compose.ui.text.style.TextDirection.m4776equalsimpl0(r5, r0)
            r1 = 2
            if (r0 == 0) goto L1b
            goto L77
        L1b:
            androidx.compose.ui.text.style.TextDirection$Companion r0 = androidx.compose.ui.text.style.TextDirection.INSTANCE
            int r0 = r0.m4782getContentOrRtls_7Xco()
            boolean r0 = androidx.compose.ui.text.style.TextDirection.m4776equalsimpl0(r5, r0)
            r2 = 3
            if (r0 == 0) goto L2a
        L28:
        ...
        L48:
            androidx.compose.ui.text.style.TextDirection$Companion r0 = androidx.compose.ui.text.style.TextDirection.INSTANCE
            int r0 = r0.m4780getContents_7Xco()
            boolean r5 = androidx.compose.ui.text.style.TextDirection.m4776equalsimpl0(r5, r0)
            if (r5 == 0) goto L78
            if (r6 == 0) goto L6b
        ...
        L78:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics_androidKt.m4632resolveTextDirectionHeuristics9GRLPo0(androidx.compose.ui.text.style.TextDirection, androidx.compose.ui.text.intl.LocaleList):int");
    }
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m4280boximpl(paragraphStyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m4283equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m4288getNone_3YsG6Y()));
    }
}
