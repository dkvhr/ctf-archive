...
public final class LayoutNodeSubcompositionsState {
    ...
    public LayoutNodeSubcompositionsState(LayoutNode root, SubcomposeSlotReusePolicy slotReusePolicy) {
        ...
        this.intermediateMeasurePolicy = new Function2<SubcomposeIntermediateMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$intermediateMeasurePolicy$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, Constraints constraints) {
                return m3886invoke0kLqBqw(subcomposeIntermediateMeasureScope, constraints.getValue());
            }

            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
            public final MeasureResult m3886invoke0kLqBqw(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, long j) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                if ((LayoutNodeSubcompositionsState.this.root.getLayoutState$ui_release() != LayoutNode.LayoutState.Measuring && LayoutNodeSubcompositionsState.this.root.getLayoutState$ui_release() != LayoutNode.LayoutState.LayingOut) || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() == null) {
                    ...
                    intermediateMeasureScopeImpl2.m3884setLookaheadConstraintsBRTryo0(j);
                    final MeasureResult invoke = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m4817boximpl(j));
                    ...
                    intermediateMeasureScopeImpl3.m3885setLookaheadSizeozmzZPI(IntSizeKt.IntSize(invoke.getWidth(), invoke.getHeight()));
                ...
                return intermediateMeasurePolicy$ui_release.invoke(intermediateMeasureScopeImpl, Constraints.m4817boximpl(j));
            }
        };
    }
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$1
            ...
            public void mo3887premeasure0kLqBqw(int index, long constraints) {
                Map map2;
                map2 = LayoutNodeSubcompositionsState.this.precomposeMap;
                LayoutNode layoutNode2 = (LayoutNode) map2.get(slotId);
                ...
                if (!layoutNode2.isPlaced()) {
                    ...
                    LayoutNodeKt.requireOwner(layoutNode2).mo4136measureAndLayout0kLqBqw(layoutNode2.getChildren$ui_release().get(index), constraints);
    ...
    public final class IntermediateMeasureScopeImpl implements SubcomposeIntermediateMeasureScope, MeasureScope {
        ...
        public void m3884setLookaheadConstraintsBRTryo0(long j) {
        ...
        public void m3885setLookaheadSizeozmzZPI(long j) {
        ...
        public float mo320toDpGaN1DYA(long j) {
            return this.$$delegate_0.mo320toDpGaN1DYA(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo321toDpu2uoSUM(float f) {
            return this.$$delegate_0.mo321toDpu2uoSUM(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo322toDpu2uoSUM(int i) {
            return this.$$delegate_0.mo322toDpu2uoSUM(i);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDpSize-k-rfVVM */
        public long mo323toDpSizekrfVVM(long j) {
            return this.$$delegate_0.mo323toDpSizekrfVVM(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx--R2X_6o */
        public float mo324toPxR2X_6o(long j) {
            return this.$$delegate_0.mo324toPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx-0680j_4 */
        public float mo325toPx0680j_4(float f) {
            return this.$$delegate_0.mo325toPx0680j_4(f);
        }
        ...
        public long mo326toSizeXkaWNTQ(long j) {
            return this.$$delegate_0.mo326toSizeXkaWNTQ(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-0xMU5do */
        public long mo327toSp0xMU5do(float f) {
            return this.$$delegate_0.mo327toSp0xMU5do(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo328toSpkPz2Gy4(float f) {
            return this.$$delegate_0.mo328toSpkPz2Gy4(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo329toSpkPz2Gy4(int i) {
            return this.$$delegate_0.mo329toSpkPz2Gy4(i);
        }
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (nodeState == null) {
            nodeState = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m3856getLambda1$ui_release(), null, 4, null);
