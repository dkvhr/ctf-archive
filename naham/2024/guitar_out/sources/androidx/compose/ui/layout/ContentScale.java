...
public interface ContentScale {
    ...
    long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3859access$computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3859access$computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3859access$computeFillMaxDimensioniLBOSCw, m3859access$computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3860access$computeFillMinDimensioniLBOSCw = ContentScaleKt.m3860access$computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3860access$computeFillMinDimensioniLBOSCw, m3860access$computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3858access$computeFillHeightiLBOSCw = ContentScaleKt.m3858access$computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3858access$computeFillHeightiLBOSCw, m3858access$computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m3861access$computeFillWidthiLBOSCw = ContentScaleKt.m3861access$computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m3861access$computeFillWidthiLBOSCw, m3861access$computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m2459getWidthimpl(srcSize) <= Size.m2459getWidthimpl(dstSize) && Size.m2456getHeightimpl(srcSize) <= Size.m2456getHeightimpl(dstSize)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3861access$computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m3858access$computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
