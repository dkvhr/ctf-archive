...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.INSTANCE.m5001getZeronOccac();
    ...
    public abstract void mo3867placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredWidth() {
        return IntSize.m5033getWidthimpl(this.measuredSize);
    }

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredHeight() {
        return IntSize.m5032getHeightimpl(this.measuredSize);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: setMeasuredSize-ozmzZPI, reason: not valid java name */
    public final void m3921setMeasuredSizeozmzZPI(long j) {
        if (IntSize.m5031equalsimpl0(this.measuredSize, j)) {
            return;
        }
        this.measuredSize = j;
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m5033getWidthimpl(this.measuredSize), Constraints.m4831getMinWidthimpl(this.measurementConstraints), Constraints.m4829getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m5032getHeightimpl(this.measuredSize), Constraints.m4830getMinHeightimpl(this.measurementConstraints), Constraints.m4828getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m5033getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m5032getHeightimpl(this.measuredSize)) / 2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: setMeasurementConstraints-BRTryo0, reason: not valid java name */
    public final void m3922setMeasurementConstraintsBRTryo0(long j) {
        if (Constraints.m4822equalsimpl0(this.measurementConstraints, j)) {
            return;
        }
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m3924placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3930placeRelative70tqf50(placeable, j, f);
        }
        ...
        public final void placeRelative(Placeable placeable, int i, int i2, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(IntOffset) + IntOffset.m4992getYimpl(j)), f, null);
            } else {
                long IntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m4991getXimpl(IntOffset), IntOffset.m4992getYimpl(IntOffset));
                long j2 = placeable.apparentToRealOffset;
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset2) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(IntOffset2) + IntOffset.m4992getYimpl(j2)), f, null);
            }
        }
        ...
        public static /* synthetic */ void m3923place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3927place70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m3925placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3931placeRelativeWithLayeraW9wM(placeable, j, f2, function1);
        }
        ...
        public final void placeRelativeWithLayer(Placeable placeable, int i, int i2, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j = placeable.apparentToRealOffset;
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(IntOffset) + IntOffset.m4992getYimpl(j)), f, layerBlock);
            } else {
                long IntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m4991getXimpl(IntOffset), IntOffset.m4992getYimpl(IntOffset));
                long j2 = placeable.apparentToRealOffset;
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset2) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(IntOffset2) + IntOffset.m4992getYimpl(j2)), f, layerBlock);
            }
        }
        ...
        public static /* synthetic */ void m3926placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3932placeWithLayeraW9wM(placeable, j, f2, function1);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m3929placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            Intrinsics.checkNotNullParameter(placeAutoMirrored, "$this$placeAutoMirrored");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(j) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j) + IntOffset.m4992getYimpl(j2)), f, function1);
            } else {
                long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j));
                long j3 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset) + IntOffset.m4991getXimpl(j3), IntOffset.m4992getYimpl(IntOffset) + IntOffset.m4992getYimpl(j3)), f, function1);
            }
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m3928placeApparentToRealOffsetaW9wM$ui_release(Placeable placeApparentToRealOffset, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(j) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j) + IntOffset.m4992getYimpl(j2)), f, function1);
        }
        ...
        public final void m3930placeRelative70tqf50(Placeable placeRelative, long j, float f) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelative.apparentToRealOffset;
                placeRelative.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(j) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j) + IntOffset.m4992getYimpl(j2)), f, null);
            } else {
                long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j));
                long j3 = placeRelative.apparentToRealOffset;
                placeRelative.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset) + IntOffset.m4991getXimpl(j3), IntOffset.m4992getYimpl(IntOffset) + IntOffset.m4992getYimpl(j3)), f, null);
            }
        }

        /* renamed from: place-70tqf50, reason: not valid java name */
        public final void m3927place70tqf50(Placeable place, long j, float f) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long j2 = place.apparentToRealOffset;
            place.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(j) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j) + IntOffset.m4992getYimpl(j2)), f, null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m3931placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(j) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j) + IntOffset.m4992getYimpl(j2)), f, layerBlock);
            } else {
                long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j));
                long j3 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(IntOffset) + IntOffset.m4991getXimpl(j3), IntOffset.m4992getYimpl(IntOffset) + IntOffset.m4992getYimpl(j3)), f, layerBlock);
            }
        }

        /* renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m3932placeWithLayeraW9wM(Placeable placeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long j2 = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(j) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(j) + IntOffset.m4992getYimpl(j2)), f, layerBlock);
        }
    }
}
