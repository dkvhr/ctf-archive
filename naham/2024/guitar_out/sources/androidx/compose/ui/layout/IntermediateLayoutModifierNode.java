...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (lookaheadRoot != null && lookaheadRoot.getIsVirtualLookaheadRoot()) {
            ...
            int m4081constructorimpl = NodeKind.m4081constructorimpl(512);
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public final MeasureResult m3868intermediateMeasureTeuZzU(MeasureScope intermediateMeasure, Measurable measurable, long j, long j2, long j3) {
        Intrinsics.checkNotNullParameter(intermediateMeasure, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m3870setLookaheadSizeozmzZPI(j2);
        this.lookaheadConstraints = Constraints.m4817boximpl(j3);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, intermediateMeasurablePlaceable, Constraints.m4817boximpl(j));
    }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo3871measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long j) {
                Intrinsics.checkNotNullParameter(minWidth, "$this$minWidth");
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m4817boximpl(j));
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo3871measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long j) {
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo3871measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long j) {
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo3871measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long j) {
    ...
    public final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo3866measureBRTryo0(long constraints) {
            Placeable mo3866measureBRTryo0;
            long lookaheadSize;
            if (!this.this$0.getIsIntermediateChangeActive()) {
                ...
                mo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(constraints2.getValue());
                ...
                m3922setMeasurementConstraintsBRTryo0(constraints3.getValue());
                if (!intermediateLayoutModifierNode.getIsIntermediateChangeActive()) {
                    ...
                    lookaheadSize = IntSizeKt.IntSize(mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight());
                }
                m3921setMeasuredSizeozmzZPI(lookaheadSize);
            } else {
                mo3866measureBRTryo0 = this.wrappedMeasurable.mo3866measureBRTryo0(constraints);
                m3922setMeasurementConstraintsBRTryo0(constraints);
                m3921setMeasuredSizeozmzZPI(IntSizeKt.IntSize(mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight()));
            }
            this.wrappedPlaceable = mo3866measureBRTryo0;
            return this;
        }
        ...
        public void mo3867placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            if (!this.this$0.getIsIntermediateChangeActive()) {
                position = IntOffset.INSTANCE.m5001getZeronOccac();
            }
            if (layerBlock != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.INSTANCE.m3932placeWithLayeraW9wM(placeable, position, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.INSTANCE.m3927place70tqf50(placeable2, position, zIndex);
    ...
    public final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        private long lookaheadSize = IntSize.INSTANCE.m5038getZeroYbymL2g();
        ...
        public void m3870setLookaheadSizeozmzZPI(long j) {
