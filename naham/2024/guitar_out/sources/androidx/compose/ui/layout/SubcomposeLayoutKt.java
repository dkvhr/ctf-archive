...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState state, Modifier modifier, Function2<? super SubcomposeIntermediateMeasureScope, ? super Constraints, ? extends MeasureResult> function2, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> measurePolicy, Composer composer, final int i, final int i2) {
        ...
        Updater.m2270setimpl(m2263constructorimpl, state, state.getSetRoot$ui_release());
        Updater.m2270setimpl(m2263constructorimpl, rememberCompositionContext, state.getSetCompositionContext$ui_release());
        Updater.m2270setimpl(m2263constructorimpl, measurePolicy, state.getSetMeasurePolicy$ui_release());
        Updater.m2270setimpl(m2263constructorimpl, function22, state.getSetIntermediateMeasurePolicy$ui_release());
