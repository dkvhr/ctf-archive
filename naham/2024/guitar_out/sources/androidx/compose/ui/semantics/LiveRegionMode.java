...
public final class LiveRegionMode {
    ...
    private static final int Polite = m4231constructorimpl(0);
    private static final int Assertive = m4231constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m4230boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4231constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4232equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4233equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4234hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4232equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4234hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4235toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4235toStringimpl(int i) {
        return m4233equalsimpl0(i, Polite) ? "Polite" : m4233equalsimpl0(i, Assertive) ? "Assertive" : "Unknown";
    }
}
