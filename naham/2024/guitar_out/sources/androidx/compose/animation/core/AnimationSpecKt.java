...
public final class AnimationSpecKt {
    ...
    public static /* synthetic */ RepeatableSpec m93repeatable91I0pcU$default(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, Object obj) {
        ...
        if ((i2 & 8) != 0) {
            j = StartOffset.m111constructorimpl$default(0, 0, 2, null);
        }
        return m92repeatable91I0pcU(i, durationBasedAnimationSpec, repeatMode, j);
    }

    /* renamed from: repeatable-91I0pcU */
    public static final <T> RepeatableSpec<T> m92repeatable91I0pcU(int i, DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long j) {
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int i, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
        return new RepeatableSpec(i, animation, repeatMode, StartOffset.m111constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> InfiniteRepeatableSpec<T> m90infiniteRepeatable9IiC70o(DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long j) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
        return new InfiniteRepeatableSpec(animation, repeatMode, StartOffset.m111constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
