...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m76targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long m5001getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5001getZeronOccac() : slideOffset2.invoke(IntSize.m5025boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long m5001getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5001getZeronOccac() : slideOffset.invoke(IntSize.m5025boximpl(fullSize)).getPackedValue();
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3926placeWithLayeraW9wM$default(layout, mo3866measureBRTryo0, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m4982boximpl(m77invokeBjo55l4(enterExitState));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m77invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return SlideModifier.this.m76targetValueByStateoFUgxo0(it, j2);
                    }
