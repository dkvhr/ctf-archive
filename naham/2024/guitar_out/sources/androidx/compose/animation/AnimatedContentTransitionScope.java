...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    EnterTransition mo14slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> initialOffset);

    /* renamed from: slideOutOfContainer-mOhB8PU, reason: not valid java name */
    ExitTransition mo15slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> targetOffset);
    ...
    public static final class SlideDirection {
        ...
        public static String m21toStringimpl(int i) {
            return m19equalsimpl0(i, Left) ? "Left" : m19equalsimpl0(i, Right) ? "Right" : m19equalsimpl0(i, Up) ? "Up" : m19equalsimpl0(i, Down) ? "Down" : m19equalsimpl0(i, Start) ? "Start" : m19equalsimpl0(i, End) ? "End" : "Invalid";
        }
    }
    ...
    static /* synthetic */ EnterTransition m12slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        ...
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m4982boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
        ...
        return animatedContentTransitionScope.mo14slideIntoContainermOhB8PU(i, finiteAnimationSpec, function1);
    }
    ...
    static /* synthetic */ ExitTransition m13slideOutOfContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        ...
        return animatedContentTransitionScope.mo15slideOutOfContainermOhB8PU(i, finiteAnimationSpec, function1);
    }
}
