...
public final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m5031equalsimpl0(this.startSize, animData.startSize);
        }
        ...
        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m5034hashCodeimpl(this.startSize);
        }
        ...
        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m5036toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long m69animateTomzRDjE0 = m69animateTomzRDjE0(IntSizeKt.IntSize(mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight()));
        return MeasureScope.layout$default(measure, IntSize.m5033getWidthimpl(m69animateTomzRDjE0), IntSize.m5032getHeightimpl(m69animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public final long m69animateTomzRDjE0(long targetSize) {
        ...
        if (animData != null) {
            if (!IntSize.m5031equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue())) {
                animData.m74setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m5025boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m5025boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
