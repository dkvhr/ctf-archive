...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.layoutDirection = layoutDirection;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5025boximpl(IntSize.INSTANCE.m5038getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo14slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        ...
        return m33isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                int m5033getWidthimpl = IntSize.m5033getWidthimpl(m32getCurrentSizeYbymL2g);
                ...
                return function1.invoke(Integer.valueOf(m5033getWidthimpl - IntOffset.m4991getXimpl(m31calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                return function1.invoke(Integer.valueOf((-IntOffset.m4991getXimpl(m31calculateOffsetemnUabE)) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m32getCurrentSizeYbymL2g = this.m32getCurrentSizeYbymL2g();
                int m5032getHeightimpl = IntSize.m5032getHeightimpl(m32getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m32getCurrentSizeYbymL2g2 = this.m32getCurrentSizeYbymL2g();
                m31calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m31calculateOffsetemnUabE(IntSize, m32getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5032getHeightimpl - IntOffset.m4992getYimpl(m31calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                m32getCurrentSizeYbymL2g = this.m32getCurrentSizeYbymL2g();
                m31calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m31calculateOffsetemnUabE(IntSize, m32getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m4992getYimpl(m31calculateOffsetemnUabE)) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m33isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m25getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m24getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m34isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m24getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public final long m31calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo2280alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo15slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        return m33isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m31calculateOffsetemnUabE = this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m4991getXimpl(m31calculateOffsetemnUabE)) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m31calculateOffsetemnUabE = this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m4991getXimpl(m31calculateOffsetemnUabE)) + IntSize.m5033getWidthimpl(packedValue)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m31calculateOffsetemnUabE = this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m4992getYimpl(m31calculateOffsetemnUabE)) + IntSize.m5032getHeightimpl(packedValue)));
            }
    ...
    public final void m36setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m5025boximpl(j));
    }
        ...
        public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    ...
                    long packedValue = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long packedValue2 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo75createAnimationSpecTemP2vQ = value.mo75createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo75createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5025boximpl(m38invokeYEO4UFw(obj));
                }
                ...
                public final long m38invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(animate);
            final long mo2280alignKFBX0sM = this.this$0.getContentAlignment().mo2280alignKFBX0sM(IntSizeKt.IntSize(mo3866measureBRTryo0.getWidth(), mo3866measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m5033getWidthimpl(animate.getValue().getPackedValue()), IntSize.m5032getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m3923place70tqf50$default(layout, Placeable.this, mo2280alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
