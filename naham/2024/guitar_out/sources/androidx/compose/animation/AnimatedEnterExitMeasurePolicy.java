...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        while (it.hasNext()) {
            arrayList.add(((Measurable) it.next()).mo3866measureBRTryo0(j));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5025boximpl(IntSizeKt.IntSize(width3, height3)));
