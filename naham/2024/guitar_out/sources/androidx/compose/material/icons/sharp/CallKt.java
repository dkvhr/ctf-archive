...
public final class CallKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.RegisterArg.getParentInsn()" because "reg" is null
        	...
        	... 1 more
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getCall(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            java.lang.String r0 = "<this>"
            r1 = r30
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.CallKt._call
            if (r0 == 0) goto Lf
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        Lf:
            java.lang.String r2 = "Sharp.Call"
            ...
            float r3 = androidx.compose.ui.unit.Dp.m4873constructorimpl(r0)
            float r4 = androidx.compose.ui.unit.Dp.m4873constructorimpl(r0)
            ...
            long r1 = r1.m2655getBlack0d7_KjU()
            r3 = 0
            r0.<init>(r1, r3)
            r17 = r0
            ...
            r1 = 1075922862(0x402147ae, float:2.52)
            r7.lineToRelative(r0, r1)
            r1 = -1070260552(0xffffffffc0351eb8, float:-2.83)
            r2 = -1078439444(0xffffffffbfb851ec, float:-1.44)
            r3 = -1062941491(0xffffffffc0a4cccd, float:-5.15)
            r4 = -1066401792(0xffffffffc0700000, float:-3.75)
            r5 = -1059921592(0xffffffffc0d2e148, float:-6.59)
            r6 = -1059921592(0xffffffffc0d2e148, float:-6.59)
            r0 = r7
            ...
            r1 = 1075629261(0x401ccccd, float:2.45)
            r2 = 1095950664(0x4152e148, float:13.18)
            r3 = 1093476024(0x412d1eb8, float:10.82)
            r4 = 1101817446(0x41ac6666, float:21.55)
            r5 = 1101529088(0x41a80000, float:21.0)
            r6 = 1101513359(0x41a7c28f, float:20.97)
            r0 = r7
            ...
            r29 = 0
            androidx.compose.ui.graphics.vector.ImageVector$Builder r0 = androidx.compose.ui.graphics.vector.ImageVector.Builder.m3253addPathoIyEayM$default(r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29)
            androidx.compose.ui.graphics.vector.ImageVector r0 = r0.build()
            androidx.compose.material.icons.sharp.CallKt._call = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
