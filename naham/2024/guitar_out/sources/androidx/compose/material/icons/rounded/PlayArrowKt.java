...
public final class PlayArrowKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.RegisterArg.getParentInsn()" because "reg" is null
        	...
        	... 1 more
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getPlayArrow(androidx.compose.material.icons.Icons.Rounded r30) {
        /*
        ...
        Lf:
            ...
            r4 = 1067618140(0x3fa28f5c, float:1.27)
            r5 = 1069883064(0x3fc51eb8, float:1.54)
            r6 = 1062668861(0x3f570a3d, float:0.84)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1090665841(0x41023d71, float:8.14)
            r1 = -1062878577(0xffffffffc0a5c28f, float:-5.18)
            r7.lineToRelative(r0, r1)
            r1 = 1058977874(0x3f1eb852, float:0.62)
            r2 = -1094210028(0xffffffffbec7ae14, float:-0.39)
            r3 = 1058977874(0x3f1eb852, float:0.62)
            r4 = -1079697736(0xffffffffbfa51eb8, float:-1.29)
            r5 = 0
            r6 = -1076342292(0xffffffffbfd851ec, float:-1.69)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1092133847(0x4118a3d7, float:9.54)
            r1 = 1086282793(0x40bf5c29, float:5.98)
            r7.lineTo(r0, r1)
            r1 = 1091431301(0x410deb85, float:8.87)
            r2 = 1085381018(0x40b1999a, float:5.55)
            r3 = 1090519040(0x41000000, float:8.0)
            r4 = 1086387651(0x40c0f5c3, float:6.03)
            r5 = 1090519040(0x41000000, float:8.0)
            r6 = 1088044401(0x40da3d71, float:6.82)
            r0 = r7
