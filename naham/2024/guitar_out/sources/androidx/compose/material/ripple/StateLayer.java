...
public final class StateLayer {
    ...
    public final void m969drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float f2;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m960getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3172getSizeNHjbRc());
        } else {
            f2 = drawStateLayer.mo325toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m3154drawCircleVaOC9Bg$default(drawStateLayer, m2628copywmQWz5c$default, f3, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float m2459getWidthimpl = Size.m2459getWidthimpl(drawStateLayer.mo3172getSizeNHjbRc());
            float m2456getHeightimpl = Size.m2456getHeightimpl(drawStateLayer.mo3172getSizeNHjbRc());
