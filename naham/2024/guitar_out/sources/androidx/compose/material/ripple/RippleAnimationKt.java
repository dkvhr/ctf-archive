...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m4873constructorimpl(10);
    ...
    public static final float m961getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m2459getWidthimpl(j), Size.m2456getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m960getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float m2388getDistanceimpl = Offset.m2388getDistanceimpl(OffsetKt.Offset(Size.m2459getWidthimpl(j), Size.m2456getHeightimpl(j))) / 2.0f;
        return z ? m2388getDistanceimpl + getRippleEndRadius.mo325toPx0680j_4(BoundedRippleExtraRadius) : m2388getDistanceimpl;
    }
}
