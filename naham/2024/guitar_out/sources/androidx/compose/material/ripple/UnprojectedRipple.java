...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m971setColorDxMtmZc(long color, float alpha) {
        long m970calculateRippleColor5vOe2sY = m970calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 != null && Color.m2630equalsimpl0(color2.m2639unboximpl(), m970calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2619boximpl(m970calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2683toArgb8_81llA(m970calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m970calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m2628copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
