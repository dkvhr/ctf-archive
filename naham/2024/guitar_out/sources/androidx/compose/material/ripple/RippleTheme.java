...
public interface RippleTheme {
    ...
    long mo958defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m968defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m2681luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m2666getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m967defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (!lightTheme) {
                return RippleThemeKt.access$getDarkThemeRippleAlpha$p();
            }
            if (ColorKt.m2681luminance8_81llA(contentColor) > 0.5d) {
