...
public final class CompositionImpl implements ControlledComposition, RecomposeScopeOwner {
    ...
    public CompositionImpl(CompositionContext parent, Applier<?> applier, CoroutineContext coroutineContext) {
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2238getLambda1$runtime_release();
    }
    ...
    public void dispose() {
        synchronized (this.lock) {
            if (!this.disposed) {
                this.disposed = true;
                this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2239getLambda2$runtime_release();
