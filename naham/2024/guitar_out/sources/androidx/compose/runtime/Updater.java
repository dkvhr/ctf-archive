...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2262boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2263constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2264equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2265equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2266hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2271toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2264equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2266hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2271toStringimpl(this.composer);
    }
    ...
    public static final void m2269setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2270setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2272updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2273updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = composer.getInserting();
    ...
    public static final void m2267initimpl(Composer composer, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2268reconcileimpl(Composer composer, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
