...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m2241startBaiHCIY(key, null, GroupKind.INSTANCE.m2251getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m2241startBaiHCIY(-127, null, GroupKind.INSTANCE.m2251getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m2241startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m2251getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m2241startBaiHCIY(125, null, GroupKind.INSTANCE.m2252getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2241startBaiHCIY(125, null, GroupKind.INSTANCE.m2253getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m2241startBaiHCIY(key, null, GroupKind.INSTANCE.m2251getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProviders(final ProvidedValue<?>[] values) {
        ...
        m2241startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2251getGroupULZAiWs(), updateProviderMapGroup);
    }
    ...
    private final void m2241startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        Object obj = objectKey;
        validateNodeNotExpected();
        updateCompoundKeyWhenWeEnterGroup(key, objectKey, data);
        boolean z = kind != GroupKind.INSTANCE.m2251getGroupULZAiWs();
        ...
        boolean z2 = kind == GroupKind.INSTANCE.m2252getNodeULZAiWs() && this.reusing;
    ...
    */
    public final void invokeMovableContentLambda(final androidx.compose.runtime.MovableContent<java.lang.Object> r11, androidx.compose.runtime.PersistentCompositionLocalMap r12, final java.lang.Object r13, boolean r14) {
        ...
        L3e:
            ...
            int r5 = r5.m2251getGroupULZAiWs()     // Catch: java.lang.Throwable -> La6
            r6 = 202(0xca, float:2.83E-43)
            r10.m2241startBaiHCIY(r6, r0, r5, r12)     // Catch: java.lang.Throwable -> La6
    ...
    public void sourceInformationMarkerStart(int key, String sourceInformation) {
        ...
        if (this.sourceInformationEnabled) {
            m2241startBaiHCIY(key, null, GroupKind.INSTANCE.m2251getGroupULZAiWs(), sourceInformation);
        }
    }
