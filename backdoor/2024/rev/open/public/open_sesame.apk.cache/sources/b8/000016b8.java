...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object mo1637trySendJP2dKIU = sendChannel.mo1637trySendJP2dKIU(e);
        if (!(mo1637trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1637trySendJP2dKIU;
            return ChannelResult.Companion.m1657successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m1654unboximpl();
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1652isSuccessimpl(sendChannel.mo1637trySendJP2dKIU(e))) {
            return;
        }
