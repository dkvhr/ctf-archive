...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public final long m1374getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1375getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m304constructorimpl(j ^ ULong.m304constructorimpl(j >>> 32))) * 31) + ((int) ULong.m304constructorimpl(j2 ^ ULong.m304constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m350toStringimpl(this.first)).append("..").append((Object) ULong.m350toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m350toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m350toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1376fromClosedRange7ftBX0g(long j, long j2, long j3) {
