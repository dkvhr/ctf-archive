...
public interface TimeMark {
    ...
    TimeMark mo1446minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1448plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1593plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1592minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1448plusLRDsOJo(Duration.m1508unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1489isNegativeimpl(timeMark.mo1445elapsedNowUwyO8pc());
        }
