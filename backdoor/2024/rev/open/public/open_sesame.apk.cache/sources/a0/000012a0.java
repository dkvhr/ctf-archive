        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m700contentEqualskV0jMPg(((UByteArray) t).m215unboximpl(), ((UByteArray) t2).m215unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m697contentEqualsFGO6Aew(((UShortArray) t).m478unboximpl(), ((UShortArray) t2).m478unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m698contentEqualsKJPZfPQ(((UIntArray) t).m294unboximpl(), ((UIntArray) t2).m294unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m702contentEqualslec5QzE(((ULongArray) t).m373unboximpl(), ((ULongArray) t2).m373unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m714contentToString2csIQuQ(uByteArray != null ? uByteArray.m215unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m718contentToStringd6D3K8(uShortArray != null ? uShortArray.m478unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m717contentToStringXUkPCBk(uIntArray != null ? uIntArray.m294unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m720contentToStringuLth9ew(uLongArray != null ? uLongArray.m373unboximpl() : null));
            } else {
