...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public static /* synthetic */ void m1631$r8$lambda$TOZof2GYGCn1P43qXNY1O5Gvm8(HandlerContext handlerContext, Runnable runnable) {
        m1632invokeOnTimeout$lambda3(handlerContext, runnable);
    }
    ...
    public void mo1683dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        if (this.handler.postDelayed(runnable, RangesKt.coerceAtMost(j, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda0
                ...
                public final void dispose() {
                    HandlerContext.m1631$r8$lambda$TOZof2GYGCn1P43qXNY1O5Gvm8(HandlerContext.this, runnable);
                }
            };
        }
        cancelOnRejection(coroutineContext, runnable);
    ...
    public static final void m1632invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    private final void cancelOnRejection(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        Dispatchers.getIO().mo1683dispatch(coroutineContext, runnable);
    }
    ...
    public void mo1684scheduleResumeAfterDelay(long j, final CancellableContinuation<? super Unit> cancellableContinuation) {
