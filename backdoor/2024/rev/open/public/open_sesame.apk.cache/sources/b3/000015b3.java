...
public final class DurationKt {
    ...
    private static final long m1582timesmvk6XK0(int i, long j) {
        return Duration.m1494timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1581timeskIfJnKk(double d, long j) {
        return Duration.m1493timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1558getZEROUwyO8pc = Duration.Companion.m1558getZEROUwyO8pc();
        ...
        if (str.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m1492plusLRDsOJo = Duration.m1492plusLRDsOJo(m1558getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1558getZEROUwyO8pc = Duration.m1492plusLRDsOJo(m1492plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m1558getZEROUwyO8pc = Duration.m1492plusLRDsOJo(m1558getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, 8), true)) {
                m1558getZEROUwyO8pc = Duration.Companion.m1556getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1492plusLRDsOJo2 = Duration.m1492plusLRDsOJo(m1558getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        String str6 = str4;
                        Intrinsics.checkNotNullExpressionValue(substring7, str6);
                        m1558getZEROUwyO8pc = Duration.m1492plusLRDsOJo(m1492plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                        str4 = str6;
                    } else {
                        m1558getZEROUwyO8pc = Duration.m1492plusLRDsOJo(m1558getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m1508unaryMinusUwyO8pc(m1558getZEROUwyO8pc) : m1558getZEROUwyO8pc;
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1456constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1456constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1456constructorimpl((j << 1) + i);
    }
