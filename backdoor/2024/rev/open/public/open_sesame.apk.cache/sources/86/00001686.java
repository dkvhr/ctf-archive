...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1635receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1655closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m1657successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            java.lang.Object r5 = r5.m1654unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1635receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public final Object mo1636tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1656failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1655closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1657successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m1674constructorimpl$default = InlineList.m1674constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1682remove()) {
                    prevNode.helpRemove();
                } else {
                    m1674constructorimpl$default = InlineList.m1679plusFjFbRPM(m1674constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1634onCancelIdempotentListww6eGU(m1674constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            ...
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1642boximpl(z ? companion.m1655closedJP2dKIU(((Closed) obj).closeCause) : companion.m1657successJP2dKIU(obj)), selectInstance.getCompletion());
        } else if (i == 0) {
            throw StackTraceRecoveryKt.recoverStackTrace(((Closed) obj).getReceiveException());
        } else {
            if (i == 1 && selectInstance.trySelect()) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1642boximpl(ChannelResult.Companion.m1655closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m129constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1642boximpl(ChannelResult.Companion.m1657successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            ChannelResult m1642boximpl = ChannelResult.m1642boximpl(ChannelResult.Companion.m1655closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m129constructorimpl(m1642boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1642boximpl(ChannelResult.Companion.m1657successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1642boximpl(ChannelResult.Companion.m1655closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1634onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
