...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public final int m1365getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1366getLastpVg5ArA() {
        return this.last;
    }
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1351getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1367fromClosedRangeNkh28Cs(int i, int i2, int i3) {
