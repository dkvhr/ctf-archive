...
public abstract class ComputableLiveData<T> {
    ...
    public static /* synthetic */ void m43$r8$lambda$5eX8YRZhf927ktc4Rs00cwiRw(ComputableLiveData computableLiveData) {
    ...
    public ComputableLiveData(Executor executor) {
        ...
        this.refreshRunnable = new Runnable() { // from class: androidx.lifecycle.ComputableLiveData$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ComputableLiveData.m43$r8$lambda$5eX8YRZhf927ktc4Rs00cwiRw(ComputableLiveData.this);
            }
        };
