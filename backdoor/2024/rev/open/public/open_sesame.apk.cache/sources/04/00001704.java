...
public interface SendChannel<E> {
    ...
    Object mo1637trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1652isSuccessimpl(mo1637trySendJP2dKIU)) {
                return true;
            }
            Throwable m1646exceptionOrNullimpl = ChannelResult.m1646exceptionOrNullimpl(mo1637trySendJP2dKIU);
