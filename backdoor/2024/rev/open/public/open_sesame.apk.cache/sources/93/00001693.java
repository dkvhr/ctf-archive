...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1637trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m1657successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m1656failurePtdJZtk() : ChannelResult.Companion.m1655closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m1655closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1682remove()) {
                receive.helpRemove();
            } else {
                m1674constructorimpl$default = InlineList.m1679plusFjFbRPM(m1674constructorimpl$default, receive);
            }
        }
        if (m1674constructorimpl$default != null) {
            if (!(m1674constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1674constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m1674constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m1674constructorimpl$default;
    ...
    */
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m129constructorimpl(Unit.INSTANCE));
                break;
