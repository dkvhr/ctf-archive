...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner, SavedStateRegistryOwner {
    ...
    public static /* synthetic */ void m4$r8$lambda$KrBLxNpMJdSxVU3Lsj65hn0UyA(ComponentDialog componentDialog) {
        onBackPressedDispatcher$lambda$1(componentDialog);
    }
    ...
    public ComponentDialog(Context context, int i) {
        ...
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() { // from class: androidx.activity.ComponentDialog$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ComponentDialog.m4$r8$lambda$KrBLxNpMJdSxVU3Lsj65hn0UyA(ComponentDialog.this);
            }
        });
    }
