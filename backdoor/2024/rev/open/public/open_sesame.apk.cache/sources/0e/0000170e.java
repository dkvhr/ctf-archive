...
public final class AgentPremain {
    ...
    public static /* synthetic */ void $r8$lambda$8e1eAWGNJu9vYr96rU9gzKJ_uMQ(Signal signal) {
        m1659installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m129constructorimpl = Result.m129constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m129constructorimpl = Result.m129constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m135isFailureimpl(m129constructorimpl) ? null : m129constructorimpl;
        if (bool != null) {
    ...
    public static final void m1659installSignalHandler$lambda1(Signal signal) {
