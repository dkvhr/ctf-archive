...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1658invokeWpGqRn0(((ChannelResult) obj).m1654unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1658invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1642boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1654unboximpl = ((ChannelResult) this.L$0).m1654unboximpl();
            Throwable m1646exceptionOrNullimpl = ChannelResult.m1646exceptionOrNullimpl(m1654unboximpl);
            if (m1646exceptionOrNullimpl != null) {
                throw m1646exceptionOrNullimpl;
            }
            Object m1647getOrNullimpl = ChannelResult.m1647getOrNullimpl(m1654unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1647getOrNullimpl, this);
