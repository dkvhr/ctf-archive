...
public final class FullyDrawnReporter {
    ...
    public static /* synthetic */ void m5$r8$lambda$9oQ81VFq3e0CkAqj9HHhVQeVeY(FullyDrawnReporter fullyDrawnReporter) {
    ...
    public FullyDrawnReporter(Executor executor, Function0<Unit> reportFullyDrawn) {
        ...
        this.reportRunnable = new Runnable() { // from class: androidx.activity.FullyDrawnReporter$$ExternalSyntheticLambda0
            {
                FullyDrawnReporter.this = this;
            }

            @Override // java.lang.Runnable
            public final void run() {
                FullyDrawnReporter.m5$r8$lambda$9oQ81VFq3e0CkAqj9HHhVQeVeY(FullyDrawnReporter.this);
            }
        };
    }
