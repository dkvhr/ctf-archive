...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1448plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1492plusLRDsOJo(this.offset, j), null);
        }
        ...
        public long mo1447minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1461equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1488isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m1558getZEROUwyO8pc();
                    }
                    long m1491minusLRDsOJo = Duration.m1491minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) obj).timeSource) && Duration.m1461equalsimpl0(mo1447minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m1558getZEROUwyO8pc());
        }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1558getZEROUwyO8pc(), null);
    }
}