...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        mo48clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo48clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo48clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo48clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo48clone = transition.mo48clone();
        sceneChangeSetup(viewGroup, mo48clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo48clone);
    }
