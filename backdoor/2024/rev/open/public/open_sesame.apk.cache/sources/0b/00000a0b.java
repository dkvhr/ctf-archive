...
public final class DispatchQueue {
    ...
    public static /* synthetic */ void m44$r8$lambda$1MEFmJywCV2uxhp8ajM5a9C_oI(DispatchQueue dispatchQueue, Runnable runnable) {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.mo1683dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.m44$r8$lambda$1MEFmJywCV2uxhp8ajM5a9C_oI(DispatchQueue.this, runnable);
                }
            });
        } else {
            enqueue(runnable);
